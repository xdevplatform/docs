...
icon: rocket
description: Send your first X API v2 request in minutes using cURL or Postman, including authentication, endpoint selection, and parsing the JSON response.
...
<CardGroup cols={3}>
  ...
  <Card title="API reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/lookup/introduction">
...
<CardGroup cols={2}>
  <Card title="Learn authentication" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
