...
description: How Publicis Sport & Entertainment used YouScan and X API visual listening to surface sports marketing insights from images and brand mentions.
mode: wide
category: case-study
