---
title: ListenFirst boosts efficiency with X API v2
description: How ListenFirst used X API v2 to streamline data aggregation, improve accuracy, and deliver unified social analytics to marketing clients.
mode: wide
