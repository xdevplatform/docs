---
title: Decoding Hate
description: How the Decoding Hate project used the X API to analyze personal experiences of hate incidents during COVID-19 and surface patterns for researchers.
mode: wide
category: case-study
keywords: ["Decoding Hate", "case study", "social research", "hate speech research", "academic research", "social good", "research project"]
---
