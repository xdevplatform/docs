...
description: How researchers at the Canada Excellence Research Chair use the X API to study migration, refugees, and public discourse with full-archive social data.
mode: wide
