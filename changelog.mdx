...
<Update label="May 20, 2026" description="Developer Platform" >
### New developer sign-up experience at console.x.com
You can now sign up for a developer account and manage your apps and credentials at [console.x.com](https://console.x.com). The Ads API [step-by-step guide](/x-ads-api/getting-started/step-by-step-guide) has been updated to reflect the new sign-up flow.

### Documentation now available in Japanese, Spanish, Portuguese, and Korean
The X Developer Platform documentation is now available in four additional languages. Use the language switcher in the docs to read content in your preferred language, starting with the Ads API [step-by-step guide](/x-ads-api/getting-started/step-by-step-guide).
</Update>
