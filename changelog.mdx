...
<Update label="May 21, 2026" description="X API">
  ...
  Today, we announced that legacy X API **Basic** plans (monthly and annual) are being deprecated and will be automatically migrated to **Pay-Per-Use (PPU)** starting **June 1, 2026**. PPU removes fixed monthly fees — you only pay for the requests you make. Basic Monthly subscribers will be charged a **\$200** initial credit at their cutover date; Basic Annual subscribers receive their remaining prorated value as PPU credits with no new card charge. After migration, auto-recharge defaults to **\$200** when your balance falls below **\$10**, with a **\$400** per-cycle spend cap — all adjustable in the [Developer Portal](https://developer.x.com/en/portal/dashboard). You can opt out before June 1, but doing so ends API access at your cutover date. See [pricing](/x-api/getting-started/pricing) for details, or read the full announcement [here](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="May 20, 2026" description="X API">
  ### Auto-recharge now works with free credits

  Starting **May 21, 2026**, free credits (from redeemed vouchers) are treated the same as paid credits for auto-recharge. Previously, auto-recharge would not trigger when a voucher balance hit zero, even if enabled. With this fix, if auto-recharge is on and your balance is depleted, your saved payment method will be charged automatically — consistent with how paid credits have always worked. If you don't want to be charged after free credits run out, review and disable auto-recharge in your [Developer Console](https://console.x.com). Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
