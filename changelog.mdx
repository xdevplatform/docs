...
<Update label="May 20, 2026" description="X Ads API">
  ### Streamlined X Ads API Access Requests

  This week, we made it easier to request access to the [X Ads API](/x-ads-api/introduction). The Ads API introduction now includes a direct link to our access request form, replacing the previous ad-hoc process. Submit a request and our team will review it within 3 business days.
</Update>
