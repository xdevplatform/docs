...
<Update label="May 20, 2026" description="X API">
  ...
  Today, we fixed an issue where auto-recharge would not trigger once free (voucher) credits reached zero. Starting **May 21, 2026**, free credits are treated the same as paid credits — when your balance is fully depleted and auto-recharge is enabled in the [Developer Console](https://console.x.com), your account will be recharged automatically using your saved payment method. If you have auto-recharge enabled and don't want charges after free credits run out, review and disable it in your console settings. Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
