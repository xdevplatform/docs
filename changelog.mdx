...
<Update label="Jul 21, 2026" description="Developer Platform">
  ### New live status page at developer.x.com/status

  Live status for the X Developer Platform — including the X API v2, Enterprise APIs, Ads API, streaming endpoints, and supporting services — is now hosted at [developer.x.com/status](https://developer.x.com/status). Bookmark the new page to monitor uptime and current incidents. Past incidents are preserved on the [Incidents](/incidents) page.
</Update>
