...
<Update label="Sep 21, 2026" description="Livestream API">
  ### Updated access model for the Livestream API

  Livestream API access is now whitelist-only rather than tied to the Enterprise plan. To request access, fill out the [contact form](/forms/enterprise-api-interest).

  The access note now appears on [Create Broadcast](/livestream-api/broadcasts/create-broadcast), [Publish or End Broadcast](/livestream-api/broadcasts/publish-or-end-broadcast), [Delete Broadcast](/livestream-api/broadcasts/delete-broadcast), and every source endpoint: [Create](/livestream-api/sources/create-source), [List](/livestream-api/sources/list-sources), [Get](/livestream-api/sources/get-source), [Update](/livestream-api/sources/update-source), [Delete](/livestream-api/sources/delete-source), and [Get Recommended Region](/livestream-api/sources/get-recommended-region). See the [Livestream API introduction](/livestream-api/introduction) for an overview.
</Update>
