...
<Update label="Aug 21, 2026" description="X API v2">
  ...
  Both are public events and can be subscribed to with either app-only or user-context authentication. The `user_id` filter matches the user starting or ending the broadcast.
</Update>
