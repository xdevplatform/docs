...
<Update label="Jun 18, 2026" description="X API v2">
  ### Community Notes endpoint pricing correction

  We corrected the listed pricing for the [Community Notes endpoints](/x-api/community-notes/introduction). Note reads are billed at **$0.005 per resource** under the standard **Note: Read** rate on the [pricing page](/x-api/getting-started/pricing).
</Update>
