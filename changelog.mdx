...
<Update label="May 20, 2026" description="X API">
  ### Auto-Recharge Now Triggers for Free Credits

  Today, we fixed a bug in the X API credit management system. Effective May 21, 2026, free credits redeemed from vouchers are treated the same as paid credits for auto-recharge. When your balance reaches zero and auto-recharge is enabled in the [Developer Console](https://console.x.com), your saved payment method will be charged automatically — matching the behavior for paid credits. If you don't want to incur charges after free credits are depleted, review and disable auto-recharge in the Developer Console. Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
