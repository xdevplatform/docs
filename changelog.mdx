...
<Update label="Jun 28, 2026" description="X Ads API">
  ...
  - `standard_delivery` is deprecated at the campaign level. Configure standard versus accelerated delivery on the line item via its [`standard_delivery`](/x-ads-api/campaign-management/reference) parameter instead.
</Update>
