...
<Update label="Jul 16, 2026" description="X API">
  ### Pay-Per-Use monthly Post read cap

  We clarified on the [pricing page](/x-api/getting-started/pricing) that Pay-Per-Use plans are subject to a cap of **2 million Post reads per monthly billing cycle**. If you need higher volume, you'll need to upgrade to an [Enterprise plan](/forms/enterprise-api-interest).
</Update>
