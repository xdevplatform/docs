...
<Update label="May 21, 2026" description="X API">
  ### Legacy Basic plans moving to Pay-Per-Use

  Today, we announced that the legacy X API **Basic** plans (monthly and annual) are being deprecated and will be automatically migrated to **Pay-Per-Use (PPU)** after **June 1, 2026**. With PPU, there are no fixed monthly fees — you only pay for the API requests you actually make. At cutover, monthly subscribers will receive a **\$200** initial credit (charged via Stripe). Annual subscribers will receive the remaining prorated value of their annual fee as PPU credits. After migration, auto-recharge defaults to **\$200** when balances fall below **\$10**, with a **\$400** spend cap per cycle — both adjustable in the [Developer Portal](https://developer.x.com/en/portal/dashboard). Opt-out is available before June 1, 2026, but ends API access after your cutover date. Learn more [here](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="May 20, 2026" description="X API">
  ### Auto-recharge now triggers on free credits

  We fixed an issue where auto-recharge wouldn't trigger when a credit voucher (free credits) balance reached zero. Starting **May 21, 2026**, free credits are treated the same as paid credits for auto-recharge — if your balance is depleted and auto-recharge is enabled, your account will recharge automatically using your saved payment method. If you don't want to incur charges after free credits run out, review your settings in the [Developer Console](https://console.x.com) and disable auto-recharge. Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>

<Update label="May 13, 2026" description="X Ads API">
  ### X Ads API feedback program

  We're collecting direct feedback from developers and advertisers to improve the **X Ads API** — including bug reports, endpoint pain points, wishlist features, and documentation gaps. Share input via the [feedback form](https://docs.google.com/forms/d/e/1FAIpQLSeDn5s1T0ze9-7K0XAw18MD3bEzGrIle3ko3uyjN8EP5dJhYQ/viewform) or reply on the [announcement thread](https://devcommunity.x.com/t/x-ads-api-share-your-feedback/265247).
</Update>
