...
<Update label="Jul 1, 2026" description="Developer Platform">
  ...
  Today, we launched the [**Developer E𝕏hibit**](https://developer.x.com/exhibit) — a public directory that showcases apps built on the X API. Submit your app from the **Apps** page in the [Developer Console](https://console.x.com), complete a quick verification, and your listing goes live to help potential users and other developers discover your project. Learn more [here](https://devcommunity.x.com/t/introducing-the-developer-e-hibit-showcase-your-x-api-apps-and-get-discovered/269675).
</Update>

<Update label="Jun 30, 2026" description="Developer Platform">
  ### Hosted X MCP server

  Today, we launched a hosted [X MCP server](/tools/mcp) at `https://api.x.com/mcp` so any MCP-compatible AI tool (Grok Build, Cursor, Claude, VS Code, and others) can call the X API with your own account's permissions — no local server to clone and run. Connect through the open-source [`xurl mcp`](https://github.com/xdevplatform/xurl) bridge, which handles OAuth 2.0 PKCE login and auto-refreshes tokens for you.

  Capabilities include full-archive Post search, user and news search, timelines and mentions, bookmark management, trends, and drafting/publishing Articles. Learn more [here](https://devcommunity.x.com/t/announcing-the-hosted-x-mcp/269558).
</Update>
