...
<Update label="May 20, 2026" description="X API">
  ...
  Today, we shipped a fix so that **auto-recharge** behaves consistently across all credit types. Previously, when a credit voucher (free credits) balance reached zero, auto-recharge would not trigger — even if it was enabled. **Starting May 21, 2026**, free credits are treated the same as paid credits: if your balance is depleted and auto-recharge is enabled in the [Developer Console](https://console.x.com), your account will recharge automatically using your saved payment method.

  - If you don't want to be charged after free credits run out, review and disable auto-recharge in the Developer Console.
  - Make sure your payment method is current if you intend to keep auto-recharge on.

  See [Auto-recharge](https://docs.x.com/x-api/getting-started/pricing#auto-recharge) for details, or read the [announcement](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>

<Update label="May 13, 2026" description="X Ads API">
  ### X Ads API Feedback Open

  We've opened a feedback channel for the [X Ads API](https://docs.x.com/x-ads-api/introduction). Share bugs, pain points, wishlist items, and documentation gaps to help shape what ships next — by replying in the [community thread](https://devcommunity.x.com/t/x-ads-api-share-your-feedback/265247) or submitting the linked form.
</Update>
