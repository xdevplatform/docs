...
<Update label="May 21, 2026" description="X API">
  ...
  Today, we announced that the legacy **Basic** plans (monthly and annual) are being deprecated. After **June 1, 2026**, all Basic subscribers will be automatically migrated to [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/about-x-api) at the end of their current billing cycle — no action required. Monthly subscribers receive a **\$200** initial credit charge; annual subscribers receive the remaining prorated value as PPU credits. Default PPU settings after migration: auto-recharge enabled at **\$200** (triggered below **\$10**) and a **\$400** spend cap per cycle, all adjustable in the [Developer Portal](https://developer.x.com/en/portal/dashboard). To opt out, update your settings before **June 1, 2026** — note that opting out ends API access at your cutover date. Learn more [here](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="May 20, 2026" description="X API">
  ### Auto-Recharge Now Applies to Free Credits

  Today, we fixed an issue where auto-recharge would not trigger once free (voucher) credits reached zero. Starting **May 21, 2026**, free credits are treated the same as paid credits. If your balance is fully depleted and auto-recharge is enabled in the [Developer Console](https://console.x.com), your account will be recharged automatically using your saved payment method. If you have auto-recharge enabled and don't want charges after free credits run out, review and disable it in your console settings. Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
