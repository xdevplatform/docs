...
<Update label="May 21, 2026" description="X API">
  ...
  Today, we announced that legacy **Basic** plans (monthly and annual) are being deprecated. After **June 1, 2026**, Basic subscribers will be automatically migrated to [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/about-x-api) at their next cutover date — no action required.

  - **Basic Monthly**: a **$200** initial credit is charged at cutover and deducted as you make requests.
  - **Basic Annual**: the remaining prorated value is granted as PPU credits that expire after the equivalent prorated months (no additional card charge).
  - **Default PPU settings**: auto-recharge enabled at **$200** when balance drops below **$10**, with a **$400** per-cycle spend cap. Adjust anytime in the [Developer Portal](https://developer.x.com/en/portal/dashboard).

  To opt out, update your Developer Portal settings before June 1, 2026. Opting out ends API access at your cutover date and is final. Learn more [here](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="May 20, 2026" description="X API">
  ### Fix: Auto-Recharge Now Triggers for Free Credits

  Today, we fixed an issue where auto-recharge would not trigger when a credit balance funded by a voucher (free credits) reached zero. Starting **May 21, 2026**, free and paid credits are treated identically for auto-recharge — if your balance is depleted and auto-recharge is enabled, your account will recharge automatically using your saved payment method.

  If you don't want to incur charges after free credits run out, review and disable auto-recharge in the [Developer Console](https://console.x.com). Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
