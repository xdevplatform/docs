...
<Update label="Sep 24, 2026" description="Livestream API">
  ### Livestream API access no longer requires an Enterprise plan

  Access to the [Livestream API](/livestream-api/introduction) is now granted to whitelisted apps rather than being limited to the Enterprise plan. To request access, submit the [Livestream API Access Form](/forms/livestream-api-access) with your X Developer App ID and use case.

  See [Getting started](/livestream-api/getting-started) for the remaining prerequisites.
</Update>
