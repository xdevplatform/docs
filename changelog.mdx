...
<Update label="May 21, 2026" description="X API">
  ...
  Today, we announced that the legacy **Basic** monthly and annual plans are being deprecated. Starting **June 1, 2026**, all Basic subscribers will be automatically migrated to [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/pricing) at the end of their current billing cycle — no action is required. Monthly subscribers will receive an initial **\$200** credit charge via Stripe; annual subscribers will receive the remaining prorated value of their annual fee as PPU credits. After migration, auto-recharge is enabled by default at **\$200** (triggered below **\$10**) with a **\$400** spend cap per billing cycle — all adjustable in the [Developer Portal](https://developer.x.com/en/portal/dashboard). Developers who do not want to migrate can opt out before June 1, 2026; opting out ends API access at the cutover date. Learn more [here](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="May 20, 2026" description="X API">
  ### Auto-Recharge Now Triggers After Free Credits Are Depleted

  Today, we fixed an issue where the auto-recharge feature would not trigger once a redeemed credit voucher (free credits) reached zero. Starting **May 21, 2026**, free credits are treated the same as paid credits for auto-recharge: if your balance is depleted and auto-recharge is enabled, your saved payment method is automatically charged. If you do not want to incur charges after free credits are used up, review and disable auto-recharge in the [Developer Console](https://console.x.com). Learn more [here](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
