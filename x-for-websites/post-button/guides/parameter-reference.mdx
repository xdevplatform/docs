...
description: "Reference for Post button parameters including text, url, hashtags, via, related accounts, size, language, and DNT for HTML data-* attributes or JavaScript."
