---
title: Post button
description: "Add a Post button to your website with HTML markup and widgets.js to let visitors share content on X with pre-populated text, hashtags, and via attribution."
