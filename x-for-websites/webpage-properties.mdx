...
description: Configure X widget defaults across a site with meta and link elements, including dnt, lang, in-reply-to, and other webpage-level widget properties.
---
