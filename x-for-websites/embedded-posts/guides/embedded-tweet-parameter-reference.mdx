...
description: "Reference for embedded Post data-* attributes and JavaScript factory parameters covering theme, width, alignment, conversation, cards, language, and DNT."
