...
description: 'An embedded Post supports customization in data-* attributes and JavaScript factory functions. This reference document describes parameters used in all.'
---
