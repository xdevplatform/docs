...
sidebarTitle: FAQ
description: "An embedded Post comes in two parts: a containing Post information and the JavaScript file from a X server which converts the into a fully-rendered Post."
---
