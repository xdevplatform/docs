...
description: "Overview of X for Websites tools including embedded Posts, timelines, the Post button, Follow button, oEmbed API, and the publish.x.com configurator."
mode: wide
...
<CardGroup>
<Card title="Embedded Tweets" icon="/icons/xds/icon-code.svg">
...
<CardGroup>
<Card title="Embedded timelines" icon="/icons/xds/icon-code.svg" >
