---
title: oEmbed API
description: "You can use the oEmbed API to programmatically return embedded content, such as Tweets and timelines. The response from the oEmbed API will return an HTML."
mode: wide
