...
description: "Web Intents display X actions optimized for display in a small browser window. A website may link to a follow web intent through a simple link on any."
---
