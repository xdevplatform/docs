...
description: "Use twttr.widgets.createFollowButton to dynamically insert a Follow button on your page with a username, target element, custom options, and a promise callback."
