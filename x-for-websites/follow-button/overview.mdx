---
title: Follow button
description: "Add an X Follow button to your website with HTML markup or publish.x.com, customize size and screen name display, and load it with widgets.js."
