...
description: The Follow button is a small button displayed on your websites to help users easily follow a X account. Part of the X for Websites reference documentation.
---
