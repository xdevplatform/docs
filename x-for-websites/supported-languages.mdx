...
description: Languages and browsers supported by X for Websites widgets, including locale codes, language fallbacks, and minimum supported browser versions.
---
