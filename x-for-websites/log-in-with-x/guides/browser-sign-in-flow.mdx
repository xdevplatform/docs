...
description: "How the Sign in with X browser flow works on desktop and mobile, redirecting users to x.com for authorization before returning to your application URL."
