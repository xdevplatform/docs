...
description: "The browser implementation of Sign in with X is based on OAuth. This page demonstrates the requests needed to obtain an access token for the sign in flow."
---
