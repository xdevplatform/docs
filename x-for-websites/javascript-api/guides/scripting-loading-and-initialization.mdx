...
description: "Use twttr.widgets.load to scan the DOM and initialize new X for Websites buttons or widgets added dynamically through lazy loading or pushState navigation."
