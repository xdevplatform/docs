...
description: If you’re integrating your site with X using X for Websites and Web Intents, you can enhance your application using JavaScript. Reference and integration guide.
---
