...
description: "Overview of the X for Websites JavaScript API for enhancing embedded Posts, timelines, and Web Intents on your site with dynamic widget loading and events."
---
