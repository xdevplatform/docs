...
description: "Embed X profile and list timelines on your website with sizing, custom chrome, theme, Post limits, and the publish.x.com markup generator for easy setup."
