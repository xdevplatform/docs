...
description: A profile timeline displays the latest Posts ordered from newest to oldest from a specific public X account. Part of the X for Websites reference documentation.
---
