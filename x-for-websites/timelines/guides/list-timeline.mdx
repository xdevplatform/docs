...
description: "Embed a X list timeline showing the latest Posts from a curated public list using an anchor tag with the list URL or the twttr.widgets.createTimeline factory."
