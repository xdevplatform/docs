...
description: "Customize an embedded timeline with data- attributes added to a fallback anchor element or passed to a JavaScript factory function in an options object."
---
