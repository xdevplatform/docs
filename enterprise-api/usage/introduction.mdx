...
description: "The Usage endpoint lets you monitor your API usage, including the number of Posts consumed. Reference for the Enterprise X API tier covering usage."
