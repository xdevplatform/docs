...
|:-------|:---------|:------------|
| GET | [`/2/usage/tweets`](/enterprise-api/usage/get-usage) | Get Post usage data |
...
<Tip>
Resources are deduplicated within a 24-hour UTC window, so requesting the same resource multiple times in a day only counts as one charge. [Learn more about pricing →](/enterprise-api/getting-started/pricing)
</Tip>
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="/enterprise-api/usage/post-usage">
