---
title: News lookup endpoint on the Enterprise API
sidebarTitle: Introduction
description: "Use the X news lookup endpoint to fetch breaking headlines, story summaries, contexts, tickers, and clustered Post results with bearer token authentication."
