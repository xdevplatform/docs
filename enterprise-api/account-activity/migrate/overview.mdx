---
title: Account Activity v2 migration overview
description: Migrate from the legacy Enterprise Account Activity API to v2 with updated endpoint paths, OAuth 2.0 authentication, and webhook management.
