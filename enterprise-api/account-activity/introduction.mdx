...
description: "The Account Activity API (AAA) provides a way to receive real-time events related to X. Reference for the Enterprise X API tier covering account activity."
