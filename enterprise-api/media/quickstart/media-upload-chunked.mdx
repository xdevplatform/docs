...
<CardGroup cols={2}>
  <Card title="Best practices" icon="book" href="/enterprise-api/media/quickstart/best-practices">
    File constraints and requirements
  </Card>
  <Card title="Create Posts" icon="message" href="/enterprise-api/posts/manage-tweets/quickstart">
    Post with media
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/media/media-upload-init">
