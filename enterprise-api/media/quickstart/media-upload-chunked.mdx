...
description: "This guide walks you through uploading videos and large media files using the chunked upload. Reference for the Enterprise X API tier covering quickstart."
