...
>
>*   [Native Enriched compared to X API v2](/enterprise-api/migrate/data-format-migration#migrating-from-native-enriched-data-format-to-v2)
>*   [Activity Streams compared to X API v2](/enterprise-api/migrate/data-format-migration#migrating-from-activity-streams-data-format-to-v2)
...
Enterprise endpoints that return Post objects have been updated to provide the metadata needed to understand the Post's edit history. Learn more about these metadata on the ["Edit Posts" fundamentals](/enterprise-api/fundamentals/edit-posts) page.
...
>Please note: It is highly recommended to use the [Enriched Native](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-tweet-object) format for enterprise data APIs. 
>
>*   The Enriched Native format includes all new metadata since 2017, such as [poll metadata](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#poll-metadata), and additional metrics such as reply\_count and quote\_count.
>
...
*   [Expanded and enhanced URLs enrichment](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#expanded-and-enhanced-urls)
*   [Matching rules enrichment](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#matching-rules)
*   [Poll metadata enrichment](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#poll-metadata)
*   [Profile geo enrichment](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#profile-geo)
...
| :--- | :--- |
| [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-tweet-object) Post object | [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#post-object) Activity object |
| [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-user-object) User object | [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-user-object) Actor object |
| [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-entities) Entities object | [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-entities) X entities object |
| [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-extended-entities) Extended entities object | [Link]/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-extended-entities X extended entitites object |
| [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-geo-objects) Geo object | [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-geo-objects) Location object |
| n/a | [Link](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#gnip-object) Gnip object |
...
| entities | [Entities](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-entities) | Entities which have been parsed out of the text of the Post. Additionally see [Entities in X Objects](https://developer.x.com/en/docs/enterprise-api/v1/data-dictionary/object-model/entities) . Example:<br/><br/>"entities":<br/>\<br/>    "hashtags":\[\],<br/>    "urls":\[\],<br/>    "user_mentions":\[\],<br/>    "media":\[\],<br/>    "symbols":\[\]<br/>    "polls":\[\]<br/>} |
| extended_entities | [Extended Entities](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-entities) | When between one and four native photos or one video or one animated GIF are in Post, contains an array 'media' metadata. This is also available in Quote Tweets. Additionally see [Entities in X Objects](https://developer.x.com/en/docs/enterprise-api/v1/data-dictionary/object-model/extended-entities) . Example:<br/><br/>"entities":<br/>\<br/>    "media":\[\]<br/>} |
...
| Field | Type | Description |
| :--- | :--- | :--- |
| utc_offset | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) |
| time_zone | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) as tzinfo_name |
| lang | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) as language |
| geo_enabled | null | Value will be set to null.  Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings). This field must be true for the current user to attach geographic data when using [POST statuses / update](https://developer.x.com/en/docs/enterprise-api/v1/tweets/post-and-engage/guides/post-tweet-geo-guide) |
| following | null | Value will be set to null. Still available via [GET friendships/lookup](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/follow-search-get-users/api-reference/get-friendships-lookup) |
| follow\_request\_sent | null | Value will be set to null. Still available via [GET friendships/lookup](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/follow-search-get-users/api-reference/get-friendships-lookup) |
...
There are three ‘root-level’ JSON objects used to describe the location associated with a Post: [place](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#place-data-dictionary), [geo](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#native-enriched-geo-objects) and [coordinates](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#coordinates-object-data-dictionary). 

Additionally, the native enriched format includes the [profile geo enrichment's](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#profile-geo) [derived location](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#derived-locations) within the user object.
...
* if you are working with native media (photos, videos, or GIFs), the [Extended Entities object](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-extended-entities) is the way to go.
...
| media_url | String | An http:// URL pointing directly to the uploaded media file. Example:<br/><br/>"media_url":"http://pbs.twimg.com/media/DOhM30VVwAEpIHq.jpg"<br/><br/>For media in direct messages, `media_url` is the same https URL as `media_url_https` and must be accessed by signing a request with the user’s access token using OAuth 1.0A.<br/><br/>It is not possible to access images via an authenticated x.com session. Please visit [this page](https://developer.x.com/en/docs/enterprise-api/v1/direct-messages/message-attachments/guides/retrieving-media) to learn how to account for these recent change. <br/><br/>You cannot directly embed these images in a web page.<br/><br/>See [Photo Media URL formatting](#photo_format) for how to format a photo's URL, such as `media_url_https`, based on the available `sizes`. |
...
* Volume streams ([Decahose](/enterprise-api/enterprise-gnip-2.0/fundamentals/decahose-api) )
* [Real-time PowerTrack](/enterprise-api/enterprise-gnip-2.0/powertrack-api)
* X Search APIs ([Full-Archive Search](/enterprise-api/enterprise-gnip-2.0/fundamentals/search-api) and [30-Day Search](/enterprise-api/enterprise-gnip-2.0/fundamentals/search-api))
...
Check out our comparison guide: [Activity Streams compared to X API v2](/enterprise-api/migrate/data-format-migration#migrating-from-activity-streams-data-format-to-v2)
...
| actor | object | [An object representing the x user who posted. The Actor Object refers to a X User, and contains all metadata relevant to that user.  <br/>See](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#actor-object) [actor object details](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#actor-object) |
...
| location | object | [A JSON object representing the X "Place" where the post was created. This is an object passed through from the X platform.  <br/>  <br/>See](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#location-object) [location object](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#location-object) |
...
| Field | Type | Description |
| :--- | :--- | :--- |
| utcOffset | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) |
| twitterTimeZone | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) as tzinfo_name |
| languages | null | Value will be set to null. Still available via [GET account/settings](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/manage-account-settings/api-reference/get-account-settings) as language |
...
| geo | object | The geo coordintates object from X.  Either a polygon, or point.<br/><br/>See [geo](https://developer.x.com/en/docs/enterprise-api/v1/data-dictionary/object-model/geo#coordinates) |
...
| :--- | :--- | :--- |
| Field | Type | Description |
| address | object | Within profileLocation location object within the [gnip object](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#gnip-object).  Address of location derived by the [profile geo enrichement](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#profile-geo).  Level of granularity will vary. <br/><br/>**"address": \{**<br/><br/>**          "country": **"United States"**,**<br/><br/>**          "countryCode": **"US"**,**<br/><br/>**          "locality": **"Providence"**,**<br/><br/>**          "region": **"Rhode Island"**,**<br/><br/>**          "subRegion": **"Providence County"<br/><br/>**        }** |
| geo | object | Within profileLocation location object within the [gnip objec](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#gnip-object)t. Centroid coordinates of the location derived by the [profile geo enrichement](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-enrichments#profile-geo).<br/><br/>**"geo": \{**<br/><br/>**          "coordinates": \[**<br/><br/>-98.5**,**<br/><br/>39.76<br/><br/>**          \],**<br/><br/>**          "type": **"point"<br/><br/>**        }** |
...
For Activity streams format, the twitter_entities is the same format and data dictionary shown on the native enriched format [entities object here](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#entities-object).
...
For Activity streams format, the twitter\_extended\_entities is the same format and data dictionary shown on the native enriched format [extended_entities object here](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-extended-entities).
