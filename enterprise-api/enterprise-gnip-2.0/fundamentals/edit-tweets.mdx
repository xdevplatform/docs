...
The [Compliance Firehose](/enterprise-api/enterprise-gnip-2.0/fundamentals/firehouse) and the v2 [batch compliance endpoint](/enterprise-api/compliance/batch-compliance/introduction) have both been updated to provide edit Post support: 
