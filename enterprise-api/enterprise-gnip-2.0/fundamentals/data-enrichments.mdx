...
keywords: ["data enrichments", "enterprise enrichments", "GNIP enrichments", "data enrichment", "enriched data", "enterprise data enrichment"]
---
...
**This is an example of an [entities object](/enterprise-api/enterprise-gnip-2.0/fundamentals/data-dictionary#x-entities) with the URL enrichment:**
```
"entities": {
    "hashtags": [
