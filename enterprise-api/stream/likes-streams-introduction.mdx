...
description: "The Likes Streams endpoints deliver real-time like events through persistent HTTP GET connections. Reference for the Enterprise X API tier covering stream."
