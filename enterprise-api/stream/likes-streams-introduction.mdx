...
description: The Likes Streams endpoints deliver real-time like events through persistent HTTP GET connections. These streams provide access to. Enterprise X API v2 tier.
