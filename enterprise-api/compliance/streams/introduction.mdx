...
description: "Keep stored X data in sync with deletes, edits, and account changes using Enterprise compliance event streams for Posts and users in near real time."
---
