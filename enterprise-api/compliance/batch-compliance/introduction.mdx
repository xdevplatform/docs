...
description: "The Batch Compliance endpoints let you upload datasets of Post IDs or user IDs and. Reference for the Enterprise X API tier covering batch compliance."
