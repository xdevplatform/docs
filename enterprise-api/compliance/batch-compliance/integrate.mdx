...
description: "When using the Batch compliance endpoints, developers can batch upload large amounts of X. Reference for the Enterprise X API tier covering batch compliance."
