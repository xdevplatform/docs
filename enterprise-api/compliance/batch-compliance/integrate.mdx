...
You can then upload your Post or User IDs to this location by following step two onwards, [from the quick start guide](/enterprise-api/compliance/batch-compliance#getting-started-with-the-batch-compliance-endpoints).
...
At this point, you will be able to use the [compliance status endpoint](/enterprise-api/compliance/get-compliance-job) to check on the status of your compliance job, and you will be able to download the compliance result when complete.
