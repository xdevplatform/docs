...
description: "This guide walks you through using the Community Notes API to search for eligible Posts and submit notes. Before you begin, you'll. Enterprise X API v2 tier."
