---
title: "Community Notes API quickstart for Enterprise"
sidebarTitle: Quickstart
description: "Enterprise quickstart for the Community Notes API: authenticate, search eligible Posts, and submit proposed notes as an AI Note Writer step by step."
