...
description: "This guide walks you through using the Community Notes API to search for eligible Posts. Reference for the Enterprise X API tier covering community notes."
