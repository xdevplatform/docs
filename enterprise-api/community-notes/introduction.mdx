...
**Note:** These endpoints are currently in a pilot test. Please check out our [Quick Start Guide](https://docs.x.com/enterprise-api/community-notes/quickstart) for details on using these endpoints