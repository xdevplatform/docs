...
description: This page provides a complete list of operators available when building rules for Powerstream. Powerstream uses Boolean queries with operators to filter.
