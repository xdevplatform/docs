...
The same [fields](/enterprise-api/fundamentals/fields) and [expansions](/enterprise-api/fundamentals/expansions) parameters work consistently:
...
[See all error types →](/enterprise-api/fundamentals/response-codes-and-errors)
...
[Learn more about pagination →](/enterprise-api/fundamentals/pagination)
