...
|:---------|:----------|:------------|
| **High-volume streams** | **Firehose**, [Volume Streams](/enterprise-api/posts/volume-streams/introduction) (1% and 10% sampled) | Deliver large volumes of Post data without filtering. Designed for comprehensive coverage of platform activity. |
| **Lower-volume streams** | [Filtered Stream](/enterprise-api/posts/filtered-stream/introduction) | Allow you to specify keywords or criteria to receive only matching Posts. Ideal for targeted monitoring. |
| **Low-latency streams** | [Powerstream](/enterprise-api/powerstream/introduction) | Optimized for speed with minimal delay. Best for use cases requiring real-time data delivery. |
...
<Note>
If your use case requires lower latency, consider [Powerstream](/enterprise-api/powerstream/introduction), which is optimized for speed and delivers data with minimal delay.
</Note>
