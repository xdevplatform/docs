...
<CardGroup cols={2}>
  <Card title="Migration overview" icon="route" href="/enterprise-api/migrate/overview">
    Current migration guidance.
  </Card>
  <Card title="Endpoint map" icon="map" href="/enterprise-api/migrate/x-api-endpoint-map">
