...
Learn how to maximize connection time and recover missed data when using X streaming endpoints including [Filtered Stream](/enterprise-api/posts/filtered-stream/introduction), [Volume Streams](/enterprise-api/posts/volume-streams/introduction), [Powerstream](/enterprise-api/powerstream/introduction), and [Compliance Streams](/enterprise-api/compliance/streams/introduction).
...
If you don't have access to backfill or recovery features, or if the disconnection exceeded 24 hours, you can use the [Search Posts endpoint](/enterprise-api/posts/search/introduction) to request missed data.
