...
|:-------|:----------|:--------------|
| Post (Tweet) | `tweet.fields` | [Post fields](/enterprise-api/fundamentals/data-dictionary#tweet) |
| User | `user.fields` | [User fields](/enterprise-api/fundamentals/data-dictionary#user) |
| Media | `media.fields` | [Media fields](/enterprise-api/fundamentals/data-dictionary#media) |
| Poll | `poll.fields` | [Poll fields](/enterprise-api/fundamentals/data-dictionary#poll) |
| Place | `place.fields` | [Place fields](/enterprise-api/fundamentals/data-dictionary#place) |
...
<CardGroup cols={2}>
  <Card title="Expansions" icon="expand" href="/enterprise-api/fundamentals/expansions">
    Include related objects in responses.
  </Card>
  <Card title="Data Dictionary" icon="book" href="/enterprise-api/fundamentals/data-dictionary">
