...
- Use with [filtered stream](/enterprise-api/posts/filtered-stream/introduction) to monitor conversations in real-time
- Combine with [pagination](/enterprise-api/fundamentals/pagination) for large threads
...
<CardGroup cols={2}>
  <Card title="Search posts" icon="magnifying-glass" href="/enterprise-api/posts/search/introduction">
    Search by conversation_id.
  </Card>
  <Card title="Filtered stream" icon="signal-stream" href="/enterprise-api/posts/filtered-stream/introduction">
