...
<CardGroup cols={2}>
  <Card title="Error handling" icon="triangle-exclamation" href="/enterprise-api/fundamentals/response-codes-and-errors">
    Handle 429 and other errors.
  </Card>
  <Card title="Getting started" icon="rocket" href="/enterprise-api/getting-started/about-x-api">
