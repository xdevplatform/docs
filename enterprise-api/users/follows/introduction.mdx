...
description: "The Follows endpoints let you follow and unfollow users, and retrieve follower and following lists. Reference for the Enterprise X API tier covering follows."
