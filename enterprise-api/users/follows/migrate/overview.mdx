...
| JSON format | Standard v1.1 format | [X API v2 format](/enterprise-api/fundamentals/data-dictionary) (determined by fields and expansions request parameters, not backward-compatible with v1.1 formats)<br/><br/>To learn more about how to migrate from the Standard v1.1 format to the X API v2 format, please visit our [data formats migration guide](/enterprise-api/migrate/data-format-migration). |
| Supports selecting which [fields](/enterprise-api/fundamentals/data-dictionary) return in the payload |     | ✔   |
| Supports the Post [annotations](/enterprise-api/fundamentals/post-annotations) fields |     | ✔   |
| Supports requesting new [metrics](/enterprise-api/fundamentals/metrics) fields |     | ✔   |
| Supports the [conversation_id](/enterprise-api/fundamentals/conversation-id) field |     | ✔   |
...
[Follows lookup: Standard v1.1 to X API v2](/enterprise-api/users/follows/migrate/standard-to-twitter-api-v2)

[Manage follows: Standard v1.1 to X API v2](/enterprise-api/users/follows#manage-follows-standard-v1-1-compared-to-x-api-v2)
