---
title: Enterprise follows endpoints v2 migration
description: Compare Standard v1.1 friendships and followers endpoints with X API v2 follow lookup and manage follows endpoints to migrate your integration.
