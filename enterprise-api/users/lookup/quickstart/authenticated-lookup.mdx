...
<CardGroup cols={2}>
  <Card title="User lookup" icon="users" href="/enterprise-api/users/lookup/quickstart/user-lookup">
    Look up other users
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/users/lookup/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/users/authenticated-user-lookup">
