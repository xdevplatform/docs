...
description: "This guide walks you through retrieving the currently authenticated user's profile using the. Reference for the Enterprise X API tier covering quickstart."
