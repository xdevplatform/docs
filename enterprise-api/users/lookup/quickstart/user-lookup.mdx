...
description: "This guide walks you through looking up users by their ID or username. Before you begin, you'll need: - A developer account with an. Enterprise X API v2 tier."
