...
<CardGroup cols={2}>
  <Card title="Authenticated user" icon="user-check" href="/enterprise-api/users/lookup/quickstart/authenticated-lookup">
    Get the current user
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/users/lookup/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/users/single-user-lookup">
