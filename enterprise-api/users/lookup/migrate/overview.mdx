---
title: Enterprise user lookup v2 migration
description: Compare Standard v1.1 users/show and users/lookup endpoints with the X API v2 user lookup endpoints, including fields, expansions, and authentication.
