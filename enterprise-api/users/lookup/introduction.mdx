...
description: The User lookup endpoints let you retrieve profile information for one or more users. Look up users by their ID, username. Enterprise X API v2 tier.
