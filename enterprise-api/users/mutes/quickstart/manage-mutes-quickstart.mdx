...
<Steps>
  <Step title="Get your user ID">
    You need your authenticated user's ID. You can find it using the [user lookup endpoint](/enterprise-api/users/lookup/introduction) or from your Access Token (the numeric part is your user ID).
  </Step>

  <Step title="Get the target user ID">
    Find the user ID of the account you want to mute using the [user lookup endpoint](/enterprise-api/users/lookup/introduction).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Mutes lookup" icon="volume-xmark" href="/enterprise-api/users/mutes/quickstart/mutes-lookup">
    Get your muted users
  </Card>
  <Card title="Blocks" icon="ban" href="/enterprise-api/users/blocks/quickstart">
    Block users instead
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/users/mute-user-by-user-id">
