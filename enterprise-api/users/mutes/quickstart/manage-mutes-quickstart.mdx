...
description: "This guide walks you through muting and unmuting users using the X API. Before you begin, you'll need: - A developer account with. Enterprise X API v2 tier."
