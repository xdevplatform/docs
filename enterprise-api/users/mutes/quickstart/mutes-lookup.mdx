...
<CardGroup cols={2}>
  <Card title="Manage mutes" icon="volume-xmark" href="/enterprise-api/users/mutes/quickstart/manage-mutes-quickstart">
    Mute and unmute users
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/users/get-muted-users">
