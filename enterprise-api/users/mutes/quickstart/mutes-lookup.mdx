...
description: "This guide walks you through retrieving your muted users list using the X API. Before you begin, you'll need: - A developer account. Enterprise X API v2 tier."
