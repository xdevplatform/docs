...
description: If you have been working with the standard v1.1 GET mutes/users/ids and GET mutes/users/list endpoints, the goal of this guide is. Enterprise X API v2 tier.
---
