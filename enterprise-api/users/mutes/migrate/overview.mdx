---
title: Enterprise mutes endpoints v2 migration
description: Compare Standard v1.1 mutes endpoints with the X API v2 mutes lookup and manage mutes endpoints, including parameter, auth, and rate limit changes.
