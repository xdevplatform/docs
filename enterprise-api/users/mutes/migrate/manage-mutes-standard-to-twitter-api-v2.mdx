...
description: If you have been working with the standard v1.1 POST mutes/users/create and POST mutes/users/destroy endpoints, the goal of this. Enterprise X API v2 tier.
---
