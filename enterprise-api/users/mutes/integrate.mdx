...
description: "This guide covers the key concepts you need to integrate the mutes endpoints into your application. Reference for the Enterprise X API tier covering mutes."
---
