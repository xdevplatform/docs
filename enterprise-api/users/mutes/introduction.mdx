...
description: "The Mutes endpoints let you mute and unmute users, and retrieve the list of users muted by the. Reference for the Enterprise X API tier covering mutes."
