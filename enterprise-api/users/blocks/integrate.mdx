...
description: This guide covers the key concepts you need to integrate the blocks endpoints into your application. The block and unblock users. Enterprise X API v2 tier.
---
