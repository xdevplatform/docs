...
In addition to the changes in how you request certain fields, X API v2 is also introducing new JSON designs for the objects returned by the APIs, including [P](/enterprise-api/fundamentals/data-dictionary#tweet)ost and [user](/enterprise-api/fundamentals/data-dictionary#user) objects.
