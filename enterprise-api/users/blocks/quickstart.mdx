...
<CardGroup cols={2}>
  <Card title="Mutes" icon="volume-xmark" href="/enterprise-api/users/mutes/introduction">
    Mute users instead of blocking
  </Card>
  <Card title="Follows" icon="user-plus" href="/enterprise-api/users/follows/introduction">
    Manage follows
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/users/blocks/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/users/get-blocking">
