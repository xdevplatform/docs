...
description: "Search X users by keyword with the Enterprise tier User search endpoint to find accounts by name, handle, bio terms, and other public profile fields."
