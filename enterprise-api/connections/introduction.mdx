...
description: "The Stream Connections endpoints let you retrieve the history of your application's streaming. Reference for the Enterprise X API tier covering connections."
