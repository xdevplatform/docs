...
<CardGroup cols={3}>
  ...
  <Card title="API reference" icon="code" href="/enterprise-api/posts/create-post">
...
<CardGroup cols={3}>
  <Card title="Posts" icon="message" href="/enterprise-api/posts/lookup/introduction">
    Search, retrieve, and publish posts. Access timelines, threads, and quote posts.
  </Card>
  <Card title="Users" icon="user" href="/enterprise-api/users/lookup/introduction">
    Look up users, manage follows, blocks, and mutes.
  </Card>
  <Card title="Spaces" icon="microphone" href="/enterprise-api/spaces/lookup/introduction">
    Find live audio conversations and their participants.
  </Card>
  <Card title="Direct Messages" icon="envelope" href="/enterprise-api/direct-messages/lookup/introduction">
    Send and receive private messages.
  </Card>
  <Card title="Lists" icon="list" href="/enterprise-api/lists/list-lookup/introduction">
    Create and manage curated lists of accounts.
  </Card>
  <Card title="Trends" icon="arrow-trend-up" href="/enterprise-api/trends/trends-by-woeid/introduction">
...
<Tabs>
  <Tab title="Full firehose">
    ...
    [Learn more about volume streams](/enterprise-api/posts/volume-streams/introduction)
  </Tab>
  <Tab title="Data access">
    ...
    Customize responses with [fields](/enterprise-api/fundamentals/fields) and [expansions](/enterprise-api/fundamentals/expansions) to get exactly the data you need.
  </Tab>
  <Tab title="Streaming">
    ### Filtered stream
    ...
    [Learn more about filtered stream](/enterprise-api/posts/filtered-stream/introduction)
  </Tab>
  <Tab title="Search & analytics">
    ...
    [Learn more about search](/enterprise-api/posts/search/introduction)
  </Tab>
</Tabs>
