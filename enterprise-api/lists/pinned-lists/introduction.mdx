...
description: "The Pinned Lists endpoints let you view, pin, and unpin Lists for the authenticated user. Reference for the Enterprise X API tier covering pinned lists."
