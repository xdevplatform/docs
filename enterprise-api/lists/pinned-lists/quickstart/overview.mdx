...
description: "The pinned Lists endpoints let you look up a user's pinned Lists and manage which Lists are pinned. Before you begin, you'll need. Enterprise X API v2 tier."
