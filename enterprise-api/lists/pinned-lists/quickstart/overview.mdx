...
description: "The pinned Lists endpoints let you look up a user's pinned Lists and manage which Lists are. Reference for the Enterprise X API tier covering quickstart."
