...
<CardGroup cols={2}>
  <Card title="Pinned Lists lookup" icon="thumbtack" href="/enterprise-api/lists/pinned-lists/quickstart/pinned-list-lookup">
    Get your pinned Lists
  </Card>
  <Card title="Manage pinned Lists" icon="pin" href="/enterprise-api/lists/pinned-lists/quickstart/manage-pinned-lists">
    Pin and unpin Lists
  </Card>
</CardGroup>
