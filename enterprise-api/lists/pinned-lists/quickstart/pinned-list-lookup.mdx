...
description: "This guide walks you through retrieving a user's pinned Lists. Before you begin, you'll need: - A developer account with an. Enterprise X API v2 tier."
