...
description: "Quickstart for retrieving a user's pinned X Lists with the Enterprise tier pinned Lists lookup endpoint, including authentication and sample responses."
