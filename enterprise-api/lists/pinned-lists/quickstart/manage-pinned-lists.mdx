...
description: "This guide walks you through pinning and unpinning Lists. Before you begin, you'll need: - A developer account with an approved App. Enterprise X API v2 tier."
