...
description: "Migrate the standard v1.1 POST lists/members create and destroy endpoints to X API v2 for adding and removing List members with OAuth 1.0a user context."
