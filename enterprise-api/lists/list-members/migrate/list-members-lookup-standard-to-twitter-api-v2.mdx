...
description: "If you have been working with the standard v1.1 GET lists/members and GET lists/memberships. Reference for the Enterprise X API tier covering migrate."
---
