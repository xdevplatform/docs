...
description: If you have been working with the standard v1.1 GET lists/members and GET lists/memberships endpoints, the goal of this guide is to. Enterprise X API v2 tier.
---
