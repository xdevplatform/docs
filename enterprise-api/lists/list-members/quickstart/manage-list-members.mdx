...
<Steps>
  <Step title="Get the List ID and user ID">
    You need the ID of your List and the user ID of the person you want to add. Find user IDs using the [user lookup endpoint](/enterprise-api/users/lookup/introduction).
  </Step>
...
<CardGroup cols={2}>
  <Card title="List members lookup" icon="users" href="/enterprise-api/lists/list-members/quickstart/list-members-lookup">
    Get List members
  </Card>
  <Card title="Manage Lists" icon="pen" href="/enterprise-api/lists/manage-lists/quickstart">
    Create and update Lists
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/lists/add-list-member">
