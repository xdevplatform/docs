...
description: "Use the Enterprise Manage Lists endpoints to create, update, and delete X Lists on behalf of authenticated users and organize accounts into curated timelines."
