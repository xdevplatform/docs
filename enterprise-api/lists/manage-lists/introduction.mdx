...
description: The Manage Lists endpoints let you create, update, and delete Lists on behalf of authenticated users. Create a new List Update List. Enterprise X API v2 tier.
