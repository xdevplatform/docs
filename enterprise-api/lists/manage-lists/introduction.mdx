...
description: "The Manage Lists endpoints let you create, update, and delete Lists on behalf of. Reference for the Enterprise X API tier covering manage lists."
