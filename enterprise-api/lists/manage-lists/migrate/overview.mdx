...
description: The v2 manage Lists endpoints will eventually replace POST lists/create, POST lists/destroy, and POST lists/update. Reference for the enterprise X API.
---
