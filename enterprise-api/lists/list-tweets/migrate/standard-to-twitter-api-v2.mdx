...
description: If you have been working with the standard v1.1 GET lists/statuses endpoint, the goal of this guide is to help you understand the. Enterprise X API v2 tier.
---
