...
description: The v2 List Posts lookup endpoint will replace the standard v1.1 GET lists/statuses. If you have code, apps. Reference for the enterprise X API.
---
