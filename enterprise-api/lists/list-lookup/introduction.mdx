...
description: "Retrieve X List details by ID or fetch all Lists owned by a user with the Enterprise List lookup endpoints, including metadata and ownership info."
