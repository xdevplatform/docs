...
|:-------|:---------|:------------|
| GET | [`/2/lists/:id`](/enterprise-api/lists/get-list) | Get List by ID |
| GET | [`/2/users/:id/owned_lists`](/enterprise-api/users/get-owned-lists) | Get Lists owned by a user |
...
<Card title="Pagination guide" icon="arrow-right" href="/enterprise-api/fundamentals/pagination">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/lists/list-lookup/quickstart">
    Make your first List lookup request
  </Card>
  <Card title="List Posts" icon="list" href="/enterprise-api/lists/list-tweets/introduction">
    Get Posts from a List
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/lists/get-list">
