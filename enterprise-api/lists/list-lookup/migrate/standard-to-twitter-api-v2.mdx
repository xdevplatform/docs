...
description: "Migrate from standard v1.1 GET lists/show and lists/ownerships endpoints to X API v2 List lookup, comparing authentication, rate limits, and response fields."
