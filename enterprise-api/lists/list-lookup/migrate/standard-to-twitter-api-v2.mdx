...
description: "If you have been working with the standard v1.1 GET lists/show and GET lists/ownerships endpoints, the goal of this guide is to help you understand the."
---
