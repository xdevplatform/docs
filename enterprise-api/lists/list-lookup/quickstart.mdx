...
description: "This guide walks you through looking up List information using the List lookup endpoints. Reference for the Enterprise X API tier covering list lookup."
