...
description: "The Likes endpoints let you like and unlike Posts, see which users liked a Post, and get Posts liked. Reference for the Enterprise X API tier covering likes."
