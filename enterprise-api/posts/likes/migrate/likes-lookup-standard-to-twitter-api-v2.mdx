...
description: "If you have been working with the standard v1.1 GET favorites/list endpoint, the goal of this. Reference for the Enterprise X API tier covering migrate."
