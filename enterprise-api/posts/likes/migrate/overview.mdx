...
[Likes lookup: Standard v1.1 to X API v2](/enterprise-api/posts/likes/migrate/likes-lookup-standard-to-twitter-api-v2)

[Manage Likes: Standard v1.1 to X API v2](/enterprise-api/posts/likes#manage-likes-standard-v1-1-compared-to-x-api-v2)
