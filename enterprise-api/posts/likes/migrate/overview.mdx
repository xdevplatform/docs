---
title: Enterprise Likes endpoints v2 migration
description: Compare Standard v1.1 and X API v2 Likes endpoints, including liked Posts lookup and manage Likes, with parameter and rate limit differences.
