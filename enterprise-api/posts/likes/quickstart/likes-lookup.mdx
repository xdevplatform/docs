...
description: "Quickstart guide for retrieving like data from the X API, including liking users and liked Posts, using the Enterprise tier likes lookup endpoints."
