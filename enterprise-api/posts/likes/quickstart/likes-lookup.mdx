...
description: "This guide walks you through retrieving likes data using the X API. Before you begin, you'll need: - A developer account with an. Enterprise X API v2 tier."
