...
<CardGroup cols={2}>
  <Card title="Manage likes" icon="heart" href="/enterprise-api/posts/likes/quickstart/manage-likes">
    Like and unlike Posts
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/get-liking-users">
