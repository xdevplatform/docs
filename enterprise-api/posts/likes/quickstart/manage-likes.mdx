...
<CardGroup cols={2}>
  <Card title="Likes lookup" icon="heart" href="/enterprise-api/posts/likes/quickstart/likes-lookup">
    Get users who liked a Post
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/like-a-post">
