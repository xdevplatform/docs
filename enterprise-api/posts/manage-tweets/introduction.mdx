...
description: "The Manage Posts endpoints let you create and delete Posts on behalf of authenticated users. Reference for the Enterprise X API tier covering manage tweets."
