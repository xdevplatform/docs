---
title: Manage Posts on the Enterprise X API
sidebarTitle: Introduction
description: "Create and delete Posts on behalf of authenticated users with the Enterprise X API manage Posts endpoints. Includes request and response details."
