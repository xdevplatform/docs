---
title: Enterprise manage Posts v2 migration
description: Compare Standard v1.1 statuses endpoints with the X API v2 manage Posts endpoints for creating, deleting, and editing Posts, with parameter mappings.
