...
description: 'If you have been working with the standard v1.1 POST statuses/update and POST statuses/destroy/:id endpoints, the goal of this. Enterprise X API v2 tier.'
---
