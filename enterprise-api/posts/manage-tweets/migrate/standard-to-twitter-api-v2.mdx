...
description: "If you have been working with the standard v1.1 POST statuses/update and POST statuses/destroy/:id. Reference for the Enterprise X API tier covering migrate."
