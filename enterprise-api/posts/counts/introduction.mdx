...
description: "The Post counts endpoints return the volume of Posts matching a query over time, without returning. Reference for the Enterprise X API tier covering counts."
