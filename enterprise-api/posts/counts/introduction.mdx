...
|:---------|:------------|:-------|
| GET [`/2/tweets/counts/recent`](/enterprise-api/posts/get-count-of-recent-posts) | Count Posts from last 7 days | All developers |
| GET [`/2/tweets/counts/all`](/enterprise-api/posts/get-count-of-all-posts) | Count Posts from complete archive | Pay-per-use, Enterprise |
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/counts/quickstart/recent-tweet-counts">
    Make your first recent counts request
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/recent-post-counts">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/counts/quickstart/full-archive-tweet-counts">
    Make your first full-archive counts request
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/full-archive-post-counts">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<Card title="Build a query" icon="magnifying-glass" href="/enterprise-api/posts/counts/integrate/build-a-query">
...
<CardGroup cols={2}>
  <Card title="Recent counts quickstart" icon="clock" href="/enterprise-api/posts/counts/quickstart/recent-tweet-counts">
    Count Posts from the last 7 days
  </Card>
  <Card title="Full-archive quickstart" icon="vault" href="/enterprise-api/posts/counts/quickstart/full-archive-tweet-counts">
    Count historical Posts
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/posts/counts/integrate/overview">
