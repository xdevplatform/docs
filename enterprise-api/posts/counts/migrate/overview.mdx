...
description: "The v2 Post counts endpoint will eventually replace the enterprise Search API’s counts endpoint. Reference for the Enterprise X API tier covering migrate."
---
