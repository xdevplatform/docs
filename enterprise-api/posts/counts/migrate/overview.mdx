...
| Supports filtering using [annotations](/enterprise-api/fundamentals/post-annotations) |     | ✔   |
| Supports filtering using [conversation_id](/enterprise-api/fundamentals/conversation-id) |     | ✔   |
...
| Timezone | UTC | UTC |
| Requires the use of credentials from a [developer App](/resources/fundamentals/developer-apps) associated with a [Project](/resources/fundamentals/developer-apps) that has [Academic Research access](/enterprise-api/getting-started/about-x-api) |     | ✔   |
...
* [Enterprise operators](/enterprise-api/enterprise-gnip-2.0/fundamentals/search-api#building-search-queries)
* [X API v2 operators](/enterprise-api/posts/search/integrate/build-a-query)
...
[Post counts: Enterprise to X API v2](/enterprise-api/posts/counts/migrate/overview)
