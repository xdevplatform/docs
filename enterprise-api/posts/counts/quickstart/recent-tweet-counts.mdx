...
description: "This guide walks you through getting Post counts (volume) for the last 7 days. Before you begin, you'll need: - A developer account. Enterprise X API v2 tier."
