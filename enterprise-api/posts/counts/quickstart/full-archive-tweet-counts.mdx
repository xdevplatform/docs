...
<Warning>
Full-archive Post counts requires [Self-serve](/enterprise-api/getting-started/about-x-api) or [Enterprise](/enterprise-api/getting-started/about-x-api) access.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Recent counts" icon="clock" href="/enterprise-api/posts/counts/quickstart/recent-tweet-counts">
  ...
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/full-archive-post-count">
