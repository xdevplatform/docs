...
description: "This page covers tools and key concepts for integrating the Post counts endpoints. Reference for the Enterprise X API tier covering integrate."
---
