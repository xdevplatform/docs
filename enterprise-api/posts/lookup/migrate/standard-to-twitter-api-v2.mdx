...
description: "If you have been working with the standard v1.1 GET statuses/show and GET statuses/lookup, this. Reference for the Enterprise X API tier covering migrate."
