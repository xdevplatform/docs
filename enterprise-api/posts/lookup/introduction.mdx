...
|:-------|:---------|:------------|
| GET | [`/2/tweets/:id`](/enterprise-api/posts/get-post-by-id) | Retrieve a single Post by ID |
| GET | [`/2/tweets`](/enterprise-api/posts/get-posts-by-ids) | Retrieve multiple Posts by IDs (up to 100) |
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/lookup/quickstart">
    Make your first Post lookup request
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/posts/lookup/integrate">
    Learn key concepts and best practices
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/get-post-by-id">
