...
description: '1% sampled stream. 10% sampled stream. Commonly referred to as the "Decahose." These are referred to as "volume streams" because. Enterprise X API v2 tier.'
---
