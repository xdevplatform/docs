...
<CardGroup cols={2}>
  ...
  <Card title="Handling disconnections" icon="plug" href="/enterprise-api/posts/filtered-stream/integrate/handling-disconnections">
    Reconnect gracefully
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/filtered-stream">
