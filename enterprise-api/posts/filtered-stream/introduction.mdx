...
description: The Filtered Stream endpoints let you receive near real-time Posts that match your filter rules. Create rules using powerful. Enterprise X API v2 tier.
