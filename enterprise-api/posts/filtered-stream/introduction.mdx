...
description: "The Filtered Stream endpoints let you receive near real-time Posts that match your filter. Reference for the Enterprise X API tier covering filtered stream."
