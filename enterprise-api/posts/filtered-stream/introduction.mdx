...
description: "The Filtered Stream endpoints let you receive near real-time Posts that match your filter. Enterprise adds higher limits and semantic embedding operators for Filtered Stream only. Reference for the Enterprise X API tier covering filtered stream."
