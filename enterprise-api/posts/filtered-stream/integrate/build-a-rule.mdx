...
description: "The filtered stream endpoints deliver Posts that match a set of rules applied to the stream. Reference for the Enterprise X API tier covering integrate."
