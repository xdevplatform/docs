...
This page provides a complete list of operators available when [building rules](/enterprise-api/posts/filtered-stream/integrate/build-a-rule) for Filtered Stream.
...
<CardGroup cols={2}>
  ...
  <Card title="Filtered Stream introduction" icon="bolt" href="/enterprise-api/posts/filtered-stream/introduction">
