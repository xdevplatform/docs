...
description: "Complete Enterprise Filtered Stream operator reference, including keyword, has:, is:, and semantic embedding: operators for matching Posts in real time."
