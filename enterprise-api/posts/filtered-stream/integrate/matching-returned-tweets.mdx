...
description: "Map Posts delivered by Enterprise Filtered Stream back to the rules they matched, including embedding_similarity scores for semantic embedding rules."
---
