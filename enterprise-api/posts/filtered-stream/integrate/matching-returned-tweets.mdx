...
description: "The filtered stream endpoint gives you the ability to have multiple rules in place through a. Reference for the Enterprise X API tier covering integrate."
---
