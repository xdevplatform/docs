...
description: "This guide walks you through retrieving Posts that mention a specific user. Before you begin, you'll need: - A developer account. Enterprise X API v2 tier."
