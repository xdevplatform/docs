...
<Steps>
  <Step title="Get the user ID">
    Find the user ID using the [user lookup endpoint](/enterprise-api/users/lookup/introduction). For example, @XDevelopers has user ID `2244994945`.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Home timeline" icon="house" href="/enterprise-api/posts/timelines/quickstart/reverse-chron-quickstart">
