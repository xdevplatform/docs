...
description: "The Timelines endpoints let you retrieve Posts from user timelines, mention feeds, and home. Reference for the Enterprise X API tier covering timelines."
