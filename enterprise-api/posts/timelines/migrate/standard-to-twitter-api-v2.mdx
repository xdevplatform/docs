...
description: "If you have been working with the v1.1 timelines endpoints (statuses/user\\timeline and. Reference for the Enterprise X API tier covering migrate."
