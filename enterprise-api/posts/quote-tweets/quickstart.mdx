...
<CardGroup cols={2}>
  <Card title="Retweets" icon="retweet" href="/enterprise-api/posts/retweets/introduction">
    Look up Retweets
  </Card>
  <Card title="Post lookup" icon="magnifying-glass" href="/enterprise-api/posts/lookup/introduction">
    Look up Posts by ID
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/get-quoted-posts">
