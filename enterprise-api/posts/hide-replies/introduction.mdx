...
|:-------|:---------|:------------|
| PUT | [`/2/tweets/:tweet_id/hidden`](/enterprise-api/posts/hide-reply) | Hide or unhide a reply |
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/hide-replies/quickstart">
    Hide your first reply
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/hide-replies">
