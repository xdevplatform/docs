...
description: "Through the hide replies endpoint, you can build integrations to help people and brands keep. Reference for the Enterprise X API tier covering integrate."
---
