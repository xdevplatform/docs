...
description: With the hide replies endpoint, you can build a workflow to help your users hide replies that have a very high-probability of being. Enterprise X API v2 tier.
---
