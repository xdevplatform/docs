...
2.  It uses the [Account Activity API](https://developer.x.com/en/docs/enterprise-api/v1/accounts-and-users/subscribe-account-activity/overview) to detect incoming replies.
