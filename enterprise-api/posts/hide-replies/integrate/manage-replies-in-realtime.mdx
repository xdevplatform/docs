...
description: "With the hide replies endpoint, you can build a workflow to help your users hide replies that. Reference for the Enterprise X API tier covering integrate."
---
