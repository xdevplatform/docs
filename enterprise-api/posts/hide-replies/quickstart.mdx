...
<CardGroup cols={2}>
  <Card title="Manage by topic" icon="tags" href="/enterprise-api/posts/hide-replies/integrate/manage-replies-by-topic">
    Moderate replies based on content
  </Card>
  <Card title="Real-time moderation" icon="bolt" href="/enterprise-api/posts/hide-replies/integrate/manage-replies-in-realtime">
    Moderate replies as they arrive
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/hide-reply">
