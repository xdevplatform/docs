...
description: The Bookmarks endpoints let you view, add, and remove bookmarked Posts for the authenticated user. Bookmarks are private and only. Enterprise X API v2 tier.
