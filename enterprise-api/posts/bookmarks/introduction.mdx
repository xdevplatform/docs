...
description: "The Bookmarks endpoints let you view, add, and remove bookmarked Posts for the authenticated. Reference for the Enterprise X API tier covering bookmarks."
