...
<Steps>
  <Step title="Get your user ID">
    You need your authenticated user's ID. You can find it using the `/2/users/me` endpoint or the [user lookup endpoint](/enterprise-api/users/lookup/introduction).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Bookmarks lookup" icon="bookmark" href="/enterprise-api/posts/bookmarks/quickstart/bookmarks-lookup">
    Get your bookmarked Posts
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/add-post-to-bookmarks">
