...
<Steps>
  <Step title="Get your user ID">
    You need your authenticated user's ID. You can find it using the `/2/users/me` endpoint or from the [user lookup endpoint](/enterprise-api/users/lookup/introduction).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Manage bookmarks" icon="bookmark" href="/enterprise-api/posts/bookmarks/quickstart/manage-bookmarks">
    Add and remove bookmarks
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/get-users-bookmarks">
