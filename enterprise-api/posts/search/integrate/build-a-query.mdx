...
description: "The search endpoints accept a single query with a GET request and return a set of historical. Reference for the Enterprise X API tier covering integrate."
