...
This page provides a complete list of operators available when [building a query](/enterprise-api/posts/search/integrate/build-a-query) for the Search API endpoints.
...
<CardGroup cols={2}>
  <Card title="Build a query" icon="filter" href="/enterprise-api/posts/search/integrate/build-a-query">
    Learn query syntax and best practices
  </Card>
  <Card title="Search introduction" icon="magnifying-glass" href="/enterprise-api/posts/search/introduction">
