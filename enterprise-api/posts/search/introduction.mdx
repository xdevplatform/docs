...
description: "The Search Posts endpoints let you find Posts matching specific criteria using powerful query. Reference for the Enterprise X API tier covering search."
