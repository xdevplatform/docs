...
|:-------|:---------|:------------|:-------|
| GET | [`/2/tweets/search/recent`](/enterprise-api/posts/search-recent-posts) | Search Posts from last 7 days | All developers |
| GET | [`/2/tweets/search/all`](/enterprise-api/posts/search-all-posts) | Search complete Post archive | Pay-per-use, Enterprise |
...
<Card title="Full operator reference" icon="list-check" href="/enterprise-api/posts/search/integrate/operators">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/search/quickstart/recent-search">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/posts/search/quickstart/full-archive-search">
    Make your first full-archive search request
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/search-all-posts">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Pagination" icon="arrow-right" href="/enterprise-api/posts/search/integrate/paginate">
    Navigate through large result sets
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/posts/search/integrate/overview">
