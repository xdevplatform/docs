...
description: "If you have been working with the v1.1 search/posts, the goal of this guide is to help you. Reference for the Enterprise X API tier covering migrate."
