...
If you have been working with the v1.1 [search/posts](/enterprise-api/posts/search/introduction), the goal of this guide is to help you understand the similarities and differences between the standard and X API v2 search Posts endpoint.
...
Both versions provide metadata that describes any edit history. Check out the [search API References](/enterprise-api/posts/recent-search) and the [Post edits fundamentals page](/enterprise-api/fundamentals/edit-posts) for more details. 
...
| :--- | :--- |
| geocode | Search Posts supports geo operators for location-based queries. |
...
# Search recent Posts - SDK handles pagination automatically
...
[Check out our quick start guide for X API v2 recent search](/enterprise-api/posts/search/quickstart/recent-search)

[Review the API reference for recent search](/enterprise-api/posts/recent-search)
...
[Step-by-step guide to making your first request to recent search](/enterprise-api/getting-started/make-your-first-request "Step-by-step guide to making your first request to recent search")
