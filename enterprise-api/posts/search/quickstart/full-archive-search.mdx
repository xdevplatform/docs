...
<Warning>
Full-archive search requires [Self-serve](/enterprise-api/getting-started/about-x-api) or [Enterprise](/enterprise-api/getting-started/about-x-api) access. [Upgrade your access](https://developer.x.com/en/portal/products) to use this endpoint.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/full-archive-search">
