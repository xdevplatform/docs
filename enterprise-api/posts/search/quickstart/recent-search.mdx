...
<Steps>
  <Step title="Build a query" icon="magnifying-glass">
    ...
    <Tip>
    See the [full operator reference](/enterprise-api/posts/search/integrate/operators) for all available options.
    </Tip>
  </Step>
...
```
  ...
  <Step title="Paginate through results" icon="arrow-right">
    ...
    <Card title="Pagination guide" icon="arrow-right" href="/enterprise-api/posts/search/integrate/paginate">
...
<CardGroup cols={2}>
  <Card title="Build a query" icon="magnifying-glass" href="/enterprise-api/posts/search/integrate/build-a-query">
    Master query syntax and operators
  </Card>
  <Card title="Operator reference" icon="list-check" href="/enterprise-api/posts/search/integrate/operators">
    See all available operators
  </Card>
  <Card title="Full-archive search" icon="vault" href="/enterprise-api/posts/search/quickstart/full-archive-search">
    Search the complete Post archive
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/search-recent-posts">
