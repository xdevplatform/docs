...
description: "This guide walks you through making your first recent search request to find Posts from the last 7 days. Before you begin, you'll. Enterprise X API v2 tier."
