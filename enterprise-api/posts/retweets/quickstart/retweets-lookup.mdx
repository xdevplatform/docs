...
<CardGroup cols={2}>
  <Card title="Manage Retweets" icon="retweet" href="/enterprise-api/posts/retweets/quickstart/manage-retweets">
    Retweet and undo Retweets
  </Card>
  <Card title="Quote Posts" icon="quote-left" href="/enterprise-api/posts/quote-tweets/quickstart">
    Get Quote Posts
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/get-retweeted-by">
