...
description: "This guide walks you through Retweeting and undoing Retweets using the X API. Before you begin, you'll need: - A developer account. Enterprise X API v2 tier."
