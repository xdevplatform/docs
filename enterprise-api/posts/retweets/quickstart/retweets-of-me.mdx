...
<CardGroup cols={2}>
  ...
  <Card title="Manage Retweets" icon="share" href="/enterprise-api/posts/retweets/quickstart/manage-retweets">
    Retweet and undo Retweets
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/posts/reposts-of-me">
