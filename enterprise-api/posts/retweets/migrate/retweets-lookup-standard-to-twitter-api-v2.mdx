...
description: "If you have been working with the standard v1.1 v1.1 GET statuses/retweets/:id, v1.1 GET. Reference for the Enterprise X API tier covering migrate."
