...
description: "If you have been working with the standard v1.1 POST statuses/retweet/:id, and POST. Reference for the Enterprise X API tier covering migrate."
---
