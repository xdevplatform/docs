---
title: Enterprise Reposts endpoints v2 migration
description: Compare Standard v1.1 retweets endpoints with the X API v2 manage Reposts and Reposts lookup endpoints, including parameters and authentication.
