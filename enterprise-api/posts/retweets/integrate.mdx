...
We've added a guide on how to [use fields and expansions](/enterprise-api/fundamentals/data-dictionary#how-to-use-fields-and-expansions) together to our [X API v2 data dictionary](/enterprise-api/fundamentals/data-dictionary).
