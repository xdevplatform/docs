---
title: X Activity API for Enterprise real-time events
sidebarTitle: Introduction
description: "Subscribe to real-time X Activity events like post.create, follow, profile updates, and Spaces start or end, delivered via HTTP stream or webhook."
