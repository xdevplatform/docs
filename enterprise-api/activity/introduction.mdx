...
description: The X Activity API (XAA) endpoint group allows developers to tap into activity events happening on the X Platform. A developer can subscribe to events.
---
