...
description: "Subscribe to real-time X Activity API events like post.create, follow, profile updates, and Spaces start or end, delivered via HTTP stream or webhook."
