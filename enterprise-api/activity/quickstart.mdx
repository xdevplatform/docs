...
description: "This guide explains how to subscribe for and receive events using the X Activity API endpoints. Reference for the Enterprise X API tier covering activity."
---
