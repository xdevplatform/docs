...
<Steps>
  <Step title="Get the recipient's user ID">
    You need the user ID of the person you want to message. You can get this from the [User lookup endpoint](/enterprise-api/users/lookup/introduction).
  </Step>
...
<Steps>
  <Step title="Upload the media">
    First, upload your media using the [Media Upload endpoint](/enterprise-api/media/quickstart/media-upload-chunked).
  </Step>
...
<CardGroup cols={2}>
  <Card title="DM lookup" icon="inbox" href="/enterprise-api/direct-messages/lookup/quickstart">
    Retrieve DM conversations
  </Card>
  <Card title="Integration guide" icon="book" href="/enterprise-api/direct-messages/manage/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/direct-messages/create-dm-message-by-participant-id">
