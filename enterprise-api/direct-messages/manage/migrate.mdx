...
description: "Both v1.1 and v2 versions of the Direct Messages endpoints provide methods for creating Direct. Reference for the Enterprise X API tier covering manage."
---
