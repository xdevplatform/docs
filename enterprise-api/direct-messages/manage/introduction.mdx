...
<CardGroup cols={2}>
  ...
  <Card title="DM lookup" icon="messages" href="/enterprise-api/direct-messages/lookup/introduction">
    Retrieve DM events
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/direct-messages/send-new-message">
