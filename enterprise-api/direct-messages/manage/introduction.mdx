...
description: "The Manage Direct Messages endpoints let you send and delete Direct Messages on behalf of. Reference for the Enterprise X API tier covering manage."
