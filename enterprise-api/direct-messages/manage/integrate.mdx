...
description: "This guide covers the key concepts you need to integrate the manage Direct Messages endpoints into. Reference for the Enterprise X API tier covering manage."
---
