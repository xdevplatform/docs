...
<Steps>
  <Step title="Upload media">
    Use the [Media Upload endpoint](/enterprise-api/media/quickstart/media-upload-chunked) to upload your file and get a `media_id`.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/direct-messages/manage/quickstart">
    Send your first Direct Message
  </Card>
  <Card title="DM lookup" icon="inbox" href="/enterprise-api/direct-messages/lookup/introduction">
