---
title: Manage Direct Message blocks on the Enterprise API
sidebarTitle: Introduction
keywords: ["DM blocks", "direct message blocks", "block DMs", "DM blocking", "direct message blocking", "block messages"]

description: "Use the Enterprise Manage DM blocks endpoints to block or unblock accounts on behalf of an authenticated user and control who can send Direct Messages on X."
---
