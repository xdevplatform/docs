...
description: "The manage DM blocks endpoints enable you to block or unblock a specified account on behalf of an. Reference for the Enterprise X API tier covering blocks."
---
