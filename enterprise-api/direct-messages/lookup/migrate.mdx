...
| Default request [rate limits](/enterprise-api/fundamentals/rate-limits)*  <br/>*All requests require user tokens |     | GET requests: 300 requests per 15 mins<br/><br/>Rate limit is applied across all three endpoints |
...
| Default request [rate limits](/enterprise-api/fundamentals/rate-limits) | 15 requests per 15 minutes | 300 requests per 15 minutes  <br/>Rate limit is applied across all three GET endpoints |
