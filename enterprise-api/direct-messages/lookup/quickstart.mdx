...
description: "This guide walks you through retrieving Direct Message events for the authenticated user. Reference for the Enterprise X API tier covering lookup."
