...
description: "This guide covers the key concepts you need to integrate the Direct Messages lookup endpoints into. Reference for the Enterprise X API tier covering lookup."
---
