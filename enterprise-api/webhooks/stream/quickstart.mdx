...
The v2 filtered stream webhooks API is similar to the [v2 filtered stream endpoint](/enterprise-api/posts/filtered-stream/introduction) in terms of setting up the rules to filter on. The difference lies in the delivery mechanism for the Posts that match your rules.
