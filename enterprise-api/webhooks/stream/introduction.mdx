...
description: "The filtered stream endpoint group enables developers to filter a stream of public Posts. Reference for the Enterprise X API tier covering stream."
---
