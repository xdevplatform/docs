...
| Product | Description |
|:--------|:------------|
| [X Activity API (XAA)](/enterprise-api/activity/introduction) | Receive real-time events for activity happening on X |
| [Account Activity API (AAA)](/enterprise-api/account-activity/introduction) | Receive real-time events tied to specific user accounts |
| [Filtered Stream Webhooks](/enterprise-api/webhooks/stream/introduction) | Receive filtered stream Posts via webhook delivery |
...
| **CRC support** | Must respond to Challenge-Response Check GET requests ([learn more](/enterprise-api/webhooks/quickstart#2-the-crc-check)) |
...
|:-------|:---------|:------------|
| POST | [`/2/webhooks`](/enterprise-api/webhooks/create-webhook) | Register a new webhook |
| GET | [`/2/webhooks`](/enterprise-api/webhooks/get-webhook) | List registered webhooks |
| DELETE | [`/2/webhooks/:webhook_id`](/enterprise-api/webhooks/delete-webhook) | Delete a webhook |
| POST | [`/2/webhooks/replay`](/enterprise-api/webhooks/create-replay-job-for-webhook) | Create a replay job for webhook |
| PUT | [`/2/webhooks/:webhook_id`](/enterprise-api/webhooks/validate-webhook) | Trigger CRC check and re-enable a webhook |
...
<Card title="See full implementation details" icon="code" href="/enterprise-api/webhooks/quickstart">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/enterprise-api/webhooks/quickstart">
    Set up your webhook end-to-end
  </Card>
  <Card title="Filtered Stream Webhooks" icon="filter" href="/enterprise-api/webhooks/stream/introduction">
    Receive filtered Posts via webhook
  </Card>
  <Card title="Account Activity API" icon="bell" href="/enterprise-api/account-activity/introduction">
    Receive account events via webhook
  </Card>
  <Card title="Sample apps" icon="github" href="/enterprise-api/webhooks/quickstart#sample-apps">
