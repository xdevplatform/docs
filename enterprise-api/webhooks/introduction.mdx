...
description: "The V2 Webhooks API enables developers to receive real-time event notifications from X accounts. Reference for the Enterprise X API tier covering webhooks."
