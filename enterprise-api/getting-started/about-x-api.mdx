...
description: Overview of the X Enterprise API, including full firehose access, volume and likes streams, account activity webhooks, custom rate limits, and support.
...
<CardGroup cols={3}>
  ...
  <Card title="Users" icon="/icons/xds/icon-person.svg">
  ...
  <Card title="Direct Messages" icon="/icons/xds/icon-envelope.svg">
    Send and receive private messages between users.
  </Card>
  <Card title="Lists" icon="/icons/xds/icon-bulleted-list.svg">
    Create and manage curated lists of accounts.
  </Card>
  <Card title="Trends" icon="/icons/xds/icon-feather-chart-line.svg">
...
<CardGroup cols={2}>
  <Card title="Apply for access" icon="/icons/xds/icon-key.svg" href="/forms/enterprise-api-interest">
    Contact our sales team to discuss your needs.
  </Card>
  <Card title="Explore endpoints" icon="/icons/xds/icon-rocket.svg" href="/x-api/posts/create-post">
