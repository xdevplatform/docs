...
description: "Apply for X Enterprise API access, work with your dedicated account team during onboarding, and get credentials configured for your data volume."
...
<CardGroup cols={2}>
  ...
  <Card title="Use minimal scopes" icon="/icons/xds/icon-shield-check.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Learn about authentication" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
