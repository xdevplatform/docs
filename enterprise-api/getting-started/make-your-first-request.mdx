...
This guide walks you through making your first X API request. You'll need a [developer account with app credentials](/enterprise-api/getting-started/getting-access) before starting.
...
<Steps>
  ...
  <Step title="Choose an endpoint">
    ...
    |:---------|:-------------|
    | [User lookup](/enterprise-api/users/lookup/introduction) | Get user profile by username or ID |
    | [Post lookup](/enterprise-api/posts/lookup/introduction) | Get post by ID |
    | [Recent search](/enterprise-api/posts/search/introduction) | Search posts from the last 7 days |
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="API reference" icon="code" href="/enterprise-api/posts/lookup/introduction">
...
[Full error reference →](/enterprise-api/fundamentals/response-codes-and-errors)
...
<CardGroup cols={2}>
  ...
  <Card title="Explore endpoints" icon="compass" href="/enterprise-api/posts/search/introduction">
  ...
  <Card title="Build something" icon="hammer" href="/enterprise-api/what-to-build">
