...
<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="/enterprise-api/introduction">
...
<CardGroup cols={2}>
  ...
  <Card title="What to Build" icon="lightbulb" href="/enterprise-api/what-to-build">
    Ideas and inspiration for projects.
  </Card>
  <Card title="Migration Guide" icon="route" href="/enterprise-api/migrate/overview">
