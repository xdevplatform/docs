...
description: "This guide walks you through retrieving Space information using the Spaces lookup endpoints. Reference for the Enterprise X API tier covering lookup."
