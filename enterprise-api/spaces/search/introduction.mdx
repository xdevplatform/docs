...
description: "The Spaces Search endpoint lets you search for live or scheduled Spaces by keyword. Reference for the Enterprise X API tier covering search."
