...
description: "Quickstart guide for searching X Spaces by keyword with the Enterprise tier Spaces search endpoint, covering authentication and example requests."
