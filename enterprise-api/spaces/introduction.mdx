---
title: Spaces endpoints on the Enterprise API
sidebarTitle: Introduction
description: "Explore the X API Spaces endpoints to look up live or scheduled audio Spaces, search by keyword, and understand host, speaker, and listener roles."
