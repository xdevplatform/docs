...
|:-------|:---------|:------------|
| GET | [`/2/communities/search`](/enterprise-api/communities/search-communities) | Search for Communities |
...
<CardGroup cols={2}>
  <Card title="Communities lookup" icon="users-rectangle" href="/enterprise-api/communities/lookup/introduction">
    Look up Communities by ID
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/communities/search-communities">
