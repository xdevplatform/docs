...
description: "The Communities lookup endpoint lets you retrieve information about X Communities by their ID. Reference for the Enterprise X API tier covering lookup."
