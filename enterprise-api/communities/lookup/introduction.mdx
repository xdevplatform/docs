...
description: The Communities lookup endpoint lets you retrieve information about X Communities by their ID. Communities are public or private. Enterprise X API v2 tier.
