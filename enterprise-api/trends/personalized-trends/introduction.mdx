...
<CardGroup cols={2}>
  <Card title="Trends by WOEID" icon="globe" href="/enterprise-api/trends/trends-by-woeid/introduction">
    Get trends for a specific location
  </Card>
  <Card title="API Reference" icon="code" href="/enterprise-api/trends/personalized-trends">
