...
description: The Personalized Trends endpoint returns trending topics tailored to the authenticated user, based on their location and interests. Enterprise X API v2 tier.
