...
description: "The Personalized Trends endpoint returns trending topics tailored to the authenticated. Reference for the Enterprise X API tier covering personalized trends."
