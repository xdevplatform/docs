...
The Livestream API, including the scheduling endpoints, is only available under the Enterprise plan. To request access, submit the [Livestream API Access Form](/forms/livestream-api-access). See [Getting Started](/livestream-api/getting-started) for the full list of prerequisites.
