...
<CardGroup cols={3}>
  <Card title="Get started" icon="rocket" href="/livestream-api/getting-started">
    Prerequisites, access, and credentials.
  </Card>
  ...
  <Card title="Request access" icon="key" href="/forms/livestream-api-access">
    Submit the Livestream API Access Form for review.
  </Card>
</CardGroup>
