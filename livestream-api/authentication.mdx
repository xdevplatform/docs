...
- Your application must be whitelisted for the Livestream API. To request access, submit the [Livestream API Access Form](/forms/livestream-api-access).
...
- Your application must be whitelisted for the Livestream API.
