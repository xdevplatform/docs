...
- Your application must be enabled for the Livestream API under an Enterprise plan. To request access, submit the [Livestream API Access Form](/forms/livestream-api-access).
