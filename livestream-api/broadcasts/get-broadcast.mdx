...
<Info>
A variant of this lookup, [`GET /2/broadcasts/:id`](/livestream-api/broadcasts/get-broadcast-by-id), omits the user ID from the path — the broadcast must still be owned by the authenticated user.
</Info>
