...
All of these require [user context authentication](/livestream-api/fundamentals/authentication). OAuth 2.0 (with `broadcast.read` and `broadcast.write` scopes) is recommended; OAuth 1.0a is also supported.
