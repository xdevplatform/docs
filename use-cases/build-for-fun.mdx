---
title: Build for fun
description: Hobbyist projects to build with the X API, from creative bots and IoT installations to art projects, games, and weekend hacks using real-time data.
mode: wide
keywords: ["fun projects", "creative projects", "hobby projects", "IoT", "art projects", "creative coding", "side projects"]
---
