...
description: Use the X API in classrooms and curricula to teach API design, data analysis, social media research, and software engineering with real-world data.
mode: wide
