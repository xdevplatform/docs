...
description: Build consumer apps with the X API that enhance how people post, follow, search, and engage on X, from utilities and chatbots to creator tools.
mode: wide
...
<CardGroup>
  ...
  [**Learn more**](/x-api/what-to-build#moderate-conversations-for-health-and-safety) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#enable-creation-and-personal-expression) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#measure-and-analyze-whats-happening) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#improve-community-experiences) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#curate-and-recommend-content) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#impact-the-greater-good) <Icon icon="/icons/xds/icon-arrow-right.svg"/>
  </Card>
</CardGroup>
