...
<CardGroup>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-safety-moderation) <Icon icon="arrow-right"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-creators) <Icon icon="arrow-right"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-analytics) <Icon icon="arrow-right"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-communities) <Icon icon="arrow-right"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-research) <Icon icon="arrow-right"/>
  </Card>
  ...
  [**Learn more**](/x-api/what-to-build#build-for-good) <Icon icon="arrow-right"/>
  </Card>
</CardGroup>
