---
title: Get historical Posts with full-archive search
description: Step-by-step tutorial for retrieving historical Posts back to 2006 using the X API v2 full-archive search endpoint, query operators, and pagination.
mode: wide
...
full-archive endpoint with the new next_token for each request.
