...
description: "Tutorial for calling the X API v2 user lookup endpoint from R using httr and jsonlite, including bearer token setup and parsing JSON responses in R."
mode: wide
