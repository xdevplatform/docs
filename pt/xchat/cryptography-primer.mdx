---
title: "Como o X Chat mantém suas mensagens seguras"
sidebarTitle: Introdução à Criptografia
description: "Um guia em linguagem simples sobre como o X Chat protege as mensagens: chaves, criptografia, assinaturas digitais e backups seguros, sem exigir conhecimento de criptografia."
keywords: ["criptografia do X Chat", "introdução à criptografia", "criptografia de chave pública", "ECDH", "ECIES", "assinaturas digitais", "chaves de conversa", "backup seguro de chaves"]
---

O X Chat é criptografado: as mensagens de um usuário, em texto simples, existem apenas em seus dispositivos. Esta página explica como isso funciona.
...
| **Bisbilhoteiros de rede** | Segurança de transporte mais conteúdo criptografado | TLS padrão, mais tudo acima |
...
|:-----------|:-------------------|
| **Um dispositivo comprometido** | Um cliente desbloqueado detém texto simples e chaves em bruto. Nenhum design de criptografia sobrevive a um endpoint comprometido. |
...
<CardGroup cols={2}>
  <Card title="Primeiros passos" icon="/icons/xds/icon-rocket.svg" href="/xchat/getting-started">
    Implemente chaves, envio e recebimento passo a passo
  </Card>
  <Card title="Referência do Chat XDK" icon="/icons/xds/icon-code.svg" href="/xchat/xchat-xdk">
    Métodos e tipos do SDK de criptografia
  </Card>
  <Card title="Introdução" icon="/icons/xds/icon-book.svg" href="/xchat/introduction">
