...
description: "Diagnostique problemas de criptografia do X Chat: erros do Chat XDK, recuperação do backup seguro de chave, falhas de descriptografia e payloads assinados."
