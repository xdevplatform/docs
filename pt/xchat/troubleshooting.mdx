---
title: "Resolva problemas comuns do X Chat"
sidebarTitle: Solução de problemas
description: "Soluções para os problemas mais comuns do X Chat: configuração de chaves, recuperação de backup, mensagens que não descriptografam e erros de envio."
keywords: ["erros do X Chat", "solução de problemas", "Chat XDK", "falha de descriptografia", "backup seguro de chaves", "erros de criptografia"]
---
...
- A **API** armazena e retorna a chave exatamente como o registro fez o upload: a codificação DER (SPKI), que é a chave em bruto atrás de um prefixo fixo de identificador de algoritmo
