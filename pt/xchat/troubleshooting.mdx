...
Esta página cobre problemas que são **específicos da criptografia do X Chat e do Chat XDK** — chaves, Juicebox, descriptografia/verificação e construção de payloads criptografados de envio.
...
### O desbloqueio falha (PIN inválido)

- Confirme que o PIN corresponde ao usado com `setup`
...
- **Não** registre texto simples, PINs, chaves privadas ou blobs de chave completos
