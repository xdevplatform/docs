...
description: Referência do Chat XDK, o SDK de criptografia que gerencia chaves, criptografia, descriptografia e assinatura para o X Chat nas linguagens suportadas.
