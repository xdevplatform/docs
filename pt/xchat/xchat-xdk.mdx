...
description: Referência do Chat XDK, o SDK de criptografia que cuida do gerenciamento de chaves, criptografia, descriptografia e assinatura do X Chat nas linguagens suportadas.
