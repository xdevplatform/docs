...
description: Referência do Chat XDK, o SDK de criptografia que cuida da gestão de chaves, criptografia, descriptografia e assinatura para o X Chat nas linguagens suportadas.
