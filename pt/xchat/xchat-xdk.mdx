---
title: "Chat XDK: o kit de criptografia do X Chat"
sidebarTitle: Chat XDK
description: "Conheça o Chat XDK, a biblioteca que cuida de chaves, criptografia, descriptografia e assinatura por você, com referências para todas as linguagens suportadas."
keywords: ["Chat XDK", "chat-xdk", "SDK de criptografia", "gerenciamento de chaves", "assinatura", "referência do SDK"]
---
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    O mecanismo WASM compilado é entregue dentro do pacote; não há etapa de build. Requer Node.js 18+.
  </Tab>
  <Tab title="Rust">
    ```toml
    [dependencies]
...
<CardGroup cols={2}>
  <Card title="Primeiros passos" icon="/icons/xds/icon-rocket.svg" href="/pt/xchat/getting-started">
    Conecte o Chat XDK à Chat API
  </Card>
  <Card title="Mídia" icon="/icons/xds/icon-photo.svg" href="/pt/xchat/media">
