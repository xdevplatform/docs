---
title: "Receba mensagens do X Chat em tempo real"
sidebarTitle: Eventos em tempo real
description: "Saiba de novas mensagens e eventos do X Chat em tempo real via webhooks ou stream, e descriptografe-os com o Chat XDK."
keywords: ["eventos do X Chat", "webhooks", "activity stream", "mensagens em tempo real", "chat.received", "chat.sent"]
---
