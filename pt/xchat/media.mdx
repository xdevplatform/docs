---
title: "Envie imagens e arquivos no X Chat"
sidebarTitle: Mídia
description: "Compartilhe imagens e anexos nos seus chats criptografados: criptografe, envie, baixe e descriptografe mídia com o Chat XDK."
keywords: ["mídia do X Chat", "imagens criptografadas", "anexos", "encrypt_stream", "upload de mídia", "download de mídia"]
---
...
Este caminho **não** é o modelo de mídia de Posts (`expansions=attachments.media_keys`, `media.fields=variants` etc.). Esses parâmetros se aplicam a **Posts**; blobs criptografados do X Chat são endereçados por **`media_hash_key`** e download de mídia do X Chat.
