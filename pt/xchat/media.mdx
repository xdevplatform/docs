...
sidebarTitle: Mídia
description: "Criptografe, envie, baixe e descriptografe imagens e anexos no X Chat com a criptografia de stream do Chat XDK e os endpoints de upload de mídia da X API."
