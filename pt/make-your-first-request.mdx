...
icon: rocket
description: Envie sua primeira solicitação à X API v2 em minutos usando cURL ou Postman, incluindo autenticação, escolha de endpoint e leitura da resposta em JSON.
...
Este guia mostra como fazer sua primeira solicitação à X API. Você precisará de uma [conta de desenvolvedor com credenciais de app](/x-api/getting-started/getting-access) antes de começar.
...
<Steps>
  <Step title="Obtenha seu Bearer Token">
    No [Developer Console](https://console.x.com), acesse seu app e copie o Bearer Token.
  </Step>
  <Step title="Escolha um endpoint">
    ...
    | Endpoint | O que faz |
    |:---------|:----------|
    | [User lookup](/x-api/users/lookup/introduction) | Obtenha o perfil do usuário por nome de usuário ou ID |
...
<CardGroup cols={3}>
  ...
  <Card title="Referência da API" icon="/icons/xds/icon-code.svg" href="/x-api/posts/lookup/introduction">
...
<CardGroup cols={2}>
  <Card title="Aprender autenticação" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
    Entenda o OAuth para solicitações com contexto de usuário.
  </Card>
  <Card title="Explorar endpoints" icon="compass" href="/x-api/posts/search/introduction">
    Descubra o que você pode criar.
  </Card>
  <Card title="Usar um SDK" icon="cube" href="/tools-and-libraries">
    Desenvolva mais rápido com as bibliotecas oficiais.
  </Card>
  <Card title="Criar algo" icon="hammer" href="/x-api/what-to-build">
