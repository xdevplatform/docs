...
description: "Boas práticas para proteger suas X API keys, tokens e credenciais OAuth, e para gerenciar o acesso do seu developer App às contas do X que o autorizaram."
---
