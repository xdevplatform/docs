...
description: "Conecte-se com segurança à X API por TLS 1.2, com orientações sobre root stores confiáveis, verificações de revogação de certificado e boas práticas de verificação HTTPS."
sidebarTitle: TLS
