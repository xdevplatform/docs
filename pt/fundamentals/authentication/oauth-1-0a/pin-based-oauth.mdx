...
description: "Use o fluxo OAuth baseado em PIN para X apps que não conseguem incorporar um navegador, como ferramentas de CLI e consoles de jogos, informando um PIN numérico como oauth_verifier."
