---
title: OAuth Echo
description: "Delegue a autenticação do X a um provedor de mídia externo em uploads via OAuth Echo, usando os headers x-auth-service-provider e verify-credentials."
