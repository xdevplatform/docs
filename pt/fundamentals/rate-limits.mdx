...
icon: gauge-high
description: "Entenda os rate limits da X API entre tiers e endpoints: limites por app vs por usuário, headers de resposta e melhores práticas para retries."
...
<CardGroup cols={2}>
  ...
  <Card title="Use backoff exponencial" icon="/icons/xds/icon-history.svg">
