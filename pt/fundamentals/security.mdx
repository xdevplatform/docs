...
<CardGroup cols={2}>
  ...
  <Card title="Segurança de credenciais" icon="/icons/xds/icon-key.svg">
...
<CardGroup cols={2}>
  <Card title="Auditorias de segurança" icon="/icons/xds/icon-search.svg">
  ...
  <Card title="Monitoramento" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Incidente no seu app" icon="/icons/xds/icon-warning.svg" href="https://hackerone.com/twitter">
...
<CardGroup cols={2}>
  <Card title="Guia de autenticação" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
    Implemente OAuth corretamente.
  </Card>
  <Card title="Permissões do app" icon="/icons/xds/icon-shield-check.svg" href="/resources/fundamentals/developer-apps#app-permissions">
