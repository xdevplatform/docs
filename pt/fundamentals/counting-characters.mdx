...
icon: text-size
description: Como o X conta caracteres em Posts, incluindo o limite de 280 caracteres, pontos de código ponderados, encurtamento de URLs, tratamento de emojis e Unicode e casos especiais.
