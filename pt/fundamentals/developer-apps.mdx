...
sidebarTitle: Apps
icon: cube
description: Crie e configure apps de desenvolvedor do X para obter credenciais de API, definir permissões OAuth 1.0a e OAuth 2.0 e gerenciar callback URLs.
...
<CardGroup cols={2}>
  ...
  <Card title="Permissões mínimas" icon="/icons/xds/icon-shield-check.svg">
