...
<CardGroup cols={2}>
  ...
  <Card title="Use escopos mínimos" icon="/icons/xds/icon-shield-check.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Aprenda sobre autenticação" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
