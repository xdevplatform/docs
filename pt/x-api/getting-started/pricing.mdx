...
<CardGroup cols={2}>
  ...
  <Card title="Preços por endpoint" icon="/icons/xds/icon-code.svg">
...
<Note>
Os planos pay-per-use estão sujeitos a um limite de **2 milhões de leituras de posts por ciclo de faturamento mensal**. Se você precisar de um volume maior, será necessário fazer upgrade para um [plano Enterprise](/forms/enterprise-api-interest).
</Note>
