...
title: Preços
sidebarTitle: Preços
description: "A X API utiliza um modelo de preços por uso. Sem assinaturas—pague apenas pelo que usar. Ganhe créditos gratuitos da xAI API ao comprar créditos da X API—até 20% de volta."
...
| Ação | Custo Unitário |
|:-------|:----------|
| **Content: Create** | &dollar;0.015 por requisição |
| **Content: Create (with URL)** | &dollar;0.200 por requisição |
