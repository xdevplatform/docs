...
description: ">Observação: > >Lançamos uma nova versão de search Posts e Post counts na API do X v2. Recomendamos que você analise o que há de novo na API do X v2."
---
