...
description: "Recupere métricas de impression e engagement para Posts com a Engagement API enterprise usando endpoints de totals, 28-hour e historical request."
keywords: ["Engagement API", "enterprise Engagement API", "métricas de engagement", "dados de engagement", "enterprise engagement", "GNIP engagement"]
---
## Overview
