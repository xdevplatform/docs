---
title: "Enriquecimentos de dados: Enterprise"
description: "Os enriquecimentos de dados do Gnip enterprise adicionam metadados aos payloads, incluindo URLs expandidas, matching rules, detalhes de enquetes e coordenadas geo do perfil."
keywords: ["enriquecimentos de dados", "enterprise enrichments", "GNIP enrichments", "enriquecimento de dados", "dados enriquecidos", "enriquecimento de dados enterprise"]
---
...
The Expanded and Enhanced URL enrichment can be found within the `entities` object of the Post payload - specifically in the `entities.urls.unwound` object. It provides the following fields of metadata:
