...
description: "Visão geral do console enterprise Gnip em console.gnip.com para gerenciar o acesso enterprise à API do X, detalhes dos produtos, métricas de uso e configurações da conta."
---
## Overview
...
Note that the [Usage API](/x-api/enterprise-gnip-2.0/fundamentals/usage) delivers much of this data programmatically.
