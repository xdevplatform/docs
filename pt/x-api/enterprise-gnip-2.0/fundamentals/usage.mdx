---
title: Usage API
description: "A Usage API é uma API REST gratuita que fornece acesso programático e visibilidade do consumo de atividade em todos os produtos da sua conta enterprise."
sidebarTitle: Usage API
keywords: ["Usage API", "enterprise usage API", "rastreamento de uso", "rastreamento de consumo", "enterprise usage", "uso de API enterprise"]
---
