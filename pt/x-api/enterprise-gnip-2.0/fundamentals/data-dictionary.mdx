...
description: "Referência de todos os fields de Post, User e Space retornados pelos produtos de dados Enterprise Gnip 2.0, incluindo Native Enriched e Activity Streams."
sidebarTitle: Dicionário de dados
keywords: ["enterprise data dictionary", "GNIP data dictionary", "formato de dados enterprise", "dicionário de dados enterprise", "objetos enterprise"]
---
