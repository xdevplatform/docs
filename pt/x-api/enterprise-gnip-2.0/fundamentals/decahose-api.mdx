---
title: Decahose API
description: "Faça streaming de uma amostra aleatória de 10% de todos os Posts e likes públicos em tempo real através da Decahose API enterprise com particionamento e enriquecimento de URL."
keywords: ["Decahose", "stream 10%", "decahose API", "enterprise decahose", "stream amostrado 10%", "streaming enterprise"]
---
