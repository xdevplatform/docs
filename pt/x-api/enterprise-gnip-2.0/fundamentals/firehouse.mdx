...
description: "Faça streaming de eventos de compliance de usuários em tempo real, como deletes, edições, withholdings e scrubs, com a Compliance Firehose API enterprise para dados armazenados."
