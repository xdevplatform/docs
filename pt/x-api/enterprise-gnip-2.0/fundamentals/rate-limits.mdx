...
description: "Analise os rate limits de solicitações das APIs Gnip enterprise, incluindo PowerTrack, Decahose, Search, Account Activity, Engagement e Compliance Firehose."
keywords: ["enterprise rate limits", "GNIP rate limits", "limites de API enterprise", "rate limits enterprise", "enterprise throttling"]
---
...
### Rate limits enterprise por janela

| Produto | Endpoint | Rate limit |
| :--- | :--- | :--- |
