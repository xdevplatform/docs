---
title: Introdução e visão geral da API Account Activity v2
sidebarTitle: Introdução
description: "A Account Activity API (AAA) permite receber eventos em tempo real do X via webhooks. Referência do nível standard da X API v2 para atividade de conta."
...
<CardGroup cols={2}>
  ...
  <Card title="Abrangente" icon="/icons/xds/icon-bulleted-list.svg">
    Posts, DMs, follows, curtidas, blocks, mutes e mais
  </Card>
  <Card title="Baseada em assinaturas" icon="/icons/xds/icon-bell.svg">
...
<CardGroup cols={2}>
  <Card title="Início rápido" icon="/icons/xds/icon-rocket.svg" href="/x-api/account-activity/quickstart">
