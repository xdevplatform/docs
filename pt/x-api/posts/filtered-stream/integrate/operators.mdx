...
description: "Referência dos operadores do Filtered Stream da X API v2: operadores de palavra-chave, has:, is: e o operador embedding: exclusivo do Enterprise."
