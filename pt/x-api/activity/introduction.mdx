...
description: "Transmita eventos em tempo real da atividade do usuário no X (Posts, curtidas, follows, mutes, blocks, DMs, menções e atualizações de perfil) via webhooks."
...
Atualmente, a X Activity API oferece suporte aos seguintes tipos de evento, organizados por categoria. Para ver um JSON de exemplo de cada tipo, consulte [Payloads de eventos](/x-api/activity/event-payloads).
