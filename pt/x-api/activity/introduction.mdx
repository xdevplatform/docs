...
description: "Visão geral da X Activity API para transmitir em tempo real eventos de atividade do usuário, como post.create, post.delete e atualizações de perfil em X."
