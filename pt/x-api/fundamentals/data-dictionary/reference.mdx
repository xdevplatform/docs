---
title: Referência do dicionário de dados
description: "Referência completa do dicionário de dados da API do X v2, cobrindo campos de objetos Tweet, User, Media, Place, Poll e Space e como solicitá-los com expansions."
sidebarTitle: Referência
keywords: ["referência do dicionário de dados", "lista completa de fields", "esquema de objetos da api", "campos do objeto tweet", "campos do objeto user", "referência de expansions"]
---
...
Neste guia, solicitaremos vários fields no seguinte screenshot do Tweet.
 
