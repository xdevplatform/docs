---
title: "Dicionário de dados da API do X v2: fields de Post, User, Space"
sidebarTitle: Visão geral
description: "Referência em nível de field para objetos JSON da API do X v2, incluindo Post (Tweet), User, Space, Media, Poll e Place, além de expansions e métricas."
keywords: ["dicionário de dados", "tweet fields", "user fields", "objetos da api", "expansions", "métricas", "objeto post", "objeto user", "modelo de dados x api v2"]
---

A API do X retorna JSON estruturado e rico. Este dicionário documenta cada field disponível para cada tipo de objeto.

## Navegação rápida

- [Fields de Post (Tweet)](#post-tweet)
- [Fields de User](#user)
- [Space, List, Media, Poll, Place, Community, DM events](#space)
- [Como solicitar fields e expansions](#how-to-use-fields-and-expansions)
- [Exemplos de payloads](#x-api-v2-example-payloads)

**Tabelas de fields completas e detalhadas → [Referência do dicionário de dados](/x-api/fundamentals/data-dictionary/reference)**

## Navegação rápida

| Objeto | Descrição | Parâmetro fields |
|:-------|:------------|:-----------------|
| [Post (Tweet)](#post-tweet) | Posts, respostas, reposts, citações | `tweet.fields` |
| [User](#user) | Perfis de conta e metadados | `user.fields` |
| [Space](#space) | Conversas de áudio ao vivo | `space.fields` |
| [List](#list) | Coleções organizadas de contas | `list.fields` |
| [Media](#media) | Imagens, vídeos, GIFs | `media.fields` |
| [Poll](#poll) | Perguntas e opções de enquete | `poll.fields` |
| [Place](#place) | Dados de localização e geo | `place.fields` |

<Tip>
Use [parâmetros fields](/x-api/fundamentals/fields) para solicitar fields específicos e [expansions](/x-api/fundamentals/expansions) para incluir objetos relacionados.
</Tip>
...
Posts são a unidade central de conteúdo no X. Cada objeto Post inclui texto, metadados e referências a objetos relacionados como autores, mídia e enquetes.

**Fields padrão:** `id`, `text`, `edit_history_tweet_ids`

Use `tweet.fields` para solicitar fields adicionais e `expansions` para incluir objetos relacionados.

### Todos os fields de Post
...
| **paid_partnership** | boolean | Indicates if this Post is a paid partnership, i.e., it has been disclosed by the author as containing paid promotion. | Identify Posts disclosed as paid partnerships / sponsored content. |
