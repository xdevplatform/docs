...
sidebarTitle: MCP
description: Conecte ferramentas de IA como Grok e Cursor à X API e aos docs do desenvolvedor X por meio de servidores Model Context Protocol — X MCP hospedado via xurl e busca nos docs.
