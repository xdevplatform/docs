...
<CardGroup cols={2}>
  ...
  <Card title="Início rápido" icon="/icons/xds/icon-rocket.svg" href="/xdks/python/quickstart">
    Passo a passo da primeira solicitação.
  </Card>
  <Card title="Autenticação" icon="/icons/xds/icon-key.svg" href="/xdks/python/authentication">
  ...
  <Card title="Referência da API" icon="/icons/xds/icon-book.svg" href="/xdks/python/reference/modules">
