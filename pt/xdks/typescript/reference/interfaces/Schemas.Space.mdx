...
title: "Space"
sidebarTitle: "Space"
description: "Referência para Schemas.Space no X API SDK — interface TypeScript. Definições de campos, tipos e propriedades para payloads de requisição ou resposta da X API."
---
