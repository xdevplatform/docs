...
description: "Referência para o módulo modules no SDK TypeScript da X API. Clientes, tipos e utilitários reexportados fornecidos por este módulo do SDK para a X API v2."
