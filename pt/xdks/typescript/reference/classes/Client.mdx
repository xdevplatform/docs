...
title: "Client"
sidebarTitle: "Client"
description: "Reference for the main Client class in the X API TypeScript SDK, the entry point exposing specialized clients for every X API v2 endpoint group."
---
...
Cria uma nova instância do client X API
