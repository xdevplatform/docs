...
description: "Referência para a classe StreamClient no SDK TypeScript da X API. Métodos, parâmetros e tipos de retorno para os endpoints stream da X API v2."
---
