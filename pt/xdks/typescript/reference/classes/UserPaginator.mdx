...
description: "Referência para a classe UserPaginator no SDK TypeScript da X API. Itere resultados paginados de user com iteradores assíncronos e utilitários de cursor."
---
