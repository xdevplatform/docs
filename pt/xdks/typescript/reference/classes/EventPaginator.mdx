...
description: "Referência para a classe EventPaginator no SDK TypeScript da X API. Itere resultados paginados de event com iteradores assíncronos e utilitários de cursor."
---
