...
description: "Referência para o módulo Python lists.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints lists da X API v2."
---
