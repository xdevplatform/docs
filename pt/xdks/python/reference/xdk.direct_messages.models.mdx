...
description: "Referência para o módulo Python direct_messages.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints direct messages da X API v2."
---
