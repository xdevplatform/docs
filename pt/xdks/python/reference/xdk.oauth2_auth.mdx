...
description: "Referência para o pacote Python oauth2_auth no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints oauth2 auth da X API v2."
---
