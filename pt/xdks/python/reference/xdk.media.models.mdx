...
description: "Referência para o módulo Python media.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints media da X API v2."
---
