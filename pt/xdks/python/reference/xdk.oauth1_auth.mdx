...
description: "Referência para o pacote Python oauth1_auth no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints oauth1 auth da X API v2."
---
