...
description: "Referência para o módulo account_activity.models do XDK Python, listando classes de resposta Pydantic para replay jobs, subscriptions, and subscription counts."
---
