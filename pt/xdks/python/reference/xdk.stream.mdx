...
description: "Referência para o pacote Python stream no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints stream da X API v2."
---
...
Este módulo fornece acesso aos endpoints stream da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a stream.

### `class xdk.stream.StreamClient`

Streaming Client para operações de stream
