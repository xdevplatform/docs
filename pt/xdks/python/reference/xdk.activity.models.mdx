...
description: "Referência para o módulo Python activity.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints activity da X API v2."
---
