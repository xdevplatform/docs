...
description: "Referência para o pacote Python activity no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints activity da X API v2."
---
...
Este módulo fornece acesso aos endpoints activity da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a activity.
