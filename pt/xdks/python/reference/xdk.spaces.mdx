...
description: "Referência para o pacote Python spaces no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints spaces da X API v2."
---
...
Este módulo fornece acesso aos endpoints spaces da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a spaces.
