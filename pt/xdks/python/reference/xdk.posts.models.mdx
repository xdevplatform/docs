...
description: "Referência para o módulo Python posts.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints posts da X API v2."
---
