...
description: "Referência para o pacote Python account_activity no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints account activity da X API v2."
---
...
Este módulo fornece acesso aos endpoints account activity da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a account activity.
