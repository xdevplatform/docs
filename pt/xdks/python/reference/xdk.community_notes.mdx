...
description: "Referência para o pacote Python community_notes no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints community notes da X API v2."
---
...
Este módulo fornece acesso aos endpoints community notes da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a community notes.
