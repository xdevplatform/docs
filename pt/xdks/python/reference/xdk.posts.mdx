...
description: "Referência para o pacote Python posts no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints posts da X API v2."
---
...
Este módulo fornece acesso aos endpoints posts da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a posts.
