...
description: "Referência para o módulo Python direct_messages.client no SDK da X API. Classe do client e métodos para chamar os endpoints direct messages da X API v2."
---
