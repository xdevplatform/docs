...
description: "Referência para o pacote Python users no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints users da X API v2."
---
...
Este módulo fornece acesso aos endpoints users da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a users.
