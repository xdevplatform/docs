...
description: "Referência para o módulo Python community_notes.models no SDK da X API. Modelos Pydantic de requisição e resposta para os endpoints community notes da X API v2."
---
