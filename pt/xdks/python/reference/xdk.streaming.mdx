...
description: "Referência para o pacote Python streaming no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints streaming da X API v2."
---
