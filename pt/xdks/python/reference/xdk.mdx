...
title: "Client"
sidebarTitle: "Client"
description: "Referência para o pacote Python de nível superior xdk no SDK da X API. Clients, modelos e utilitários reexportados para chamar a X API v2 a partir de Python."
---
...
Client para interagir com a X API.
