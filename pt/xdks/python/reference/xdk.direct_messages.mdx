...
description: "Referência para o pacote Python direct_messages no SDK da X API, agrupando o client e os modelos Pydantic para os endpoints direct messages da X API v2."
---
...
Este módulo fornece acesso aos endpoints direct messages da X API
e serve como o principal ponto de entrada para toda a funcionalidade relacionada a direct messages.
