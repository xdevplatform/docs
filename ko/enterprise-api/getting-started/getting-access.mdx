...
<CardGroup cols={2}>
  ...
  <Card title="최소 스코프 사용" icon="/icons/xds/icon-shield-check.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="인증에 대해 알아보기" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
