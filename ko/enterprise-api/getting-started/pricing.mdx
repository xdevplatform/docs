---
title: Enterprise API 요금제와 맞춤형 플랜
sidebarTitle: 요금
description: "X Enterprise API 요금제는 조직의 데이터 볼륨, 사용 엔드포인트, SLA, 운영 지원 요구 사항에 맞춰 개별 설계됩니다. 대용량 데이터, 전용 액세스, 맞춤형 계약에 대한 가격 정보와 견적은 X 영업팀에 직접 문의하시기 바랍니다."
