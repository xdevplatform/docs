...
<CardGroup cols={3}>
  ...
  <Card title="API 레퍼런스" icon="/icons/xds/icon-code.svg" href="/x-api/posts/lookup/introduction">
    전체 엔드포인트 문서입니다.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="인증 배우기" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
