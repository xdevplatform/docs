...
icon: lightbulb
description: 챗봇과 분석 대시보드부터 콘텐츠 조정 도구, 학술 연구 프로젝트, 커뮤니티 앱, 자동화 봇, 실시간 알림 서비스까지 X API를 활용한 다양한 프로젝트 아이디어와 사용 사례를 살펴보고, 아이디어별로 적합한 엔드포인트와 액세스 티어를 함께 확인하세요.
...
<CardGroup cols={2}>
  <Card title="조정 도구" icon="/icons/xds/icon-shield-keyhole.svg">
    사용자가 답글을 관리하고, 콘텐츠를 필터링하며, 자신의 경험을 보호할 수 있도록 돕는 도구를 만드세요.
  </Card>
  <Card title="괴롭힘 방지" icon="/icons/xds/icon-block.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="봇 & 자동화" icon="/icons/xds/icon-ai-agents.svg">
...
<CardGroup cols={2}>
  <Card title="성과 대시보드" icon="/icons/xds/icon-bar-chart.svg">
    참여도 지표, 성장 트렌드, 도달 범위를 시각화하세요.
  </Card>
  <Card title="청중 인사이트" icon="/icons/xds/icon-people.svg">
    팔로워, 참여 패턴, 인구 통계를 분석하세요.
  </Card>
  <Card title="트렌드 분석" icon="/icons/xds/icon-feather-chart-line.svg">
    해시태그, 주제, 대화량을 추적하세요.
  </Card>
  <Card title="경쟁 분석" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  <Card title="MCP 기반 에이전트" icon="/icons/xds/icon-ai-agents.svg">
