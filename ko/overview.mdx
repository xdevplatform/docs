...
<CardGroup cols={2}>
  <Card title="X API — 사용량 기반" icon="/icons/xds/icon-coins.svg" href="/x-api/introduction">
...
<CardGroup cols={3}>
  <Card title="빠른 시작" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
...
<CardGroup cols={2}>
  <Card title="튜토리얼" icon="/icons/xds/icon-book.svg" href="/tutorials">
    일반적인 사용 사례와 통합을 위한 단계별 가이드입니다.
  </Card>
  <Card title="도구 및 라이브러리" icon="/icons/xds/icon-wrench.svg" href="/tools-and-libraries">
    모든 언어를 위한 공식 SDK 및 커뮤니티 라이브러리입니다.
  </Card>
  <Card title="개발자 포럼" icon="/icons/xds/icon-chat-unread.svg" href="https://devcommunity.x.com">
    커뮤니티와 X 팀의 도움을 받으세요.
  </Card>
  <Card title="에이전트 리소스" icon="/icons/xds/icon-ai-agents.svg" href="/tools/ai">
