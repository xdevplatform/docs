---
title: "X Chat에서 암호화된 그룹 대화 만들기"
sidebarTitle: 그룹
description: "X Chat 그룹 대화를 만들어 보세요. 그룹 생성, 멤버 추가 및 제거, 암호화된 이름과 아바타 설정까지 1:1 채팅과 동일한 보안으로 제공합니다."
keywords: ["X Chat 그룹", "그룹 채팅", "그룹 DM", "대화 키", "그룹 이름 암호화", "멤버 추가"]
---
