---
title: "X Chat의 흔한 문제 해결하기"
sidebarTitle: 문제 해결
description: "키 설정, 백업 복구, 복호화되지 않는 메시지, 전송 오류 등 X Chat에서 가장 흔한 문제에 대한 해결 방법입니다."
keywords: ["X Chat 오류", "문제 해결", "Chat XDK", "복호화 실패", "보안 키 백업", "암호화 오류"]
---
...
- **API**는 등록 시 업로드된 그대로 키를 저장하고 반환합니다: DER(SPKI) 인코딩으로, 고정된 알고리즘 식별자 접두사 뒤에 원시 키가 붙어 있습니다
