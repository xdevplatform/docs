---
title: "스크립팅: 이벤트"
description: "Bind callbacks to X for Websites widget events such as loaded, rendered, tweet, follow, retweet, like, and click using twttr.events.bind for analytics."
