---
title: 임베디드 Post JavaScript Factory Function
sidebarTitle: Embedded Post JavaScript Factory Function
description: "Dynamically insert embedded X Posts into a webpage using the twttr.widgets.createTweet JavaScript factory function from the X for Websites library."
---
