---
title: 파라미터
description: "Reference for embedded timeline data-* options including chrome, theme, width, height, tweet-limit, show-replies, aria-polite accessibility, and DNT settings."
