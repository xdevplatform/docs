---
title: Post 버튼 JavaScript Factory Function
description: "Dynamically insert a Post button with twttr.widgets.createShareButton by passing a share URL, target element, and options like pre-populated share text."
