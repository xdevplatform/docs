...
title: 캠페인 관리
sidebarTitle: 개요
description: X에서 광고 캠페인을 생성, 관리 및 최적화하세요. Ads API를 사용해 예산, 타깃팅, 크리에이티브, 입찰 전략을 정의합니다.
keywords: ["campaign management", "ads api", "line items", "ad groups", "promoted ads", "광고 캠페인", "x ads", "campaign api"]
---
...
**X에서 광고 캠페인을 프로그래밍 방식으로 생성, 예약, 관리하세요.**
