...
description: "1. 개발자 계정에 가입하세요. 2. 개발자 App을 생성하고 토큰을 안전하게 보관하세요. 3. ads.x.com/help을 방문하여 각 개발자 App에 대한 Ads API 액세스 요청을 제출하세요. X의 어떤 API 제품에든 요청을 보내려면 먼저 개발자 계정에 가입해야 합니다."
---
