...
<CardGroup cols={2}>
  ...
  <Card title="인증" icon="/icons/xds/icon-key.svg" href="/xdks/typescript/authentication">
  ...
  <Card title="API 레퍼런스" icon="/icons/xds/icon-book.svg" href="/xdks/typescript/reference/modules">
