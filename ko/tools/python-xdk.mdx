...
<CardGroup cols={2}>
  ...
  <Card title="빠른 시작" icon="/icons/xds/icon-rocket.svg" href="/xdks/python/quickstart">
    첫 요청 단계별 워크스루.
  </Card>
  <Card title="인증" icon="/icons/xds/icon-key.svg" href="/xdks/python/authentication">
  ...
  <Card title="API 레퍼런스" icon="/icons/xds/icon-book.svg" href="/xdks/python/reference/modules">
    전체 클라이언트 및 모델 레퍼런스.
  </Card>
</CardGroup>
