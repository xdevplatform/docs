...
icon: grid-2
description: X Developer Console(포털)을 사용하여 프로젝트와 앱을 관리하고, API 사용량과 요청 수를 모니터링하고, 자격 증명에 액세스하며, 팀 구성원을 초대하고, 액세스 티어 업그레이드와 결제 정보 및 인보이스를 확인하는 방법을 소개합니다.
...
<CardGroup cols={2}>
  ...
  <Card title="사용량 및 비용 모니터링" icon="/icons/xds/icon-bar-chart.svg">
    실시간으로 API 사용량을 추적합니다. 엔드포인트별 비용을 확인하고 크레딧 잔액을 관리하세요.
  </Card>
  <Card title="자격 증명 생성" icon="/icons/xds/icon-key.svg">
