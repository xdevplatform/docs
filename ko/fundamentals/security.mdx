...
<CardGroup cols={2}>
  ...
  <Card title="자격 증명 보안" icon="/icons/xds/icon-key.svg">
...
<CardGroup cols={2}>
  <Card title="보안 감사" icon="/icons/xds/icon-search.svg">
  ...
  <Card title="모니터링" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="앱 인시던트" icon="/icons/xds/icon-warning.svg" href="https://hackerone.com/twitter">
...
<CardGroup cols={2}>
  <Card title="인증 가이드" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
    OAuth를 올바르게 구현하세요.
  </Card>
  <Card title="앱 권한" icon="/icons/xds/icon-shield-check.svg" href="/resources/fundamentals/developer-apps#app-permissions">
    최소 필수 권한을 구성하세요.
  </Card>
</CardGroup>
