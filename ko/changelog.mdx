...
<Update label="2026년 5월 21일" description="X API">
  ...
  오늘, 레거시 **Basic** 월간 및 연간 요금제의 사용 중단을 발표했습니다. **2026년 6월 1일**부터 모든 Basic 가입자는 현재 청구 주기가 종료되는 시점에 [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/pricing)로 자동 마이그레이션됩니다. 별도의 조치는 필요하지 않습니다. 월간 가입자에게는 Stripe를 통해 **\$200**의 초기 크레딧이 청구됩니다. 연간 가입자에게는 연간 요금의 잔여 비례 금액이 PPU 크레딧으로 지급됩니다. 마이그레이션 이후 자동 충전은 기본적으로 **\$200**으로 활성화되며(잔액이 **\$10** 미만일 때 트리거), 청구 주기당 지출 한도는 **\$400**입니다. 모든 설정은 [Developer Portal](https://developer.x.com/en/portal/dashboard)에서 조정할 수 있습니다. 마이그레이션을 원하지 않는 개발자는 2026년 6월 1일 이전에 옵트아웃할 수 있으며, 옵트아웃하면 전환 일자에 API 접근이 종료됩니다. 자세한 내용은 [여기](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305)를 참조하세요.
</Update>

<Update label="2026년 5월 20일" description="X API">
  ### 무료 크레딧 소진 후에도 자동 충전이 작동

  오늘, 사용한 크레딧 바우처(무료 크레딧)의 잔액이 0이 되었을 때 자동 충전 기능이 트리거되지 않던 문제를 수정했습니다. **2026년 5월 21일**부터 무료 크레딧은 자동 충전과 관련하여 유료 크레딧과 동일하게 처리됩니다. 잔액이 소진되고 자동 충전이 활성화되어 있으면 저장된 결제 수단으로 자동 청구됩니다. 무료 크레딧 사용 후 청구되지 않도록 하려면 [Developer Console](https://console.x.com)에서 자동 충전 설정을 확인하고 필요 시 비활성화하세요. 자세한 내용은 [여기](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184)를 참조하세요.
</Update>
