...
<Update label="2026년 5월 20일" description="X API">
  ...
  오늘 **자동 충전**이 모든 크레딧 유형에서 일관되게 동작하도록 수정 사항을 적용했습니다. 이전에는 크레딧 바우처(무료 크레딧) 잔액이 0에 도달하면 자동 충전이 활성화되어 있어도 트리거되지 않았습니다. **2026년 5월 21일부터** 무료 크레딧은 유료 크레딧과 동일하게 처리됩니다. 잔액(무료 또는 유료)이 모두 소진되고 [Developer Console](https://console.x.com)에서 자동 충전이 활성화되어 있으면, 저장된 결제 수단을 사용해 계정이 자동으로 충전됩니다.

  - 무료 크레딧이 소진된 후 청구되기를 원하지 않는다면 Developer Console에서 자동 충전을 확인하고 필요한 경우 비활성화하세요.
  - 자동 충전을 계속 사용할 계획이라면 결제 수단이 최신 상태인지 확인하세요.

  자세한 내용은 [자동 충전](https://docs.x.com/x-api/getting-started/pricing#auto-recharge) 또는 [공지](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184)를 참조하세요.
</Update>

<Update label="2026년 5월 13일" description="X Ads API">
  ### X Ads API 피드백 접수 중

  [X Ads API](https://docs.x.com/x-ads-api/introduction)에 대한 피드백 채널을 열었습니다. 버그, 불편한 점, 원하는 기능, 문서의 부족한 부분을 공유해 앞으로 출시될 기능의 방향에 도움을 주세요. [커뮤니티 스레드](https://devcommunity.x.com/t/x-ads-api-share-your-feedback/265247)에 답글을 남기거나, 링크된 양식을 통해 제출할 수 있습니다.
</Update>
