...
<Update label="2026년 7월 16일" description="X API">
  ### Pay-Per-Use 월간 Post 읽기 한도

  [요금제 페이지](/x-api/getting-started/pricing)에서 Pay-Per-Use 요금제에 **월간 청구 주기당 200만 건의 Post 읽기** 한도가 적용된다는 점을 명확히 했습니다. 더 많은 볼륨이 필요한 경우 [Enterprise 요금제](/forms/enterprise-api-interest)로 업그레이드해야 합니다.
</Update>
