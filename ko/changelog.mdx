...
<Update label="2026년 6월 18일" description="X API v2">
  ### Community Notes 엔드포인트 가격 정정

  [Community Notes 엔드포인트](/x-api/community-notes/introduction)에 표시된 가격을 정정했습니다. 노트 읽기는 [가격 페이지](/x-api/getting-started/pricing)의 표준 **Note: Read** 요율에 따라 **리소스당 $0.005**로 청구됩니다.
</Update>
