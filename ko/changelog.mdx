...
<Update label="2026년 5월 20일" description="X Ads API">
  ### X Ads API 액세스 요청 간소화

  이번 주에는 [X Ads API](/x-ads-api/introduction) 액세스 요청을 더 쉽게 만들었습니다. Ads API 소개 페이지에 기존의 임시 절차를 대체하는 액세스 요청 양식 직접 링크가 추가되었습니다. 요청을 제출하시면 저희 팀이 영업일 기준 3일 이내에 검토해 드립니다.
</Update>
