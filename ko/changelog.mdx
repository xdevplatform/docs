...
<Update label="2026년 7월 1일" description="개발자 플랫폼">
  ...
  오늘 X API로 만든 앱을 소개하는 공개 디렉터리인 [**Developer E𝕏hibit**](https://developer.x.com/exhibit)를 출시했습니다. [Developer Console](https://console.x.com)의 **Apps** 페이지에서 앱을 제출하고 간단한 확인 단계를 완료하면, 잠재 사용자와 다른 개발자가 여러분의 프로젝트를 찾을 수 있도록 리스팅이 공개됩니다. 자세한 내용은 [여기](https://devcommunity.x.com/t/introducing-the-developer-e-hibit-showcase-your-x-api-apps-and-get-discovered/269675)에서 확인하세요.
</Update>

<Update label="2026년 6월 30일" description="개발자 플랫폼">
  ### 호스티드 X MCP 서버

  오늘 `https://api.x.com/mcp`에서 호스티드 [X MCP 서버](/tools/mcp)를 출시했습니다. 이제 MCP 호환 AI 도구(Grok Build, Cursor, Claude, VS Code 등)가 여러분 자신의 계정 권한으로 X API를 호출할 수 있으며, 로컬 서버를 복제하거나 실행할 필요가 없습니다. 오픈 소스 [`xurl mcp`](https://github.com/xdevplatform/xurl) 브리지를 통해 연결하면 OAuth 2.0 PKCE 로그인과 토큰 자동 갱신을 대신 처리합니다.

  전체 아카이브 Post 검색, 사용자 및 뉴스 검색, 타임라인 및 멘션, 북마크 관리, 트렌드, Articles 초안 작성 및 게시 등의 기능을 사용할 수 있습니다. 자세한 내용은 [여기](https://devcommunity.x.com/t/announcing-the-hosted-x-mcp/269558)에서 확인하세요.
</Update>
