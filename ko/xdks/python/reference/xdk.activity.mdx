...
description: "Reference for the activity Python package in the X API SDK, grouping the client and Pydantic models for the activity endpoints of the X API v2."
---
...
이 모듈은 X API의 activity 엔드포인트에 대한 액세스를 제공합니다.
모든 activity-related 기능의 주요 진입점 역할을 합니다.
