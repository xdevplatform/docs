...
<CardGroup cols={2}>
  <Card title="액세스 받기" icon="/icons/xds/icon-key.svg" href="/x-api/getting-started/getting-access">
    가입하고 첫 번째 앱을 만드세요.
  </Card>
  <Card title="첫 요청 보내기" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
    몇 분 안에 API를 호출하세요.
  </Card>
</CardGroup>
