...
| **Media: Read** | 리소스당 &dollar;0.005 |
| **Analytics: Read** | 리소스당 &dollar;0.005 |
| **Trend: Read** | 리소스당 &dollar;0.010 |
...
| 액션 | 단가 |
|:-------|:----------|
| **Content: Create** | 요청당 &dollar;0.015 |
| **Content: Create (with URL)** | 요청당 &dollar;0.200 |
