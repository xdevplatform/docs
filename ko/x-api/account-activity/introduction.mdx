...
<CardGroup cols={2}>
  ...
  <Card title="포괄적" icon="/icons/xds/icon-bulleted-list.svg">
    Post, DM, 팔로우, 좋아요, 차단, 뮤트 등
  </Card>
  <Card title="구독 기반" icon="/icons/xds/icon-bell.svg">
...
<CardGroup cols={2}>
  <Card title="빠른 시작" icon="/icons/xds/icon-rocket.svg" href="/x-api/account-activity/quickstart">
    구독을 설정하고 이벤트 수신 시작
  </Card>
