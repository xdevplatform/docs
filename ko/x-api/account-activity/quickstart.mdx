...
<CardGroup cols={2}>
  <Card title="소개" icon="/icons/xds/icon-book.svg" href="/x-api/account-activity/introduction">
  ...
  <Card title="웹훅 빠른 시작" icon="/icons/xds/icon-rocket.svg" href="/x-api/webhooks/quickstart">
    CRC 설정, 보안 및 웹훅 등록
  </Card>
</CardGroup>
