...
description: "Build enterprise PowerTrack and Search rules using keyword, phrase, proximity, and boolean operators with grouping for precise X data filtering."
keywords: ["enterprise rules", "GNIP rules", "enterprise filtering", "PowerTrack rules", "enterprise queries", "filter rules enterprise"]
---

## 시작하기 with enterprise rules and queries
