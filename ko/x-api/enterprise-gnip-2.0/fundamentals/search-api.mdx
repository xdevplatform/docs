...
description: ">Please note: > >We have released a new version of search Posts and Post counts in X API v2. We encourage you to review what's new with X API v2."
---
...
### 시작하기 with enterprise Search Posts: 30-Day API
