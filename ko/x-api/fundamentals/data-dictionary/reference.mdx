...
description: "Tweet, User, Media, Place, Poll, Space 객체 field와 expansion으로 이를 요청하는 방법을 다루는 X API v2 data dictionary 전체 레퍼런스."
sidebarTitle: 레퍼런스
keywords: ["data dictionary reference", "전체 field 목록", "api object schema", "tweet object fields", "user object fields", "expansions reference"]
---

## Field 및 expansion 사용 방법
