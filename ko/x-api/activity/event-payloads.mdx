...
<CardGroup cols={2}>
  <Card title="소개" icon="/icons/xds/icon-book.svg" href="/x-api/activity/introduction">
    지원되는 이벤트 유형, 프라이버시 및 인증
  </Card>
  <Card title="빠른 시작" icon="/icons/xds/icon-rocket.svg" href="/x-api/activity/quickstart">
    구독을 생성하고 이벤트 수신하기
  </Card>
