---
title: MCP servers for the X API and developer documentation
sidebarTitle: MCP
description: Connect AI tools like Grok and Cursor to the X API and X developer docs through Model Context Protocol servers — hosted X MCP via xurl and docs search.
