---
title: MCP servers for the X API and developer docs
sidebarTitle: MCP
description: Connect AI tools like Grok and Cursor to the X API and X developer docs through Model Context Protocol servers, with hosted X MCP via xurl and docs search.
