...
description: Install and use the official TypeScript XDK client library for the X API v2, with authentication, typed responses, pagination, and streaming examples.
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="/icons/xds/icon-key.svg" href="/xdks/typescript/authentication">
  ...
  <Card title="API Reference" icon="/icons/xds/icon-book.svg" href="/xdks/typescript/reference/modules">
