...
icon: flask
description: Run a local mock server to test X API v2 endpoints during development without consuming API credits, plus example requests and response payloads.
...
<CardGroup cols={2}>
  ...
  <Card title="No credits needed" icon="/icons/xds/icon-coins.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Make your first request" icon="/icons/xds/icon-rocket.svg" href="/make-your-first-request">
