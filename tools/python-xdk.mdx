...
title: Python XDK
sidebarTitle: Python
description: Install and use the official Python XDK client library for the X API v2, including authentication setup, paginated requests, and streaming examples.
...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/xdks/python/quickstart">
    Step-by-step first request walkthrough.
  </Card>
  <Card title="Authentication" icon="/icons/xds/icon-key.svg" href="/xdks/python/authentication">
  ...
  <Card title="API Reference" icon="/icons/xds/icon-book.svg" href="/xdks/python/reference/modules">
