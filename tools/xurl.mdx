...
description: xurl is a curl-style CLI for the X API with built-in OAuth handling, making it easy to test endpoints, sign requests, and prototype from the terminal.
