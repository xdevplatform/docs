...
description: "X API は X の公開会話へのプログラムからのアクセスを提供します。投稿の取得や検索、トレンドやエンゲージメントの分析、ユーザー検索、外部サービスとの連携の構築、v2 エンドポイントの活用、新しいプラットフォーム体験の創出までさまざまな用途で利用できます。"
...
<CardGroup cols={3}>
  ...
  <Card title="スペース" icon="/icons/xds/icon-microphone.svg">
    ライブ音声会話と参加者を発見。
  </Card>
...
<CardGroup cols={2}>
  <Card title="アクセスを取得" icon="/icons/xds/icon-key.svg" href="/x-api/getting-started/getting-access">
