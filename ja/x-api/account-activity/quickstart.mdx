...
<CardGroup cols={2}>
  <Card title="はじめに" icon="/icons/xds/icon-book.svg" href="/x-api/account-activity/introduction">
  ...
  <Card title="Webhook クイックスタート" icon="/icons/xds/icon-rocket.svg" href="/x-api/webhooks/quickstart">
