---
title: Account Activity API v2 の概要と導入ガイド
sidebarTitle: はじめに
description: "Account Activity API (AAA) は X 上のアカウント活動イベントを Webhook 経由でリアルタイムに受信する方法を提供します。X API v2 スタンダード階層のアカウントアクティビティに関する公式 API リファレンスドキュメントです。"
...
<CardGroup cols={2}>
  ...
  <Card title="包括的" icon="/icons/xds/icon-bulleted-list.svg">
    Post、DM、フォロー、いいね、ブロック、ミュートなど
  </Card>
  <Card title="サブスクリプション方式" icon="/icons/xds/icon-bell.svg">
...
<CardGroup cols={2}>
  <Card title="クイックスタート" icon="/icons/xds/icon-rocket.svg" href="/x-api/account-activity/quickstart">
