---
title: Data Dictionary リファレンス
description: "Tweet、User、Media、Place、Poll、Space オブジェクトのフィールドと、expansions を使ったリクエスト方法を網羅した X API v2 の完全な data dictionary リファレンス。"
sidebarTitle: リファレンス
