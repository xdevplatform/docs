---
title: "X API v2 data dictionary: Post、User、Space フィールド"
sidebarTitle: 概要
description: "X API v2 JSON オブジェクト（Post (Tweet)、User、Space、Media、Poll、Place、および expansions と metrics を含む）のフィールドレベルのリファレンス。"
...
X API は豊富に構造化された JSON を返します。この dictionary では、各オブジェクトタイプで利用可能なすべてのフィールドを文書化しています。
