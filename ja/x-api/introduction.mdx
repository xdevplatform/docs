...
<CardGroup cols={3}>
  <Card title="はじめる" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
...
<CardGroup cols={2}>
  <Card title="柔軟なスケーリング" icon="/icons/xds/icon-bar-chart.svg">
  ...
  <Card title="クレジットベース" icon="/icons/xds/icon-coins.svg">
