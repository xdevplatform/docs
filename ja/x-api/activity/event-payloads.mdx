...
<CardGroup cols={2}>
  <Card title="はじめに" icon="/icons/xds/icon-book.svg" href="/x-api/activity/introduction">
    サポートされているイベントタイプ、プライバシー、認証
  </Card>
  <Card title="クイックスタート" icon="/icons/xds/icon-rocket.svg" href="/x-api/activity/quickstart">
