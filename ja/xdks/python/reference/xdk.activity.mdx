...
description: "X API SDK の activity Python パッケージのリファレンス。 X API v2 の activity エンドポイント向けのクライアントと Pydantic モデルをまとめています。"
---
...
このモジュールは、X API の activity エンドポイントへのアクセスを提供します
activity-related のすべての機能の主要なエントリポイントとして機能します。
