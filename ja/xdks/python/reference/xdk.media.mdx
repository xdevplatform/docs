...
description: "X API SDK の media Python パッケージのリファレンス。 X API v2 の media エンドポイント向けのクライアントと Pydantic モデルをまとめています。"
---
...
このモジュールは、X API の media エンドポイントへのアクセスを提供します
media-related のすべての機能の主要なエントリポイントとして機能します。
