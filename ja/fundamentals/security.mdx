...
sidebarTitle: セキュリティ
icon: shield-halved
description: X API 開発者向けのセキュリティベストプラクティス。認証情報の保管、OAuth の取り扱い、キーのローテーション、安全なコールバック、脆弱性の開示について説明します。シークレットの環境変数管理、PKCE の活用、監査ログの確認、インシデント対応の手順にも触れます。
...
<CardGroup cols={2}>
  ...
  <Card title="認証情報のセキュリティ" icon="/icons/xds/icon-key.svg">
...
<CardGroup cols={2}>
  <Card title="セキュリティ監査" icon="/icons/xds/icon-search.svg">
  ...
  <Card title="モニタリング" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="あなたのアプリのインシデント" icon="/icons/xds/icon-warning.svg" href="https://hackerone.com/twitter">
...
<CardGroup cols={2}>
  <Card title="認証ガイド" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
    OAuth を正しく実装します。
  </Card>
  <Card title="アプリの権限" icon="/icons/xds/icon-shield-check.svg" href="/resources/fundamentals/developer-apps#app-permissions">
    最小限の必要な権限を設定します。
  </Card>
</CardGroup>
