...
sidebarTitle: アプリ
icon: cube
description: X デベロッパーアプリを作成・設定して、API 認証情報の取得、OAuth 1.0a および OAuth 2.0 の権限設定、コールバック URL の管理、キーのローテーションを行います。App-only 認証、User Context 認証、環境の切り替え、Bearer トークンの再発行にも対応します。
...
<CardGroup cols={2}>
  ...
  <Card title="最小限の権限" icon="/icons/xds/icon-shield-check.svg">
