...
<CardGroup cols={3}>
  <Card title="投稿" icon="/icons/xds/icon-chat.svg">
    投稿の検索、取得、作成、削除。タイムライン、スレッド、引用投稿へのアクセス。
  </Card>
  <Card title="ユーザー" icon="/icons/xds/icon-person.svg">
    プロフィールの参照、関係の管理、フォロワーデータへのアクセス。
  </Card>
  <Card title="Spaces" icon="/icons/xds/icon-microphone.svg">
    ライブ音声会話と参加者を発見します。
  </Card>
  <Card title="ダイレクトメッセージ" icon="/icons/xds/icon-envelope.svg">
    ユーザー間でプライベートメッセージを送受信。
  </Card>
  <Card title="リスト" icon="/icons/xds/icon-bulleted-list.svg">
    アカウントのキュレーションリストを作成・管理。
  </Card>
  <Card title="トレンド" icon="/icons/xds/icon-feather-chart-line.svg">
    地域別のトレンドトピックにアクセス。
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="アクセスを申し込む" icon="/icons/xds/icon-key.svg" href="/forms/enterprise-api-interest">
    セールスチームに連絡し、ニーズについて話し合いましょう。
  </Card>
  <Card title="エンドポイントを探索" icon="/icons/xds/icon-rocket.svg" href="/x-api/posts/create-post">
