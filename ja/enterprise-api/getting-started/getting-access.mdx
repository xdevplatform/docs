...
description: "X Enterprise API のアクセス申請から利用開始までの流れを解説します。専任担当チームによるオンボーディング、API キーとアクセストークンの発行、エンドポイント設定、組織のデータボリュームと支援ニーズに合わせたカスタムプラン構成までを順を追って説明します。"
...
<CardGroup cols={2}>
  <Card title="最初のリクエストを行う" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
