---
title: Enterprise の料金
sidebarTitle: 料金
description: "X Enterprise API の料金プランは、組織のデータボリューム、利用するエンドポイント、レート制限、専任サポートのニーズに合わせて個別にカスタマイズされます。大量データ向けのカスタム価格や見積もり、契約形態については営業担当までお問い合わせください。"
