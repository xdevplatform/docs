...
sidebarTitle: 料金
description: "X Enterprise API の料金プランは、組織のデータ量、利用するエンドポイント、SLA、運用サポート要件に応じて個別に設計されます。大量データ、専用アクセス、カスタム契約に対応した価格や見積もりについては、X の営業担当チームまでお問い合わせください。"
...
<CardGroup cols={2}>
  <Card title="アクセスを申請する" icon="/icons/xds/icon-key.svg" href="/forms/enterprise-api-interest">
    セールスチームに連絡してはじめましょう。
  </Card>
