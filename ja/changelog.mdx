...
<Update label="2026 年 6 月 18 日" description="X API v2">
  ### Community Notes エンドポイントの料金修正

  [Community Notes エンドポイント](/x-api/community-notes/introduction)に記載されていた料金を修正しました。ノートの読み取りは、[料金ページ](/x-api/getting-started/pricing)の標準の **Note: Read** 料金に基づき、**1 リソースあたり 0.005 ドル**で課金されます。
</Update>
