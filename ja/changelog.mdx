...
<Update label="2026 年 5 月 20 日" description="X API">
  ...
  本日、**自動チャージ**がすべてのクレジット種別で一貫して動作するように修正を行いました。これまでは、クレジットバウチャー (無料クレジット) の残高がゼロに達した場合、自動チャージが有効になっていても発動しませんでした。**2026 年 5 月 21 日より**、無料クレジットは有料クレジットと同じように扱われます。残高 (無料または有料) が完全に消費され、[Developer Console](https://console.x.com) で自動チャージが有効になっている場合、保存された支払い方法で自動的にチャージされます。

  - 無料クレジットを使い切った後に課金されたくない場合は、Developer Console で自動チャージを確認し、必要に応じて無効化してください。
  - 自動チャージを継続する予定がある場合は、支払い方法が最新であることを確認してください。

  詳細は[自動チャージ](https://docs.x.com/x-api/getting-started/pricing#auto-recharge)、または[お知らせ](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184)をご覧ください。
</Update>

<Update label="2026 年 5 月 13 日" description="X Ads API">
  ### X Ads API フィードバック受付中

  [X Ads API](https://docs.x.com/x-ads-api/introduction) のフィードバックチャネルを開設しました。バグ、課題、希望する機能、ドキュメントの不足点を共有して、今後の改善方針づくりにご協力ください。[コミュニティスレッド](https://devcommunity.x.com/t/x-ads-api-share-your-feedback/265247)で返信するか、リンクされたフォームから送信できます。
</Update>
