...
<Update label="2026 年 7 月 16 日" description="X API">
  ### Pay-Per-Use の月間 Post 読み取り上限

  [料金ページ](/x-api/getting-started/pricing)で、Pay-Per-Use プランには **月間の請求サイクルごとに 200 万件の Post 読み取り** という上限があることを明記しました。それ以上のボリュームが必要な場合は、[Enterprise プラン](/forms/enterprise-api-interest)へのアップグレードが必要です。
</Update>
