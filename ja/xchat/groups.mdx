---
title: "X Chat で暗号化グループ会話を作る"
sidebarTitle: グループ
description: "X Chat のグループ会話を構築します。グループの作成、メンバーの追加・削除、暗号化された名前やアバターの設定まで、1:1 チャットと同じ安全性で行えます。"
keywords: ["X Chat グループ", "グループチャット", "グループDM", "会話鍵", "グループ名の暗号化", "メンバー追加"]
---
