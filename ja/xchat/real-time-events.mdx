---
title: "新着メッセージをリアルタイムで受け取る"
sidebarTitle: リアルタイムイベント
description: "Webhook またはストリームで X Chat の新着メッセージやイベントをリアルタイムに受信し、Chat XDK で復号します。"
keywords: ["X Chat イベント", "Webhook", "アクティビティストリーム", "リアルタイムメッセージ", "chat.received", "chat.sent"]
---
