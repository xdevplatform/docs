---
title: "X Chat のよくある問題を解決する"
sidebarTitle: トラブルシューティング
description: "X Chat でよくある問題の解決方法をまとめました。鍵のセットアップ、バックアップの復元、復号できないメッセージ、送信エラーなど。"
keywords: ["X Chat エラー", "トラブルシューティング", "Chat XDK", "復号失敗", "セキュアキーバックアップ", "暗号化エラー"]
---
...
- **API** は登録時にアップロードされたそのままの形で鍵を保存・返却します:DER (SPKI) エンコーディングで、固定のアルゴリズム識別子プレフィックスの後ろに生の鍵が続きます
