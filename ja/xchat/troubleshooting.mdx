...
description: X Chat の暗号化と Chat XDK の問題
keywords: ["X Chat errors", "Chat XDK", "decryption", "Juicebox", "encryption"]
---

このページでは、**X Chat の暗号化と Chat XDK に特有の**問題（鍵、Juicebox、復号/検証、暗号化された送信ペイロードの構築）を扱います。
...
- 平文、PIN、秘密鍵、または完全な鍵 blob は**ログに記録しない**
