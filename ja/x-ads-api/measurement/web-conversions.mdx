---
title: Web コンバージョン
description: X Ads API の web conversions エンドポイントをセットアップして利用し、ウェブサイトのコンバージョンイベントを追跡、広告パフォーマンスを測定、キャンペーン配信を最適化します。
keywords: ["web conversions", "コンバージョントラッキング", "web コンバージョントラッキング", "コンバージョン", "track conversions", "conversion API"]
---
...
##### オプション 1: Ads Manager 内の既存の Conversion Event を使用する
...
##### オプション 2: Ads Manager 内で新しい Conversion Event を作成する:
