---
title: Creatives API リファレンス
description: "X Ads Creatives API のエンドポイントリファレンス。account media、Card、scheduled Tweet、Media Library、promoted video のクリエイティブ操作をカバーします。"
