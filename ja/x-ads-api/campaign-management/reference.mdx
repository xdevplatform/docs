---
title: キャンペーン管理 API リファレンス
description: "X Ads Campaign Management API のエンドポイントリファレンス。アカウント、キャンペーン、line item、funding instrument、targeting criteria のリクエストをカバーします。"
