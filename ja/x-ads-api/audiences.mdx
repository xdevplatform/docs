---
title: オーディエンス
description: "X Ads のオーディエンスターゲティングの概要。広告キャンペーンでユーザーにリーチするために使用する Custom Audience、CRM、web、mobile、および lookalike セグメントをカバーします。"
sidebarTitle: 概要
keywords: ["audiences", "tailored audiences", "custom audiences", "オーディエンスターゲティング", "crm audiences", "web audiences", "audience api", "x ads audiences"]
---
