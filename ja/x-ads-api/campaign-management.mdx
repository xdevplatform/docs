...
title: キャンペーン管理
sidebarTitle: 概要
description: X 上で広告キャンペーンを作成、管理、最適化します。Ads API を用いて予算、ターゲティング、クリエイティブ、入札戦略を定義します。
keywords: ["キャンペーン管理", "ads api", "line items", "ad groups", "promoted ads", "advertising campaigns", "x ads", "campaign api"]
---
