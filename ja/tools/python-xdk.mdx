...
<CardGroup cols={2}>
  ...
  <Card title="クイックスタート" icon="/icons/xds/icon-rocket.svg" href="/xdks/python/quickstart">
    ステップバイステップの初回リクエストのウォークスルー。
  </Card>
  <Card title="認証" icon="/icons/xds/icon-key.svg" href="/xdks/python/authentication">
    すべての認証方法の詳細ガイド。
  </Card>
  ...
  <Card title="API リファレンス" icon="/icons/xds/icon-book.svg" href="/xdks/python/reference/modules">
    クライアントとモデルの完全リファレンス。
  </Card>
</CardGroup>
