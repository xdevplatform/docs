...
<CardGroup cols={2}>
  ...
  <Card title="認証" icon="/icons/xds/icon-key.svg" href="/xdks/typescript/authentication">
    すべての認証方法の詳細ガイド。
  </Card>
  ...
  <Card title="API リファレンス" icon="/icons/xds/icon-book.svg" href="/xdks/typescript/reference/modules">
