...
description: "Listen for new X Chat messages and events in real time using webhooks or a stream, then decrypt them with the Chat XDK."
keywords: ["X Chat events", "webhooks", "activity stream", "real-time messages", "chat.received", "chat.sent"]
---
