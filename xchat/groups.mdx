...
sidebarTitle: Groups
description: "Build group conversations in X Chat: create a group, add or remove members, and set an encrypted name and avatar, all with the same security as 1:1 chats."
keywords: ["X Chat groups", "group chat", "group DM", "conversation keys", "group name encryption", "add members"]
---
