...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    const reply = chat.encryptReply(
      replyMessageId, senderId, conversationId, rawConversationKey,
      'Sounds good', conversationKeyVersion, signingKeyVersion,
      parentSequenceId, // replyToSequenceId — the message being replied to
    );
