...
description: "Meet the Chat XDK, the library that handles keys, encryption, decryption, and signing for you, with references for every supported language."
keywords: ["Chat XDK", "chat-xdk", "encryption SDK", "key management", "signing", "SDK reference"]
---
