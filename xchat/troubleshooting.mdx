...
description: Diagnose common X Chat encryption issues including Chat XDK errors, Juicebox key recovery, decryption failures, and building signed send payloads.
