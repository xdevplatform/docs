---
title: Getting Started with XChat API
sidebarTitle: Getting Started
description: Build your first end-to-end encrypted messaging application with XChat
keywords: ["XChat tutorial", "encrypted DM tutorial", "XChat quickstart", "XChat setup", "XChat Python", "XChat TypeScript"]
---

import { Button } from '/snippets/button.mdx';

This guide walks you through building an XChat application that can send and receive end-to-end encrypted direct messages. By the end, you'll have a working application that can:
...
Your XChat application needs three components:

```mermaid
flowchart TB
    subgraph "Your Application"
        A[XChat XDK<br/>Encryption]
        B[XDK<br/>API Calls]
...
| Component | Purpose |
|:----------|:--------|
| **XChat XDK** | Handles all encryption, decryption, and key management |
...
<Tabs>
  <Tab title="Python">
    ...
    # Initialize the XChat XDK with Juicebox configuration
...
<Tabs>
  <Tab title="Python">
    ...
    def send_message(conversation_id: str, text: str):
        ...
        # Encrypt the message using the XChat XDK
...
Explore working code examples to accelerate your development:

<CardGroup cols={2}>
  <Card title="Rust: Decode Chat" icon="rust" href="https://github.com/xai/chat-xdk/tree/main/examples">
    Complete example showing message decryption with the XChat XDK. Includes config loading, key unlocking, and event parsing.
  </Card>
  <Card title="TypeScript: Juicebox Demo" icon="js" href="https://github.com/xai/juicebox-sdk/tree/main/javascript/demo">
    Node.js demo for Juicebox key storage operations — register, unlock, and recover secrets.
  </Card>
  <Card title="Swift: iOS Demo" icon="swift" href="https://github.com/xai/juicebox-sdk/tree/main/swift/demo">
    iOS/macOS example app demonstrating Juicebox integration in Swift.
  </Card>
  <Card title="Customer Service Bot" icon="robot">
    See the [complete example](#complete-example-customer-service-bot) above for a full Flask-based bot implementation.
  </Card>
</CardGroup>
