...
<Tip>
Ready-to-run one-time registration scripts for every binding live in the Chat XDK repo—for example [`examples/python/register.py`](https://github.com/xdevplatform/chat-xdk/blob/main/examples/python/register.py). Use them instead of hand-rolling the flow below when you just need to onboard a new identity.
</Tip>
