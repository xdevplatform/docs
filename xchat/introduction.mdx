...
| POST | [`/2/chat/conversations/group`](/x-api/chat/create-chat-group-conversation) | Create group conversation |
| POST | [`/2/chat/conversations/group/initialize`](/x-api/chat/initialize-chat-group) | Initialize chat group |
| GET | [`/2/chat/conversations/{id}`](/x-api/chat/get-chat-conversation) | Get conversation |
| POST | [`/2/chat/conversations/{id}/keys`](/x-api/chat/initialize-conversation-keys) | Initialize conversation keys |
| POST | [`/2/chat/conversations/{id}/members`](/x-api/chat/add-members-to-a-chat-group-conversation) | Add members to group conversation |
...
| GET | [`/2/users/public_keys`](/x-api/users/get-public-keys-for-multiple-users) | Get public keys for multiple users |
...
| GET | [`/2/chat/media/{id}/{media_hash_key}`](/x-api/chat/download-chat-media) | Download media |
