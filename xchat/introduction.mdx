---
title: X Chat API for end-to-end encrypted direct messages
sidebarTitle: Introduction
description: Overview of the X Chat API for sending and receiving end-to-end encrypted, signed direct messages on X with client-side encryption via the Chat XDK.
