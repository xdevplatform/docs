---
title: "Send encrypted direct messages with the X Chat API"
sidebarTitle: Introduction
description: "Learn what the X Chat API offers: send and receive encrypted, signed direct messages on X, with the Chat XDK handling the hard parts for you."
keywords: ["X Chat API", "Chat API", "encrypted DM", "encrypted direct messages", "Chat XDK"]
---

The **Chat API** lets you send and receive **encrypted** direct messages on X. Message bodies are encrypted on the client; X routes ciphertext and cannot read plaintext content. Messages are also **signed** so recipients can verify the sender.
...
|:------|:---------------|
| **[Chat XDK](/xchat/xchat-xdk)** | Generate keys, encrypt/decrypt, sign/verify, optional passcode-protected secure key backup (Python, JS, Rust, Go, C#, Java) |
