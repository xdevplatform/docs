---
title: Send encrypted images and file attachments in X Chat
sidebarTitle: Media
description: Encrypt, upload, send, download, and decrypt images and file attachments in X Chat using the Chat XDK stream encryption and media upload endpoints.
