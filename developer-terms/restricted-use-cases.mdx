---
title: "Restricted uses of the X API"
description: "Details on restricted use cases for the X API, including off-platform tracking, government surveillance, sensitive data handling, and prohibited tools."
...
You are not permitted to register multiple applications for a single use case, or substantially similar or overlapping use cases. Learn more about these policies [here](https://devcommunity.x.com/t/policy-clarification-multiple-applications-for-the-same-use-case/92080).
...
For additional information for law enforcement authorities seeking information about X accounts, visit https://t.co/le.
