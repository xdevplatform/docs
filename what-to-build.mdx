...
icon: lightbulb
description: Project ideas and use cases for the X API, from chatbots and analytics dashboards to content moderation, research tools, and community apps.
...
<CardGroup cols={2}>
  <Card title="Moderation tools" icon="/icons/xds/icon-shield-keyhole.svg">
    Build tools to help users manage replies, filter content, and protect their experience.
  </Card>
  <Card title="Anti-harassment" icon="/icons/xds/icon-block.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Bots & automation" icon="/icons/xds/icon-ai-agents.svg">
...
<CardGroup cols={2}>
  <Card title="Performance dashboards" icon="/icons/xds/icon-bar-chart.svg">
    Visualize engagement metrics, growth trends, and reach.
  </Card>
  <Card title="Audience insights" icon="/icons/xds/icon-people.svg">
    Analyze followers, engagement patterns, and demographics.
  </Card>
  <Card title="Trend analysis" icon="/icons/xds/icon-feather-chart-line.svg">
    Track hashtags, topics, and conversation volume.
  </Card>
  <Card title="Competitive analysis" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  <Card title="MCP-powered agents" icon="/icons/xds/icon-ai-agents.svg">
