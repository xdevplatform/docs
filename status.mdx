...
description: Live status of the X API v2, Enterprise APIs, Ads API, streaming endpoints, and all supporting services. Includes current incidents and historical uptime.
...
Incident is ongoing. | **April 14, 02:20 UTC - Current**
</Step>
</Steps>
