...
icon: bookmark
description: Bookmark key X API documentation, SDKs, Postman collections, support channels, status pages, and community resources for developers building on X.
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
