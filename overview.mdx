...
<CardGroup cols={2}>
  <Card title="X API — Pay-per-use" icon="/icons/xds/icon-coins.svg" href="/x-api/introduction">
...
<CardGroup cols={2}>
  <Card title="Tutorials" icon="/icons/xds/icon-book.svg" href="/tutorials">
    Step-by-step guides for common use cases and integrations.
  </Card>
  <Card title="Tools & Libraries" icon="/icons/xds/icon-wrench.svg" href="/tools-and-libraries">
  ...
  <Card title="Agent Resources" icon="/icons/xds/icon-ai-agents.svg" href="/tools/ai">
