...
2.  Create a [X App](/resources/fundamentals/developer-apps) within the [developer portal](/resources/fundamentals/developer-portal). Note that if you would like to use [X API v2](/x-api/introduction), you must add your Twitter App to a [Project](/resources/fundamentals/projects).
     
...
* [Getting started with Postman](/tutorials/postman-getting-started)
