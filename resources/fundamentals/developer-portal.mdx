...
- Create and manage your X [Projects](https://developer.twitter.com/en/docs/projects) and [Apps](https://developer.twitter.com/en/docs/apps) (and the authentication keys and tokens that they provide).
...
The onboarding wizard guides you through the process of setting up your first [Project](https://developer.twitter.com/en/docs/projects/overview.html) and [App](https://developer.twitter.com/en/docs/apps/overview.html). You will need to create a Project and App to receive the credentials required to authenticate your API requests. You will see the wizard if you are accessing your developer account for the first time.

Through this process, you will receive a set of authentication keys and tokens, which you can learn more about on our [App overview page](https://developer.twitter.com/en/docs/apps/overview). To learn more about what is needed to authenticate with the X API, take a look at the [authentication section](https://developer.twitter.com/en/docs/authentication/).

**Please note:** You will need to [store your keys and tokens in a secure location](https://developer.twitter.com/en/docs/authentication/guides/authentication-best-practices) so you can access them later on. There is no way to reference these credentials without regenerating them.

### Project and App management

One of the primary roles of the developer account is to enable to you [manage your Projects and Apps](https://developer.twitter.com/en/docs/apps/app-management). Developers can both create and manage X Projects and Apps from the Dashboard in the developer portal. This is where you can find your App IDs; edit an App's setting, permissions, and callback URLs; and generate and revoke keys and tokens.
...
Review [all v2 access levels](https://developer.twitter.com/en/docs/twitter-api/getting-started/about-twitter-api#v2-access-level).
...
**Please note:** Team management does not currently grant/limit API access based on [App](https://developer.twitter.com/en/docs/apps/overview.html) credentials. It is not possible to share App management across your team. Apps (keys/tokens) cannot be edited, created, or deleted by non-owners.
