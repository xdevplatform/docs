...
<CardGroup>
  <Card title="Explore a user's Posts" icon="/icons/xds/icon-person.svg" iconType="solid">
  ...
  <Card title="Getting started with Postman" icon="/icons/xds/icon-rocket.svg" iconType="solid">
  ...
  <Card title="Getting started with R and v2 of the X API" icon="/icons/xds/icon-rocket.svg" iconType="solid">
  ...
  <Card title="Getting historical Posts using the full-archive search endpoint" icon="/icons/xds/icon-search.svg" iconType="solid">
