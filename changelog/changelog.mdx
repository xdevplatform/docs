...
To subscribe to updates, please [**“Turn on notifications”**](https://help.twitter.com/en/managing-your-account/notifications-on-mobile-devices#:~:text=In%20the%20top%20menu,%20you,you%20would%20like%20to%20receive) for [**@API**](https://twitter.com/api).
...
Today, we added the Trends lookup endpoint in the X API v2. Learn more about it [here](https://twittercommunity.com/t/announcing-the-users-search-and-trends-lookup-endpoints-in-the-x-api-v2/210567).

### December 8, 2023

`X API v2`

Today, we added the Users Search endpoint in the X API v2. Learn more about it [here](https://twittercommunity.com/t/announcing-the-users-search-and-trends-lookup-endpoints-in-the-x-api-v2/210567).

### November 29, 2023

`X API v2`

Today, we added the ability to the get DM permissions via the X API v2. Learn more about it [here](https://twittercommunity.com/t/dm-permissions-available-in-the-x-api-v2/209688).

### November 20, 2023

`X API v2`

Today, we launched a subscription\_type field on the User object in the X API v2. Learn more about it [here](https://twittercommunity.com/t/new-subscription-type-field-is-available-in-the-twitter-api-v2/209219/2).

### November 2, 2023

`X API v2`

Today, we launched an endpoint to programmatically get your posts usage in the X API v2. Learn more about it [here](https://developer.twitter.com/en/docs/twitter-api/usage/tweets/api-reference/get-usage-tweets).

### September 28, 2023

`X API v2`

Today, we launched an endpoint to lookup reposts of a post in the X API v2. Learn more about it [here](https://developer.twitter.com/en/docs/twitter-api/tweets/retweets/api-reference/get-tweets-id-retweets).

### September 28, 2023

`X API v1.1`

Today, we are deprecating the search/tweets, users/search, and geo/search endpoints in the X API v1.1. Learn more [here](https://developer.twitter.com/en/docs/twitter-api/enterprise/powertrack-api/guides/powertrack_recovery_and_redundancy_features).

### September 21, 2023

`X API: Enterprise`

Today, we are deprecating the Replay API endpoint from the enterprise X API. You can use [recovery](https://developer.twitter.com/en/docs/twitter-api/enterprise/powertrack-api/guides/powertrack_recovery_and_redundancy_features)  featured instead.
...
Please visit our [blog post](https://developer.twitter.com/en/blog/product-news/2022/new-v2-direct-messages-endpoints) to learn more about this update.
...
Please visit our [blog post](https://developer.twitter.com/en/blog/product-news/2022/twitter-api-v2-filtered-stream) to learn more about this update.
...
Please visit our [forum announcement](https://twittercommunity.com/t/v1-1-media-endpoints-available-for-essential-access-in-the-twitter-api-v2/171664) to learn more about this update.
...
Please visit our [forum announcement](https://twittercommunity.com/t/reverse-chronological-home-timeline-in-the-twitter-api-v2/171549) to learn more about this launch.

Along with the new endpoints,  the variants field is now available for the [media object](https://developer.twitter.com/en/docs/twitter-api/data-dictionary/object-model/media). This will give you the type of content attached with the URL.
...
Please visit our [forum announcement](https://twittercommunity.com/t/build-with-bookmarks-on-the-twitter-api-v2/168804) to learn more about this launch.

### March 17th, 2022

`X API v2`

Today, we’re launching the [quotes lookup endpoint](https://developer.twitter.com/en/docs/twitter-api/tweets/retweets/introduction) that lets you get the quotes for a post ID. 

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/introducing-the-quote-tweets-lookup-endpoint-to-the-twitter-api-v2/168370) to learn more about this launch.
...
Today, we’re launching improvements to the [reposts lookup](https://developer.twitter.com/en/docs/twitter-api/tweets/retweets/introduction) and the [Likes lookup](https://developer.twitter.com/en/docs/twitter-api/tweets/likes/introduction) endpoints, allowing you to get back the complete list of accounts who have Liked or reposted a post, not just the last 100 accounts to do so. 
...
*   We are removing language in our Developer Policy that restricted how you build with X’s core features, and limited the number of users you can support through your app.
    *   We are opening up our platform to encourage you to build tools and products that make X better, healthier, and extend the public conversation. [See a list of solutions we’d love to see you build](https://developer.twitter.com/en/docs/twitter-api/what-to-build). 
...
We go into a lot more detail on this launch and the X API launches that led to this moment in our [forum post](https://twittercommunity.com/t/ushering-in-a-new-era-for-the-twitter-developer-platform-with-the-twitter-api-v2/162087). 
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-list-lookup-endpoints-for-the-twitter-api-v2/161965).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/adding-new-functionality-to-spaces-endpoints/161959).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-manage-tweets-endpoints-for-the-twitter-api-v2/161501).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/embedded-buttons-have-a-new-look/160528).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-new-twitter-api-v2-manage-list-endpoints/159980).

### September 22nd, 2021

`X API v2: Early Access`

Today, we’re launching the new [mutes lookup](https://developer.twitter.com/en/docs/twitter-api/users/mutes/introduction) endpoint to the X API v2. This endpoint will allow authenticated users to retrieve and get information on the accounts they have muted.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-new-mutes-lookup-endpoint-for-the-twitter-api-v2/159680).
...
Today, we’re launching the new [batch compliance endpoints](https://developer.twitter.com/en/docs/twitter-api/compliance/batch-compliance/introduction) to the X API v2 to make it easier for developers using the X API to keep their X data in compliance with our [Developer Agreement and Policy](https://developer.twitter.com/en/developer-terms/policy). These endpoints allow developers and researchers to batch upload large amounts of post or User IDs and understand what action is needed to ensure that their datasets reflect user intent and the current state of the content on X.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/new-batch-compliance-endpoints-available-on-the-twitter-api-v2/158534).
...
Today, we’re launching the new [Spaces endpoints](https://developer.twitter.com/en/docs/twitter-api/spaces/overview) and a [new top-level Spaces data dictionary](https://developer.twitter.com/en/docs/twitter-api/data-dictionary/object-model/space) to the X API v2. The Spaces endpoints enable you to lookup Spaces by Space ID or user ID, or using keywords, hashtags, or usernames of people mentioned in a title. The new data dictionary contains relevant information about a Space such as its title, ticketed status, and participant metrics; all user IDs can be expanded into full objects.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/introducing-new-spaces-endpoints-on-the-twitter-api-v2/158213).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/new-engagement-api-video-views-object-to-clarify-limitation/158163).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/media-alt-text-field-now-available-in-twitter-api-v2/157939).
...
Today, we’re launching new [reposts](https://developer.twitter.com/en/docs/twitter-api/tweets/retweets) endpoints to X API v2.  Developers can now use these endpoints to repost or undo a repost on behalf of an authenticated user, or to look up who reposted a given post.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-new-twitter-api-v2-retweets-endpoints/156827).
...
Today, we’re launching new [manage mutes](https://developer.twitter.com/en/docs/twitter-api/users/mutes/introduction) endpoints to the X API v2. These endpoints will allow authenticated users to mute or unmute accounts.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-new-manage-mutes-endpoints-for-the-twitter-api-v2/156261).
 
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/new-reliability-and-recovery-functionality-available-for-twitter-api-v2-streaming-endpoints/156244/2).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/introducing-new-tweet-counts-endpoints-to-the-twitter-api-v2/155997).
...
Today, we’re launching key improvements to the functionality of teams based on feedback we’ve heard from the community. We have updated the style and design of the team page. We also made changes to the invitation flow to make it easier to invite team members or to learn more about why an invitation might have failed. If you have a team account you can check out the changes by viewing the [teams page](https://developer.twitter.com/en/portal/teams) of the developer portal. To learn more about teams check out our [documentation on the subject](https://developer.twitter.com/en/docs/developer-portal/overview#team) and related [FAQ](https://developer.twitter.com/en/docs/developer-portal/faq#dev-portal-management-faq).

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-improvements-to-the-functionality-of-teams/155447/2).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/retiring-the-1-1-configuration-endpoint/153319).
...
Today, we’re sharing that the v1.1 oEmbed endpoint will be retired and removed on November 23, 2021, so that new features can be supported in a consistent manner. After that date, the only official and supported API endpoint for X oEmbeds (embedded posts and timelines) will be via publish.twitter.com/oembed.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/consolidating-the-oembed-functionality/154690/2).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-twitter-api-v2-likes-lookup-and-blocks-lookup/154353).
...
Today, we’re launching the new [manage Likes](https://developer.twitter.com/en/docs/twitter-api/tweets/likes) endpoints to the X API v2. These endpoints enable you to use the v2 API to like and unlike posts.

To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-new-manage-likes-endpoints-for-thetwitter-api-v2/152780).[](https://twittercommunity.com/t/announcing-new-manage-likes-endpoints-for-thetwitter-api-v2/152780)
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/announcing-manage-blocks-for-twitter-api-v2/152358/2).
...
You can learn more about this change in our [forum announcement](https://twittercommunity.com/t/removing-support-for-embedded-like-collection-and-moment-timelines/150313).
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/introducing-the-new-manage-follows-endpoints-to-the-twitter-api-v2/149465).
...
Today, we are introducing the new [Academic Research product track](/resources/fundamentals/projects) to [X API v2](/resources/fundamentals/projects). This update introduces a new application process for Academic Researchers that will provide those that are approved with an Academic Research [Project](/resources/fundamentals/projects) that will unlock greater access and advanced functionality.
...
*   An increased [post cap](/x-api/fundamentals/tweet-cap) of 10 million, up from the 500,000 that is available to the [Standard product track](/resources/fundamentals/projects) at the Basic [access level](https://developer.x.com/en/products/x-api/early-access/guide#na_2). 
...
To learn more about this launch, please visit our [forum announcement](https://twittercommunity.com/t/introducing-the-new-academic-research-product-track/148632).
...
If you have any questions, please reach out to our [Labs forum category](https://twittercommunity.com/c/labs/57). 
...
In the [main dashboard page](https://developer.twitter.com/en/portal/dashboard) of the new developer portal, you can now check your usage towards the [post cap](/x-api/fundamentals/tweet-cap) of 500,000 posts per month. This cap is applied at the Project level, across the following v2 endpoints in Basic access: filtered stream, and recent search.

In order to see this feature and use the new v2 endpoints, you will need to activate the [new developer portal experience](https://developer.twitter.com/en/portal/opt-in.html).
...
Today we announced [Early Access to the first endpoints of the new X API](https://blog.twitter.com/developer/en_us/topics/tools/2020/introducing_new_twitter_api.html)!
...
Get more details in the [Hide replies documentation](https://developer.twitter.comhttps://developer.x.com/en/docs/labs).
...
You can read more about our Labs v1 plan in our [forum announcement](https://twittercommunity.com/t/update-on-labs-v1-endpoints/138641).
...
You can read more about this change in our [forum post](https://twittercommunity.com/t/how-the-new-retweets-and-comments-metric-is-returned-with-the-twitter-api/139131). 
...
You can read more about these changes in our [forum announcement](https://twittercommunity.com/t/adding-metrics-to-the-tweets-and-recent-search-endpoints-in-labs/135315)
...
You can read more about these changes in our [forum announcement.](https://twittercommunity.com/t/new-covid-19-stream-endpoint-available-in-twitter-developer-labs/135540)
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/adding-annotations-to-tweets-and-recent-search-endpoints-in-labs/135193).
...
Today, we announced a significant [update to the Developer Policy](https://developer.x.com/en/developer-terms/policy). We encourage you to read more about this via our [forum](https://twittercommunity.com/t/a-new-easier-to-understand-twitter-developer-policy/135038) and [blog](https://blog.twitter.com/developer/en_us/topics/community/2020/twitter_developer_policy_update.html) posts, and to review the revised policy. The Developer Policy is one of the foundations for your use of the X API and it is important to understand your commitments.
...
You can read more about this new endpoint in our [forum announcement](https://twittercommunity.com/t/introducing-the-hide-replies-endpoint/134683).
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/releasing-a-new-version-of-labs-endpoints/134219).
...
Today, we're making changes to the way that Access Tokens and Access Token Secrets are presented and managed within the [applications Dashboard on developer.twitter.com](https://developer.x.com/content/developer-twitter/en/apps). 
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/upcoming-changes-to-access-token-and-secret-management/130851).  
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/removing-support-for-spdy-protocol-on-twitter/132530).  
...
Learn more about this launch via our [forum announcement.](https://twittercommunity.com/t/new-recent-search-endpoint-available-in-labs/133076)
...
Learn more about this launch via our [forum announcement](https://twittercommunity.com/t/tweet-annotations-added-to-the-tweet-object-for-the-sampled-stream-and-filtered-stream-endpoints-in-labs/132407).
...
You can read more about the `user_has_blocked` [data object structure](/x-api/enterprise-gnip-2.0/fundamentals/account-activity#account-activity-data-object-structure) and check out our [forum announcement](https://twittercommunity.com/t/new-release-account-activity-api-user-has-blocked-field/131157) for more details.
...
Learn more about this launch via our [forum announcement.](https://twittercommunity.com/t/new-sampled-stream-endpoint-available-in-labs/130958)
...
Learn more about this launch via our [forum announcement](https://twittercommunity.com/t/new-filtered-stream-endpoints-available-in-labs-and-the-future-of-statuses-filter/129888).
...
Learn more about this launch via our [forum announcement](https://twittercommunity.com/t/new-twitter-developer-labs-release-metrics-endpoint/129122).
...
You can learn more about this change via our [forum announcement](https://twittercommunity.com/t/updates-to-app-permissions-direct-message-write-permission-change/128221).
...
Learn more about this launch via our [forum announcement](https://twittercommunity.com/t/update-to-twitter-developer-labs/128060).
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/removing-support-for-legacy-tls-versions-1-0-1-1-on-twitter/126648/2).
...
Learn more about this launch via our [forum announcement](https://twittercommunity.com/t/twitter-developer-labs-is-open-to-all-developers/126717).
...
We have fully retired the Terms of Service and Privacy Endpoints. The current status of our [Privacy Policy](https://twitter.com/en/privacy) and [Terms of Service](https://twitter.com/en/tos) is best served by our up-to-date web pages.

You can learn more about this change via our [forum announcement](https://twittercommunity.com/t/terms-of-service-and-privacy-endpoints-will-no-longer-serve-content-after-june-10/125714).  

### May 21st, 2019

`X API: Standard v1.1`     `X API: Premium v1.1`     `X API: Enterprise v1.1`    

Today some user object fields, including user.lang, will start returning 'null' for updated metadata fields previously announced in our [forum post](https://twittercommunity.com/t/upcoming-changes-to-user-object-and-get-users-suggestions-endpoints/124732).
...
Today, we've added the ability for developers to view and edit their existing [X apps](/resources/fundamentals/developer-apps) via the [X app dashboard](https://developer.x.com/content/developer-twitter/en/apps) on developer.twitter.com as long as they're logged into their X account. Previously, you could only view and edit your existing X apps on developer.twitter.com if you had applied or been approved for a [developer account](/resources/fundamentals/developer-portal). 
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/new-post-endpoint-rate-limit-enforcement-begins-today/115355).  
...
You can read more about this change in our [forum announcement](https://twittercommunity.com/t/new-update-to-the-twitter-text-library-emoji-character-count/114607).  
...
You can learn more about this update via our [forum announcement](https://twittercommunity.com/t/details-and-what-to-expect-from-the-api-deprecations-this-week-on-august-16-2018/110746).  

### September 11th, 2018

`X API: Standard v1.1`    

Today we are implementing some changes to the process where you [retreive attached media from Direct Messages](https://developer.x.com/en/docs/x-api/v1/direct-messages/message-attachments/overview). We will no longer support accessing `media_url` or `media_url_https` via an authenticated www.twitter.com session. The request to fetch `media_url_https` MUST always be signed with the user’s access token using OAuth 1.0A. 

You can learn more about this update via our [forum announcement](https://twittercommunity.com/t/direct-message-api-change-to-how-apps-can-access-images-sent-in-direct-messages/112722).
...
If you have a [developer portal](/resources/fundamentals/developer-portal) account, you can now create and manage your [X apps](/resources/fundamentals/developer-apps). Please read our [forum post](https://twittercommunity.com/t/app-creation-and-management-now-available-in-the-developer-portal/107723) for more details.  
...
Today, we started requiring that you register the [callback URLs](/resources/fundamentals/developer-apps#callback-urls) that you use with the Sign in with X process. You can read more about this update [here](https://twittercommunity.com/t/action-required-sign-in-with-twitter-users-must-whitelist-callback-urls/105342).

We also announced the addition of the tweet\_delete\_events activity to the Account Activity API. This new activity will be sent for those corresponding deleted events to enable developers to more easily provide a compliant experience for their customers and application users. You can read more about this new activity in our [forum post](https://twittercommunity.com/t/adding-delete-events-to-the-account-activity-api/106783) or on our [documentation](/x-api/enterprise-gnip-2.0/fundamentals/account-activity).  
...
Today, we made some changes to our [Terms of Service](https://twitter.com/en/tos), [Privacy Policy](https://twitter.com/en/privacy), and [X Developer Agreement]https://developer.x.com/en/developer-terms/agreement-and-policy that include privacy, security, and data protection updates. Please read our [forum post](https://twittercommunity.com/t/upcoming-changes-to-the-developer-platform/104603) for more details.

### May 23rd, 2018

`X API: Standard v1.1`     `X API: Premium v1.1`     `X API: Enterprise v1.1`     `X Ads API`    

Today, the timezone values in X user objects became private fields. From here on out, all\* time\_zone and utc\_offset data objects will return as null. Please read our [forum post](https://twittercommunity.com/t/upcoming-changes-to-the-developer-platform/104603) for more details.
...
Today, we are changing all instances of profile\_background\_image\_url and profile\_background\_image\_url\_https to their default values. Please read our [forum post](https://twittercommunity.com/t/upcoming-changes-to-the-developer-platform/104603) for more details.
...
Please read our [forum post](https://twittercommunity.com/t/updating-how-urls-are-rendered-in-the-quote-tweet-payload/105473) and [updated documentation](https://twittercommunity.com/t/upcoming-changes-to-the-developer-platform/104603) for more details.  

### April 30th, 2018

`X for Websites `       

The announcement of [X Kit](https://developer.x.com/en/docs/x-for-websites) deprecation, after October 31, 2018 X Kit will no longer be actively maintained.  Please read our [blog post](https://blog.twitter.com/developer/en_us/topics/tools/2018/discontinuing-support-for-twitter-kit-sdk.html) for more details.  
...
Today we announced several updates to the platform related to GDPR. Please read our [forum post](https://twittercommunity.com/t/upcoming-changes-to-the-developer-platform/104603) for more details.  
...
Launch of the [premium full-archive search endpoint](https://blog.twitter.com/developer/en_us/topics/tools/2018/access-the-full-history-of-tweets.html).  

### December 19th, 2017

`X API: Premium v1.1 `   

Launched both ([All Activities](/x-api/enterprise-gnip-2.0/fundamentals/account-activity#migration-introduction)) and ([Direct Messages](/x-api/enterprise-gnip-2.0/fundamentals/account-activity#migration-introduction)) Standard beta Account Activity APIs, read more about this launch [on our blog](https://blog.twitter.com/developer/en_us/topics/tools/2017/announcing-more-functionality-to-improve-customer-engagements-on-twitter.html).  Announced User streams & Site streams deprecation and sunset date of Tuesday June 19, 2018.  
...
Version 2.0 of twitter-text is now available [on GitHub](https://github.com/twitter/twitter-text). This update addresses the change in our character limit that was rolled out on November 7th, 2017. To learn more about this update, please [visit our forum](https://twittercommunity.com/t/shipped-twitter-text-2-0/98577).  
...
Read more about this launch [on our blog](https://blog.twitter.com/developer/en_us/topics/tools/2017/introducing-twitter-premium-apis.html).  
...
Official launch of 280 character posts in languages where cramming was an issue. Please see our [forum announcement](https://twittercommunity.com/t/updating-the-character-limit-and-the-twitter-text-library/96425) or official [blog post](https://blog.twitter.com/official/en_us/topics/product/2017/tweetingmadeeasier.html) for further reference.  

### November 1st, 2017

`X API: Standard v1.1`    

The ability to send Direct Messages via the statuses/update API endpoint has been completely removed, and the `enable_dm_commands` and `fail_dm_commands` parameters will no longer have any effect. Read more about this update [on our forum](https://twittercommunity.com/t/retiring-legacy-dm-commands-on-the-standard-tweet-api/86653 "on our forum").  
...
A change was made to X’s backend OAuth API endpoints which altered the behaviour of the /oauth/authenticate endpoint to match that of the /oauth/authorize endpoint. Read more about this update [on our forum](https://twittercommunity.com/t/recent-changes-to-twitter-s-oauth-login-flow-and-api-endpoints/94943).  

### October 10th, 2017

`X API: Enterprise v1.1`    

The Engagement API was updated to use the same metrics aggregation methodology in use by the X analytics dashboard. Read more about this update [on our forum](https://twittercommunity.com/t/changes-to-the-engagement-api/94523).  

### October 1st, 2017

`X API: Standard v1.1 `   

The default value of the `fail_dm_commands` parameter within the DM statuses/update endpoint has been switched to _true_. All status updates intended as Direct Messages will start to return errors (unless `enable_dm_commands` is _false_, in which case the post will be posted). Read more about this update [on our forum](https://twittercommunity.com/t/retiring-legacy-dm-commands-on-the-standard-tweet-api/86653).  
...
The response payload for 280 character tweets will be treated the same way as long tweets. Read more about this update [on our forum](https://twittercommunity.com/t/testing-280-characters-for-certain-languages/94126).  
...
The xAuth authentication mechanism has been removed from all X APIs  Read more about this update [on our forum](https://twittercommunity.com/t/retirement-of-xauth/88022).  

### May 8th, 2017

`X API: Standard v1.1`     `X API: Enterprise v1.1`     `X Ads API`    

All HTTP headers have been forced into lowercase (`content-type`, `x-rate-limit-remaining`, `x-access-level` etc). Read more about this update [on our forum](https://twittercommunity.com/t/upcoming-http-header-changes/86715).  

### May 5th, 2017

`X API: Standard v1.1`    

The optional `enable_dm_commands` parameter to statuses/update will enable applications to remove DM command support early, before the transition period ends. The default value is _true_ (i.e. current legacy behavior), but this may be set to _false_ to get the new, post-November 1 behavior. The optional fail\_dm\_commands parameter to statuses/update will make DM commands return HTTP 403 (error code 151) from the API when set to _true_. The default value is _false_. Read more about this update [on our forum](https://twittercommunity.com/t/retiring-legacy-dm-commands-on-the-standard-tweet-api/86653).  
...
MPEG-DASH URLs (.mpd) has been removed from the payload of a post that contains video. Read more about this update [on our forum](https://twittercommunity.com/t/retiring-mpeg-dash-video-support-on-march-9th-2017/82761).  
