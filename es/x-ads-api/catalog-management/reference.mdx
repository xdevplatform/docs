---
title: Referencia de la API de gestión de catálogos
sidebarTitle: Referencia de la API
description: "Referencia técnica completa para todos los endpoints de gestión de catálogos en la X Ads API: Product Catalogs, Products, Product Sets y Scheduled Feeds."
