---
title: Pruebas A/B
description: "Ejecuta pruebas A/B en campañas de X Ads para comparar variaciones de creatividades, segmentación, tipo de puja y unidad de puja entre divisiones aleatorizadas de grupos de usuarios y medir el impacto."
