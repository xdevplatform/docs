...
description: import { Button } from "/snippets/button.mdx";  ## Cómo obtener acceso a la Ads API  1. Regístrate para obtener una [cuenta de desarrollador](https://developer.x.com/en/apply-fo...
---
