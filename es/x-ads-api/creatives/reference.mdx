---
title: Referencia de la API de Creatividades
description: "Referencia de endpoints de la API de Creatividades de X Ads que cubre account media, cards, scheduled Tweets, media library y operaciones de promoted video creatives."
