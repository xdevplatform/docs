---
title: Referencia de la API de gestión de campañas
description: "Referencia de endpoints de la API de gestión de campañas de X Ads que cubre accounts, campaigns, line items, funding instruments y solicitudes de targeting criteria."
...
```json title="HOLIDAY" expandable lines wrap icon="/icons/xds/icon-brackets.svg"
    {
      "request": {
        "params": {
          "count": 1
