...
description: "La Política del Desarrollador de X describe el uso aceptable de la API de X, incluidas las reglas sobre contenido, automatización, privacidad, seguridad y comportamientos prohibidos."
