...
description: "Detalles sobre casos de uso restringidos para la API de X, incluyendo el seguimiento fuera de la plataforma, la vigilancia gubernamental, el manejo de datos sensibles y las herramientas prohibidas."
