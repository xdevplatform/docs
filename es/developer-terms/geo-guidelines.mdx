...
description: "Directrices para el manejo de publicaciones con etiquetas geográficas y datos de ubicación provenientes de la API de X, incluyendo funciones geográficas, objetos de lugar y consideraciones de privacidad del usuario."
