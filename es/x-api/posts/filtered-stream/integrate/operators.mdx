...
description: "Referencia de operadores de Filtered Stream (X API v2): palabras clave, has:, is: y el operador embedding: exclusivo de Enterprise para reglas de stream."
...
<CardGroup cols={2}>
  <Card title="Crear una regla" icon="/icons/xds/icon-filter.svg" href="/x-api/posts/filtered-stream/integrate/build-a-rule">
