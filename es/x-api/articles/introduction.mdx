---
title: Introducción
description: Usa los endpoints de Articles de la X API para crear borradores de publicaciones largas con texto enriquecido, medios y embebidos, y publicarlos en X.
