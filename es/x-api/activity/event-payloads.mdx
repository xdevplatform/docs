...
<CardGroup cols={2}>
  <Card title="Introducción" icon="/icons/xds/icon-book.svg" href="/x-api/activity/introduction">
    Tipos de eventos admitidos, privacidad y autenticación
  </Card>
  <Card title="Inicio rápido" icon="/icons/xds/icon-rocket.svg" href="/x-api/activity/quickstart">
