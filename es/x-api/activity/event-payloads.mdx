...
description: "Payloads JSON de ejemplo para eventos de la X Activity API: Posts, Me gusta, follows, perfiles, chat, DMs, Spaces, noticias y revocaciones de OAuth."
