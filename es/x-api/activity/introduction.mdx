...
Actualmente, la X Activity API admite los siguientes tipos de eventos, organizados por categoría. Para ver un JSON de ejemplo de cada tipo, consulta [Payloads de eventos](/x-api/activity/event-payloads).
