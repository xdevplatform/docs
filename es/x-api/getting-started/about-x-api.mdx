...
description: "La API de X ofrece acceso programático a la conversación pública. Recupera posts, analiza tendencias, crea integraciones y nuevas experiencias en X."
...
<CardGroup cols={3}>
  <Card title="Publicaciones" icon="/icons/xds/icon-chat.svg">
...
<CardGroup cols={2}>
  <Card title="Obtener acceso" icon="/icons/xds/icon-key.svg" href="/x-api/getting-started/getting-access">
    Regístrate y crea tu primera app.
  </Card>
  <Card title="Realizar tu primera solicitud" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
