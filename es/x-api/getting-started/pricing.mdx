...
description: "La X API utiliza precios de pago por uso. Sin suscripciones: paga solo por lo que usas. Gana créditos gratuitos de la xAI API cuando compras créditos de la X API, hasta un 20% de devolución."
...
| **Media: Read** | &dollar;0.005 por recurso |
| **Analytics: Read** | &dollar;0.005 por recurso |
| **Trend: Read** | &dollar;0.010 por recurso |
...
|:-------|:----------|
| **Content: Create** | &dollar;0.015 por solicitud |
| **Content: Create (with URL)** | &dollar;0.200 por solicitud |
