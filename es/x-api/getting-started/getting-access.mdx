...
description: "Regístrate como desarrollador, crea una app y guarda las API keys, el bearer token y las credenciales de OAuth que necesitas para empezar a llamar a la X API."
