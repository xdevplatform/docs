---
title: "Diccionario de datos de la X API v2: campos de Post, User y Space"
sidebarTitle: Descripción general
description: "Referencia a nivel de campo para los objetos JSON de la X API v2, incluyendo Post (Tweet), User, Space, Media, Poll y Place, además de expansions y métricas."
keywords: ["diccionario de datos", "tweet fields", "user fields", "objetos de api", "expansions", "métricas", "objeto post", "objeto user", "modelo de datos x api v2"]
---
