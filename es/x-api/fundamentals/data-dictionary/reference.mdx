---
title: Referencia del diccionario de datos
description: "Referencia completa del diccionario de datos de la X API v2 que cubre los campos de los objetos Tweet, User, Media, Place, Poll y Space y cómo solicitarlos con expansions."
sidebarTitle: Referencia
keywords: ["referencia del diccionario de datos", "lista completa de campos", "esquema de objetos api", "campos del objeto tweet", "campos del objeto user", "referencia de expansions"]
---
