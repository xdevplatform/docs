---
title: Usage API
description: "La Usage API es una API REST gratuita que proporciona acceso programático y visibilidad sobre el consumo de actividades entre los productos para tu cuenta enterprise."
sidebarTitle: Usage API
keywords: ["Usage API", "Usage API enterprise", "seguimiento de uso", "seguimiento de consumo", "uso enterprise", "uso de API enterprise"]
---
...
It is the most important and _best_ tool for helping to monitor and manage usage across the different APIs under your account.
...
```bash title="Example request" expandable lines wrap icon="terminal"
{
  "account": {
    "name": "gnip-username"
  },
...
If you would like to see an sample of a full Usage API payload, please visit [this page](/x-api/usage/introduction).
