...
description: "Referencia de todos los campos de Post, User y Space devueltos por los productos de datos Enterprise Gnip 2.0, incluyendo Native Enriched y Activity Streams."
sidebarTitle: Diccionario de datos
keywords: ["diccionario de datos enterprise", "GNIP data dictionary", "formato de datos enterprise", "diccionario de datos enterprise", "objetos enterprise"]
---
