...
<CardGroup cols={2}>
  ...
  <Card title="Completo" icon="/icons/xds/icon-bulleted-list.svg">
    Posts, DMs, seguimientos, likes, bloqueos, silencios y más
  </Card>
  <Card title="Basado en suscripciones" icon="/icons/xds/icon-bell.svg">
...
<CardGroup cols={2}>
  <Card title="Inicio rápido" icon="/icons/xds/icon-rocket.svg" href="/x-api/account-activity/quickstart">
