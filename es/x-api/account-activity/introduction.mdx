...
description: "La Account Activity API (AAA) ofrece una forma de recibir eventos en tiempo real relacionados con X. Referencia para el nivel estándar de la X API v2 que cubre la actividad de la cuenta."
