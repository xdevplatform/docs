...
description: "Guía para configurar la Account Activity API y gestionar suscripciones de usuario. Referencia del tier estándar de la X API v2 para actividad de la cuenta."
...
<CardGroup cols={2}>
  <Card title="Introducción" icon="/icons/xds/icon-book.svg" href="/x-api/account-activity/introduction">
  ...
  <Card title="Inicio rápido de webhooks" icon="/icons/xds/icon-rocket.svg" href="/x-api/webhooks/quickstart">
