---
title: "Tutoriales"
description: "Tutoriales de la X API sobre Postman, Python, R, filtered streaming, búsqueda en archivo completo, webhooks, OAuth y otros flujos comunes."
mode: wide
icon: link
...
<CardGroup>
  <Card title="Explora los Posts de un usuario" icon="/icons/xds/icon-person.svg" iconType="solid">
  ...
  <Card title="Primeros pasos con Postman" icon="/icons/xds/icon-rocket.svg" iconType="solid">
  ...
  <Card title="Primeros pasos con R y la versión v2 de la X API" icon="/icons/xds/icon-rocket.svg" iconType="solid">
  ...
  <Card title="Obtener Posts históricos usando el endpoint de full-archive search" icon="/icons/xds/icon-search.svg" iconType="solid">
