...
description: "Pagina las respuestas de la X API en TypeScript usando UserPaginator y utilidades de paginación genéricas, con bucles manuales de fetchNext o iteración asíncrona para cualquier endpoint de lista."
---

El SDK proporciona utilidades de paginación genéricas que puedes usar con cualquier endpoint que devuelva respuestas paginadas. Los métodos devuelven respuestas simples; tú los envuelves con un paginator.
