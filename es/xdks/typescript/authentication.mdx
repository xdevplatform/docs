...
description: "El SDK de TypeScript admite múltiples métodos de autenticación para diferentes casos de uso. Para operaciones de solo lectura y acceso a datos públicos: Para aplicaciones heredadas."
---

El SDK de TypeScript admite múltiples métodos de autenticación para diferentes casos de uso.

## Bearer Token (autenticación App-Only)
...
Guarda las credenciales sensibles en variables de entorno:
