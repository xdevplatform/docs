...
title: "User"
sidebarTitle: "User"
description: "Referencia de la interfaz TypeScript Schemas.User en el X API SDK. Definiciones de campos, tipos y propiedades para las cargas útiles de solicitud o respuesta de la X API."
---
