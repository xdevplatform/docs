...
description: "Referencia de la interfaz `ActivitySubscriptionCreateRequest` del XDK de TypeScript: esquema de solicitud con campos, tipos e indicadores de requerido para el SDK de la X API v2."
---
