...
title: "Tweet"
sidebarTitle: "Tweet"
description: "Referencia de la interfaz TypeScript Schemas.Tweet en el X API SDK. Definiciones de campos, tipos y propiedades para las cargas útiles de solicitud o respuesta de la X API."
---
