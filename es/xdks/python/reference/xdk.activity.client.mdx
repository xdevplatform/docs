...
description: "Referencia del módulo Python activity.client en el SDK de la X API. Clase de cliente y métodos para llamar a los endpoints activity de la X API v2."
---
