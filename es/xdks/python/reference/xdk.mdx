...
title: "Client"
sidebarTitle: "Client"
description: "Referencia del paquete Python xdk de nivel superior en el SDK de la X API. Clientes, modelos y utilidades reexportados para llamar a la X API v2 desde Python."
---
...
Un SDK de Python para la X API que ofrece acceso conveniente
...
Clasificación de errores de streaming para decisiones de reintento.
