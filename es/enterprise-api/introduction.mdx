...
<CardGroup cols={3}>
  <Card title="Solicitar acceso" icon="/icons/xds/icon-rocket.svg" href="/forms/enterprise-api-interest">
...
<CardGroup cols={2}>
  ...
  <Card title="Métricas de interacción a escala" icon="/icons/xds/icon-bar-chart.svg">
  ...
  <Card title="Streams de cumplimiento" icon="/icons/xds/icon-shield-check.svg">
...
<CardGroup cols={3}>
  ...
  <Card title="Métricas de interacción" icon="/icons/xds/icon-bar-chart.svg" href="/x-api/posts/get-post-analytics">
...
<CardGroup cols={3}>
  ...
  <Card title="Usuarios" icon="/icons/xds/icon-person.svg" href="/x-api/users/lookup/introduction">
  ...
  <Card title="Tendencias" icon="/icons/xds/icon-feather-chart-line.svg" href="/x-api/trends/trends-by-woeid/introduction">
...
<CardGroup cols={2}>
  ...
  <Card title="Foro para desarrolladores" icon="/icons/xds/icon-chat-unread.svg" href="https://devcommunity.x.com">
