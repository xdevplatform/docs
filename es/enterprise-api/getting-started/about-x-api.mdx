...
description: "Descripción general de la Enterprise API de X: firehose completo, volume y likes streams, webhooks de account activity, límites personalizados y soporte."
...
<CardGroup cols={3}>
  ...
  <Card title="Usuarios" icon="/icons/xds/icon-person.svg">
  ...
  <Card title="Mensajes directos" icon="/icons/xds/icon-envelope.svg">
  ...
  <Card title="Tendencias" icon="/icons/xds/icon-feather-chart-line.svg">
...
<CardGroup cols={2}>
  <Card title="Solicitar acceso" icon="/icons/xds/icon-key.svg" href="/forms/enterprise-api-interest">
