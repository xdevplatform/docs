...
description: "Solicita acceso a la X Enterprise API, trabaja con tu equipo dedicado durante la incorporación y configura credenciales para tu volumen de datos."
...
<CardGroup cols={2}>
  ...
  <Card title="Usa scopes mínimos" icon="/icons/xds/icon-shield-check.svg">
...
<CardGroup cols={2}>
  <Card title="Realiza tu primera solicitud" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
    Llama a la API con tus nuevas credenciales.
  </Card>
  <Card title="Aprende sobre autenticación" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
