...
description: "Realiza tu primera solicitud a la Enterprise API de X: configura autenticación, elige endpoint, ejecuta cURL de ejemplo y maneja la respuesta."
