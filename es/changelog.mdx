...
<Update label="21 de mayo de 2026" description="X API">
  ### Los planes Basic heredados pasan a Pay-Per-Use

  Hoy anunciamos que los planes **Basic** heredados (mensuales y anuales) quedan obsoletos. Después del **1 de junio de 2026**, todos los suscriptores de Basic se migrarán automáticamente a [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/about-x-api) al final de su ciclo de facturación actual, sin necesidad de hacer nada. Los suscriptores mensuales reciben un cargo inicial de crédito de **\$200**; los anuales reciben el valor prorrateado restante como créditos PPU. Configuración predeterminada de PPU tras la migración: recarga automática habilitada en **\$200** (activada por debajo de **\$10**) y un tope de gasto de **\$400** por ciclo, todo ajustable en el [Developer Portal](https://developer.x.com/en/portal/dashboard). Para no migrar, actualiza tu configuración antes del **1 de junio de 2026**; ten en cuenta que optar por no migrar finaliza tu acceso a la API en la fecha de corte. Más información [aquí](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="20 de mayo de 2026" description="X API">
  ### La recarga automática ahora se aplica a los créditos gratuitos

  Hoy corregimos un problema por el cual la recarga automática no se activaba cuando los créditos gratuitos (de vales) llegaban a cero. A partir del **21 de mayo de 2026**, los créditos gratuitos se tratan igual que los de pago. Si tu saldo se agota por completo y la recarga automática está habilitada en el [Developer Console](https://console.x.com), tu cuenta se recargará automáticamente con tu método de pago guardado. Si tienes la recarga automática activada y no quieres cargos cuando se acaben los créditos gratuitos, revisa y desactívala en la configuración de la consola. Más información [aquí](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
