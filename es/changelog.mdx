...
<Update label="21 de julio de 2026" description="Plataforma para desarrolladores">
  ### Nueva página de estado en vivo en developer.x.com/status

  El estado en vivo de la X Developer Platform — incluidos la X API v2, las APIs Enterprise, la Ads API, los endpoints de streaming y los servicios de soporte — ahora está alojado en [developer.x.com/status](https://developer.x.com/status). Guarda la nueva página en favoritos para monitorear el tiempo de actividad y los incidentes en curso. Los incidentes pasados se conservan en la página de [Incidentes](/incidents).
</Update>
