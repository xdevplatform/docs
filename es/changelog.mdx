...
<Update label="1 de julio de 2026" description="Plataforma para desarrolladores">
  ...
  Hoy lanzamos el [**Developer E𝕏hibit**](https://developer.x.com/exhibit), un directorio público que muestra las apps creadas con la X API. Envía tu app desde la página **Apps** en la [Developer Console](https://console.x.com), completa una verificación rápida y tu listado se publicará para ayudar a que posibles usuarios y otros desarrolladores descubran tu proyecto. Obtén más información [aquí](https://devcommunity.x.com/t/introducing-the-developer-e-hibit-showcase-your-x-api-apps-and-get-discovered/269675).
</Update>

<Update label="30 de junio de 2026" description="Plataforma para desarrolladores">
  ### Servidor X MCP alojado

  Hoy lanzamos un [servidor X MCP](/tools/mcp) alojado en `https://api.x.com/mcp`, para que cualquier herramienta de IA compatible con MCP (Grok Build, Cursor, Claude, VS Code y otras) pueda llamar a la X API con los permisos de tu propia cuenta, sin necesidad de clonar y ejecutar un servidor local. Conéctate a través del puente de código abierto [`xurl mcp`](https://github.com/xdevplatform/xurl), que gestiona el inicio de sesión con OAuth 2.0 PKCE y actualiza los tokens automáticamente por ti.

  Las capacidades incluyen búsqueda de Posts en el archivo completo, búsqueda de usuarios y de noticias, líneas de tiempo y menciones, gestión de marcadores, tendencias y creación y publicación de Articles. Obtén más información [aquí](https://devcommunity.x.com/t/announcing-the-hosted-x-mcp/269558).
</Update>
