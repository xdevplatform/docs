...
description: "Para suscribirte a las actualizaciones, \"Activa las notificaciones\" para @API. ### Los endpoints de búsqueda migran al nuevo índice de búsqueda"
...
<Update label="21 de mayo de 2026" description="X API">
  ### Los planes Basic heredados se mueven a Pay-Per-Use

  Hoy anunciamos que los planes **Basic** heredados de la X API (mensual y anual) quedan en desuso y serán migrados automáticamente a **Pay-Per-Use (PPU)** después del **1 de junio de 2026**. Con PPU no hay tarifas mensuales fijas: solo pagas por las solicitudes a la API que realmente realizas. En la migración, los suscriptores mensuales recibirán un crédito inicial de **\$200** (cobrado mediante Stripe). Los suscriptores anuales recibirán el valor prorrateado restante de su tarifa anual como créditos PPU. Tras la migración, la recarga automática se establece de forma predeterminada en **\$200** cuando el saldo cae por debajo de **\$10**, con un tope de gasto de **\$400** por ciclo; ambos ajustables en cualquier momento desde el [Developer Portal](https://developer.x.com/en/portal/dashboard). Puedes optar por no migrar antes del 1 de junio de 2026, pero perderás el acceso a la API después de tu fecha de transición. Más información [aquí](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="20 de mayo de 2026" description="X API">
  ### La recarga automática ahora se activa con créditos gratuitos

  Corregimos un problema por el que la recarga automática no se activaba cuando el saldo de un vale de crédito (créditos gratuitos) llegaba a cero. A partir del **21 de mayo de 2026**, los créditos gratuitos se tratan igual que los créditos de pago para la recarga automática: si tu saldo se agota y la recarga automática está habilitada, tu cuenta se recargará automáticamente usando tu método de pago guardado. Si no quieres incurrir en cargos después de agotar los créditos gratuitos, revisa la configuración en [Developer Console](https://console.x.com) y desactiva la recarga automática. Más información [aquí](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>

<Update label="13 de mayo de 2026" description="X Ads API">
  ### Programa de feedback de la X Ads API

  Estamos recopilando feedback directo de desarrolladores y anunciantes para mejorar la **X Ads API**: reportes de errores, puntos débiles de los endpoints, funciones deseadas y vacíos en la documentación. Comparte tu opinión a través del [formulario de feedback](https://docs.google.com/forms/d/e/1FAIpQLSeDn5s1T0ze9-7K0XAw18MD3bEzGrIle3ko3uyjN8EP5dJhYQ/viewform) o respondiendo en el [hilo del anuncio](https://devcommunity.x.com/t/x-ads-api-share-your-feedback/265247).
</Update>
