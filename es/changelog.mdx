...
<Update label="20 de mayo de 2026" description="X Ads API">
  ### Solicitudes de acceso a la X Ads API simplificadas

  Esta semana facilitamos la solicitud de acceso a la [X Ads API](/x-ads-api/introduction). La introducción de la Ads API ahora incluye un enlace directo a nuestro formulario de solicitud de acceso, reemplazando el proceso ad hoc anterior. Envía una solicitud y nuestro equipo la revisará en un plazo de 3 días hábiles.
</Update>
