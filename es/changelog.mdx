...
<Update label="16 de julio de 2026" description="X API">
  ### Límite mensual de lecturas de Posts en Pay-Per-Use

  Aclaramos en la [página de precios](/x-api/getting-started/pricing) que los planes Pay-Per-Use están sujetos a un límite de **2 millones de lecturas de Posts por ciclo de facturación mensual**. Si necesitas un volumen mayor, tendrás que actualizar a un [plan Enterprise](/forms/enterprise-api-interest).
</Update>
