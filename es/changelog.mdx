...
<Update label="21 de mayo de 2026" description="X API">
  ...
  Hoy anunciamos que los planes **Basic** heredados de la X API (mensuales y anuales) quedan obsoletos y migrarán automáticamente a **Pay-Per-Use (PPU)** a partir del **1 de junio de 2026**. PPU elimina las tarifas mensuales fijas: solo pagas por las solicitudes que haces. Los suscriptores de Basic Monthly recibirán un cargo de crédito inicial de **\$200** en su fecha de transición; los suscriptores de Basic Annual recibirán el valor prorrateado restante como créditos PPU sin nuevos cargos a la tarjeta. Tras la migración, la recarga automática se establece de forma predeterminada en **\$200** cuando tu saldo cae por debajo de **\$10**, con un límite de gasto de **\$400** por ciclo, todo ajustable en el [Developer Portal](https://developer.x.com/en/portal/dashboard). Puedes optar por no migrar antes del 1 de junio, pero al hacerlo se cancelará el acceso a la API en tu fecha de transición. Lee el anuncio completo [aquí](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="20 de mayo de 2026" description="X API">
  ### La recarga automática ahora funciona con créditos gratuitos

  A partir del **21 de mayo de 2026**, los créditos gratuitos (de vales canjeados) se tratan igual que los créditos pagados para la recarga automática. Anteriormente, la recarga automática no se activaba cuando el saldo de un vale llegaba a cero, incluso si estaba habilitada. Con esta corrección, si la recarga automática está activada y tu saldo se agota, se cobrará automáticamente a tu método de pago guardado, de forma coherente con el funcionamiento histórico de los créditos pagados. Si no quieres que se te cobre después de agotar los créditos gratuitos, revisa y desactiva la recarga automática en tu [Developer Console](https://console.x.com). Más información [aquí](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
