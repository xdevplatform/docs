...
<Update label="21 de mayo de 2026" description="X API">
  ### Los planes Basic heredados migran a Pay-Per-Use

  Hoy anunciamos que los planes heredados **Basic**, tanto mensual como anual, dejarán de estar disponibles. A partir del **1 de junio de 2026**, todos los suscriptores de Basic se migrarán automáticamente a [Pay-Per-Use (PPU)](https://docs.x.com/x-api/getting-started/pricing) al final de su ciclo de facturación actual; no necesitas hacer nada. Los suscriptores mensuales recibirán un cargo inicial de **\$200** en créditos a través de Stripe; los suscriptores anuales recibirán el valor prorrateado restante de su cuota anual como créditos PPU. Tras la migración, la recarga automática queda habilitada por defecto en **\$200** (se activa por debajo de **\$10**) con un tope de gasto de **\$400** por ciclo de facturación, todo ajustable en el [Developer Portal](https://developer.x.com/en/portal/dashboard). Quienes no deseen migrar pueden optar por no participar antes del 1 de junio de 2026; al hacerlo, el acceso a la API finaliza en la fecha de transición. Más información [aquí](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="20 de mayo de 2026" description="X API">
  ### La recarga automática ahora se activa al agotarse los créditos gratuitos

  Hoy corregimos un problema por el que la recarga automática no se activaba una vez que un cupón de créditos canjeado (créditos gratuitos) llegaba a cero. A partir del **21 de mayo de 2026**, los créditos gratuitos se tratan igual que los créditos pagos en lo que respecta a la recarga automática: si tu saldo se agota y la recarga automática está habilitada, se realizará un cargo automático en tu método de pago guardado. Si no deseas incurrir en cargos después de agotar los créditos gratuitos, revisa y desactiva la recarga automática en la [Developer Console](https://console.x.com). Más información [aquí](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
