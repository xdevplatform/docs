...
description: Notas de la versión e historial de versiones de la X API v2, las APIs Enterprise, la Ads API, los SDK, el streaming, los webhooks y la plataforma para desarrolladores.
