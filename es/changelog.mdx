...
<Update label="18 de junio de 2026" description="X API v2">
  ### Corrección de precios de los endpoints de Community Notes

  Corregimos los precios indicados para los [endpoints de Community Notes](/x-api/community-notes/introduction). Las lecturas de notas se facturan a **0,005 USD por recurso** bajo la tarifa estándar **Note: Read** en la [página de precios](/x-api/getting-started/pricing).
</Update>
