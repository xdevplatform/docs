...
<Update label="21 de mayo de 2026" description="X API">
  ### Los planes Basic heredados pasan a Pago por uso

  Hoy anunciamos que los planes **Basic** heredados (mensuales y anuales) se discontinúan. A partir del **1 de junio de 2026**, las suscripciones Basic se migrarán automáticamente al plan [Pago por uso (PPU)](https://docs.x.com/x-api/getting-started/about-x-api) en su próxima fecha de corte — no se requiere ninguna acción.

  - **Basic mensual**: se cargará un crédito inicial de **$200** en el corte, que se descontará a medida que realices solicitudes.
  - **Basic anual**: el valor prorrateado restante se otorgará como créditos PPU, que vencen tras la cantidad equivalente de meses prorrateados (sin cargo adicional a la tarjeta).
  - **Configuración predeterminada de PPU**: recarga automática habilitada con **$200** cuando el saldo baje de **$10**, y un tope de gasto de **$400** por ciclo. Ajústalo en cualquier momento en el [Developer Portal](https://developer.x.com/en/portal/dashboard).

  Para no participar, actualiza la configuración en el Developer Portal antes del 1 de junio de 2026. No participar implica perder el acceso a la API en tu fecha de corte y es definitivo. Más información [aquí](https://devcommunity.x.com/t/important-update-legacy-x-api-basic-plans-are-moving-to-pay-per-use-ppu/266305).
</Update>

<Update label="20 de mayo de 2026" description="X API">
  ### Corrección: la recarga automática ahora se activa con créditos gratuitos

  Hoy corregimos un problema por el cual la recarga automática no se activaba cuando un saldo financiado por un cupón (créditos gratuitos) llegaba a cero. A partir del **21 de mayo de 2026**, los créditos gratuitos y los de pago se tratan de igual modo para la recarga automática: si tu saldo se agota y la recarga automática está habilitada, tu cuenta se recargará automáticamente con tu método de pago guardado.

  Si no quieres incurrir en cargos cuando se acaben los créditos gratuitos, revisa y desactiva la recarga automática en el [Developer Console](https://console.x.com). Más información [aquí](https://devcommunity.x.com/t/update-to-auto-recharge-behavior-for-free-credits/266184).
</Update>
