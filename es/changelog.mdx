...
<Update label="24 de julio de 2026" description="X API v2">
  ### Referencia de payloads de eventos para la X Activity API

  Hoy publicamos una nueva referencia de [payloads de eventos](/es/x-api/activity/event-payloads) para la [X Activity API](/es/x-api/activity/introduction) con JSON de ejemplo para todos los tipos de eventos admitidos: Posts, Me gusta, seguimientos, actualizaciones de perfil, chat, DMs, silencios, bloqueos, Spaces, noticias y revocaciones de OAuth.

  Úsala para modelar tus manejadores de webhooks y la deserialización de JSON con payloads reales capturados en vivo antes de configurar una suscripción.
</Update>
