...
description: "Diagnostica problemas de cifrado en X Chat: errores del Chat XDK, recuperación de copia de seguridad de claves, fallos de descifrado y payloads firmados."
