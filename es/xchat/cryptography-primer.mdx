---
title: "Cómo X Chat mantiene seguros tus mensajes"
sidebarTitle: Manual básico de criptografía
description: "Una guía en lenguaje sencillo sobre cómo X Chat protege los mensajes: claves, cifrado, firmas digitales y copias de seguridad, sin necesidad de saber criptografía."
keywords: ["criptografía de X Chat", "introducción al cifrado", "cifrado de clave pública", "ECDH", "ECIES", "firmas digitales", "claves de conversación", "copia de seguridad segura de claves"]
---

X Chat está cifrado: los mensajes de un usuario, en texto plano, solo existen en sus dispositivos. Esta página explica cómo funciona.
...
| **Espías en la red** | Seguridad de transporte más contenido cifrado | TLS estándar, más todo lo anterior |
...
|:-----------|:-------------------|
| **Un dispositivo comprometido** | Un cliente desbloqueado contiene texto plano y claves en bruto. Ningún diseño de cifrado sobrevive a un endpoint comprometido. |
...
<CardGroup cols={2}>
  <Card title="Primeros pasos" icon="/icons/xds/icon-rocket.svg" href="/xchat/getting-started">
    Implementa claves, envía y recibe paso a paso
  </Card>
  <Card title="Referencia del Chat XDK" icon="/icons/xds/icon-code.svg" href="/xchat/xchat-xdk">
    Métodos y tipos del SDK de cifrado
  </Card>
  <Card title="Introducción" icon="/icons/xds/icon-book.svg" href="/xchat/introduction">
