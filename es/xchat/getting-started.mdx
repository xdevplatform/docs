...
description: Tutorial paso a paso para crear mensajería X Chat cifrada de extremo a extremo usando el Chat XDK en Python, TypeScript, Go, Rust, C# o Java.
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    El motor WASM compilado se distribuye dentro de `@xdevplatform/chat-xdk`—sin paso de build. Requiere Node.js 18+.
  </Tab>
  <Tab title="Rust">
    ```toml
    [dependencies]
