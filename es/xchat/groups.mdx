...
sidebarTitle: Grupos
description: Crea conversaciones de grupo de X Chat con varios participantes, claves de conversación compartidas, títulos cifrados, gestión de miembros y mensajes firmados.
