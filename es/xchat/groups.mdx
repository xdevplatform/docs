---
title: "Crea conversaciones de grupo cifradas en X Chat"
sidebarTitle: Grupos
description: "Crea conversaciones de grupo en X Chat: forma un grupo, añade o elimina miembros y asigna nombre y avatar cifrados, con la misma seguridad que los chats 1:1."
keywords: ["grupos de X Chat", "chat de grupo", "DM de grupo", "claves de conversación", "cifrado del nombre del grupo", "añadir miembros"]
---
