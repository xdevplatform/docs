---
title: "Recibe mensajes de X Chat al instante"
sidebarTitle: Eventos en tiempo real
description: "Escucha nuevos mensajes y eventos de X Chat en tiempo real mediante webhooks o un stream, y descífralos con el Chat XDK."
keywords: ["eventos de X Chat", "webhooks", "activity stream", "mensajes en tiempo real", "chat.received", "chat.sent"]
---
