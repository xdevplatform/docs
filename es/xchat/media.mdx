---
title: "Envía imágenes y archivos en X Chat"
sidebarTitle: Multimedia
description: "Comparte imágenes y archivos adjuntos en tus chats cifrados: cifra, sube, envía, descarga y descifra multimedia con el Chat XDK."
keywords: ["multimedia de X Chat", "imágenes cifradas", "archivos adjuntos", "encrypt_stream", "subida de medios", "descarga de medios"]
---
...
Esta ruta **no** es el modelo de multimedia de Posts (`expansions=attachments.media_keys`, `media.fields=variants`, etc.). Esos parámetros aplican a **Posts**; los blobs cifrados de X Chat se direccionan por **`media_hash_key`** y la descarga de multimedia de X Chat.
