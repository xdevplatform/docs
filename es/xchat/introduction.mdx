...
description: Mensajería directa cifrada de extremo a extremo en X para desarrolladores
...
|:------|:----------------|
| **[Chat XDK](/xchat/xchat-xdk)** | Generar claves, cifrar/descifrar, firmar/verificar y, opcionalmente, almacenamiento con PIN mediante Juicebox (Python, JS, Rust, Go, C#, Java) |
...
1. Crea pares de claves de **identidad** y **firma**; guarda las claves privadas de forma segura (Juicebox o un blob protegido).
2. **Publica las claves públicas** para que otros puedan envolver claves de conversación dirigidas a ti y verificar firmas.
...
- Conversaciones y mensajes — listar/obtener hilos, agregar/rotar claves, eventos, enviar, escribiendo, leído, membresía de grupo
