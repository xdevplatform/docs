---
title: "Envía mensajes directos cifrados con la Chat API de X"
sidebarTitle: Introducción
description: "Descubre qué ofrece la Chat API de X: envía y recibe mensajes directos cifrados y firmados, con el Chat XDK encargándose de la parte difícil."
keywords: ["X Chat API", "Chat API", "DM cifrados", "mensajes directos cifrados", "Chat XDK"]
---

La **Chat API** te permite enviar y recibir mensajes directos **cifrados** en X. Los cuerpos de los mensajes se cifran en el cliente; X enruta el texto cifrado y no puede leer el contenido en texto plano. Los mensajes también se **firman** para que los destinatarios puedan verificar al remitente.
