---
title: "Chat XDK: el kit de cifrado de X Chat"
sidebarTitle: Chat XDK
description: "Conoce el Chat XDK, la biblioteca que gestiona claves, cifrado, descifrado y firma por ti, con referencias para todos los lenguajes compatibles."
keywords: ["Chat XDK", "chat-xdk", "SDK de cifrado", "gestión de claves", "firma", "referencia del SDK"]
---
...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    El motor WASM compilado se distribuye dentro del paquete; no hay paso de build. Requiere Node.js 18+.
  </Tab>
  <Tab title="Rust">
    ```toml
    [dependencies]
...
<CardGroup cols={2}>
  <Card title="Primeros pasos" icon="/icons/xds/icon-rocket.svg" href="/es/xchat/getting-started">
    Conecta el Chat XDK con la Chat API
  </Card>
  <Card title="Multimedia" icon="/icons/xds/icon-photo.svg" href="/es/xchat/media">
