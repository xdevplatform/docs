...
description: "Canales de soporte para la X API: foro de la comunidad de desarrolladores, Stack Overflow, issues de GitHub, página de estado y opciones de contacto."
icon: life-ring
...
<CardGroup cols={2}>
  <Card title="Foros para desarrolladores" icon="/icons/xds/icon-chat-unread.svg" href="https://devcommunity.x.com">
...
<CardGroup cols={2}>
  <Card title="Interés en Enterprise API" icon="/icons/xds/icon-bank.svg" href="/forms/enterprise-api-interest">
  ...
  <Card title="Soporte de políticas" icon="/icons/xds/icon-shield-check.svg" href="https://help.x.com/forms/platform">
...
<CardGroup cols={2}>
  <Card title="Primeros pasos" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
  ...
  <Card title="Guía de autenticación" icon="/icons/xds/icon-key.svg" href="/fundamentals/authentication/overview">
  ...
  <Card title="Códigos de error" icon="/icons/xds/icon-info-circle.svg" href="/x-api/fundamentals/response-codes-and-errors">
...
<CardGroup cols={2}>
  ...
  <Card title="Política para desarrolladores" icon="/icons/xds/icon-shield-check.svg" href="/developer-terms/policy">
    Reglas y expectativas para construir en X.
  </Card>
  <Card title="Casos de uso restringidos" icon="/icons/xds/icon-block.svg" href="/developer-terms/restricted-use-cases">
...
<AccordionGroup>
  ...
  <Accordion title="Mi app fue suspendida" icon="/icons/xds/icon-block.svg">
  ...
  <Accordion title="No encuentro el endpoint que necesito" icon="/icons/xds/icon-search.svg">
