...
description: "Implementa Iniciar sesión con X en sitios web y apps móviles usando el flujo de request token de OAuth 1.0a para autenticar usuarios y obtener access tokens."
