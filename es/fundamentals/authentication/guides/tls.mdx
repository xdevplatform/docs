...
description: "Conéctate con seguridad a la X API por TLS 1.2, con orientación sobre almacenes raíz de confianza, revocación de certificados y verificación de HTTPS."
sidebarTitle: TLS
