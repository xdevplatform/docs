...
description: "Construye un encabezado Authorization de OAuth 1.0a para firmar solicitudes a la X API, incluyendo los campos consumer key, nonce, signature, timestamp, token y version."
