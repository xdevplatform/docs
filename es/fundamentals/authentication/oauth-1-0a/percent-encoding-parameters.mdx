...
description: "Aplica la codificación por porcentaje según RFC 3986 a los parámetros de OAuth 1.0a para las solicitudes a la X API, con reglas para caracteres reservados y ejemplos de codificación de URL."
