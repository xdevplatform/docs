---
title: OAuth Echo
description: "Usa OAuth Echo para delegar de forma segura la autenticación de X a un proveedor de medios de terceros para las cargas, utilizando los encabezados x-auth-service-provider y verify-credentials."
