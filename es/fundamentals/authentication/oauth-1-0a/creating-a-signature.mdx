...
description: "Genera una firma HMAC-SHA1 de OAuth 1.0a para las solicitudes a la X API recopilando parámetros, construyendo la signature base string y firmando con tus claves."
