...
description: "Usa el flujo OAuth basado en PIN para X apps que no incrustan un navegador, como CLIs y consolas de juegos, con un PIN numérico como oauth_verifier."
