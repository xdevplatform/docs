...
description: "Guía paso a paso para conectar usuarios a la X API v2 con OAuth 2.0 Authorization Code Flow con PKCE, incluyendo URLs de autorización e intercambio de tokens."
