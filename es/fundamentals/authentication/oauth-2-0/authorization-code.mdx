...
description: "Referencia del OAuth 2.0 Authorization Code Flow con PKCE de X: scopes, refresh tokens, clientes confidenciales y tiempos de vida de los access tokens."
