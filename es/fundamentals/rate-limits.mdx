...
icon: gauge-high
description: Comprende los límites de tasa de la X API por niveles de acceso y endpoints, incluidos los límites a nivel de app vs. de usuario, los encabezados de respuesta y las mejores prácticas para reintentos.
