...
sidebarTitle: Apps
icon: cube
description: Crea y configura apps de desarrollador de X para obtener credenciales de la API, establecer permisos de OAuth 1.0a y OAuth 2.0, administrar URLs de callback y rotar claves.
