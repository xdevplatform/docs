...
icon: text-size
description: "Cómo cuenta X los caracteres en Posts: límite de 280, puntos de código ponderados, acortamiento de URLs, manejo de emojis y Unicode, y casos especiales."
