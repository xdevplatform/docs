...
description: skill.md es un resumen estructurado de capacidades que describe lo que los agentes de IA pueden hacer con la X API, usado por herramientas como agentskills.io para habilitar flujos de trabajo.
