...
title: Python XDK
sidebarTitle: Python
description: "Instala y usa la biblioteca cliente oficial Python XDK para la X API v2: configuración de autenticación, solicitudes paginadas y ejemplos de streaming."
...
<CardGroup cols={2}>
  ...
  <Card title="Guía rápida" icon="/icons/xds/icon-rocket.svg" href="/xdks/python/quickstart">
    Recorrido paso a paso de tu primera solicitud.
  </Card>
  <Card title="Autenticación" icon="/icons/xds/icon-key.svg" href="/xdks/python/authentication">
  ...
  <Card title="Referencia de la API" icon="/icons/xds/icon-book.svg" href="/xdks/python/reference/modules">
