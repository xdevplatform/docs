...
description: Usa llms.txt y llms-full.txt para dar a herramientas de IA como Cursor, Windsurf y Grok acceso estructurado a la documentación de la X API para una generación de código precisa.
