...
<CardGroup cols={2}>
  ...
  <Card title="Autenticación" icon="/icons/xds/icon-key.svg" href="/xdks/typescript/authentication">
  ...
  <Card title="Referencia de la API" icon="/icons/xds/icon-book.svg" href="/xdks/typescript/reference/modules">
