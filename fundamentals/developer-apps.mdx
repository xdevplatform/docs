...
sidebarTitle: Apps
icon: cube
description: Create and configure X developer apps to get API credentials, set OAuth 1.0a and OAuth 2.0 permissions, manage callback URLs, and rotate keys.
...
<CardGroup cols={2}>
  ...
  <Card title="Minimal permissions" icon="/icons/xds/icon-shield-check.svg">
