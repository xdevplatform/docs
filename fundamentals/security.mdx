...
icon: shield-halved
description: Security best practices for X API developers, including credential storage, OAuth handling, key rotation, secure callbacks, and vulnerability disclosure.
...
<CardGroup cols={2}>
  ...
  <Card title="Credential security" icon="/icons/xds/icon-key.svg">
...
<CardGroup cols={2}>
  <Card title="Security audits" icon="/icons/xds/icon-search.svg">
  ...
  <Card title="Monitoring" icon="/icons/xds/icon-bar-chart.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Your app incident" icon="/icons/xds/icon-warning.svg" href="https://hackerone.com/twitter">
...
<CardGroup cols={2}>
  <Card title="Authentication guide" icon="/icons/xds/icon-key.svg" href="/resources/fundamentals/authentication/overview">
    Implement OAuth correctly.
  </Card>
  <Card title="App permissions" icon="/icons/xds/icon-shield-check.svg" href="/resources/fundamentals/developer-apps#app-permissions">
