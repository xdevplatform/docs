...
sidebarTitle: X IDs
icon: fingerprint
description: Understand 64-bit Snowflake IDs in the X API for Posts and users, including format, ordering, ID inflation, and safe handling in JavaScript clients.
