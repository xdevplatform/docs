...
icon: gauge-high
description: Understand X API rate limits across access tiers and endpoints, including app-level vs user-level limits, response headers, and best practices for retries.
...
<CardGroup cols={2}>
  ...
  <Card title="Use exponential backoff" icon="/icons/xds/icon-history.svg">
