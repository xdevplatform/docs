...
description: Your API keys and tokens should be guarded very carefully. These credentials are directly tied to your [developer App](/resources/fundamentals/developer...
---
