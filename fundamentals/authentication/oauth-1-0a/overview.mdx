---
title: OAuth 1.0a
description: "Overview of OAuth 1.0a user context authentication on X, covering API keys, access tokens, request signing, and tools for making authorized API calls."
...
<Tip>
Already have users who authorized your app with OAuth 1.0a? You can convert their stored access tokens to OAuth 2.0 tokens without asking them to re-authorize. See [Migrating OAuth 1.0a user tokens to OAuth 2.0](/fundamentals/authentication/oauth-2-0/oauth-1-0a-token-exchange).
</Tip>
