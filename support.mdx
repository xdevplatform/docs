...
description: Find support channels for the X API, including the developer community forum, Stack Overflow, GitHub issues, status page, and contact options.
icon: life-ring
...
<CardGroup cols={2}>
  <Card title="Enterprise API Interest" icon="/icons/xds/icon-bank.svg" href="/forms/enterprise-api-interest">
  ...
  <Card title="Policy Support" icon="/icons/xds/icon-shield-check.svg" href="https://help.x.com/forms/platform">
...
<CardGroup cols={2}>
  <Card title="Getting Started" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/make-your-first-request">
    New to the X API? Start here to get your API keys and make your first request.
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/introduction">
    Complete reference for all X API v2 endpoints, parameters, and response formats.
  </Card>
  <Card title="Authentication Guide" icon="/icons/xds/icon-key.svg" href="/fundamentals/authentication/overview">
  ...
  <Card title="Error Codes" icon="/icons/xds/icon-info-circle.svg" href="/x-api/fundamentals/response-codes-and-errors">
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Policy" icon="/icons/xds/icon-shield-check.svg" href="/developer-terms/policy">
    Rules and expectations for building on X.
  </Card>
  <Card title="Restricted Use Cases" icon="/icons/xds/icon-block.svg" href="/developer-terms/restricted-use-cases">
...
<AccordionGroup>
  ...
  <Accordion title="My app was suspended" icon="/icons/xds/icon-block.svg">
  ...
  <Accordion title="I can't find the endpoint I need" icon="/icons/xds/icon-search.svg">
