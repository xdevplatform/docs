...
description: This guide walks you through creating a batch compliance job to check the compliance status of Posts or users. Before you begin. Standard X API v2 tier.
