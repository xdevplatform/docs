...
description: "Use the X API v2 Batch Compliance endpoints to upload Post ID or user ID datasets and retrieve current compliance status for deletions, suspensions, and edits."
...
<CardGroup cols={2}>
  <Card title="Post compliance" icon="/icons/xds/icon-chat.svg">
    Check status of Posts in bulk
  </Card>
  <Card title="User compliance" icon="/icons/xds/icon-person.svg">
