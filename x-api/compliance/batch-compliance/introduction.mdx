...
description: "The Batch Compliance endpoints let you upload datasets of Post IDs or user IDs and. Reference for the X API v2 standard tier covering batch compliance."
