---
title: Compliance event streams on the X API v2
...
description: "Use X API v2 compliance event streams to keep stored X data in sync with Post deletes, edits, and account changes for users in near real time."
---
