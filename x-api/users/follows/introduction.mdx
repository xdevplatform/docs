...
description: "The Follows endpoints let you follow and unfollow users, and retrieve follower and following. Reference for the X API v2 standard tier covering follows."
...
<CardGroup cols={2}>
  ...
  <Card title="Followers" icon="/icons/xds/icon-people.svg">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/users/follows/quickstart">
