...
description: "This guide walks you through retrieving followers and following lists, and managing follows. Reference for the X API v2 standard tier covering follows."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-followers">
