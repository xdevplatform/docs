---
title: Follows endpoints migration overview
description: Migrate followers, following, and follow management from Standard v1.1 friendships endpoints to the X API v2 follows endpoints with mapped parameters.
