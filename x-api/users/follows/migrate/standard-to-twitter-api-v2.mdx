...
description: "If you have been working with the standard v1.1 POST friendships/create and POST. Reference for the X API v2 standard tier covering migrate."
