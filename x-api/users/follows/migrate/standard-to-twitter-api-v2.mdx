...
description: If you have been working with the standard v1.1 POST friendships/create and POST friendships/destroy endpoints, the goal of this. Standard X API v2 tier.
---
