...
description: "This guide covers the key concepts you need to integrate the User lookup endpoints into your. Reference for the X API v2 standard tier covering lookup."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Request only needed fields" icon="/icons/xds/icon-filter.svg">
  ...
  <Card title="Handle errors gracefully" icon="/icons/xds/icon-warning.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Error handling" icon="/icons/xds/icon-warning.svg" href="/x-api/fundamentals/response-codes-and-errors">
