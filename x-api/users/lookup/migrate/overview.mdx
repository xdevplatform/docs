---
title: User lookup endpoints migration overview
description: Map Standard v1.1 users/show, users/lookup, and account/verify_credentials to X API v2 user lookup endpoints for a smooth migration.
