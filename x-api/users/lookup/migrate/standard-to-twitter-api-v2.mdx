...
description: If you have been working with the standard v1.1 GET users/show and GET users/lookup, the goal of this guide is to help you understand. Standard X API v2 tier.
---
