...
description: "This guide walks you through retrieving the currently authenticated user's profile using the. Reference for the X API v2 standard tier covering quickstart."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-my-user">
