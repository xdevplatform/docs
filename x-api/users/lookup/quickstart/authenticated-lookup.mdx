...
description: "This guide walks you through retrieving the currently authenticated user's profile using the /me endpoint. Before you begin, you'll. Standard X API v2 tier."
