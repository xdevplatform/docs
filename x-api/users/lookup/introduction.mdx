...
description: The User lookup endpoints let you retrieve profile information for one or more users. Look up users by their ID, username. Standard X API v2 tier.
