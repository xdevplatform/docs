...
description: "This guide walks you through retrieving your block list, as well as blocking and unblocking users. Reference for the X API v2 standard tier covering blocks."
