...
Blocks lookup can return a lot of data. To ensure we don’t return to many results at any given time, we use pagination. Learn more about how to [paginate through results.](https://developer.x.com/en/docs/x-api/users/blocks/content/developer-twitter/en/docs/twitter-api/pagination)