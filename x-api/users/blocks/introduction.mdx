...
description: "The Blocks endpoints let you retrieve the list of users blocked by the authenticated user, as well. Reference for the X API v2 standard tier covering blocks."
...
<CardGroup cols={2}>
  <Card title="Blocked users" icon="/icons/xds/icon-bulleted-list.svg">
    Get your blocked user list
  </Card>
  <Card title="Block" icon="/icons/xds/icon-block.svg">
    Block a user
  </Card>
  <Card title="Unblock" icon="/icons/xds/icon-checkmark-circle.svg">
    Unblock a user
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/users/blocks/quickstart">
    Get started with blocks
  </Card>
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/users/blocks/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-blocking">
