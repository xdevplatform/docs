...
description: "The block and unblock users endpoints are only available under the Enterprise plan. Reference for the X API v2 standard tier covering blocks."
---
...
In addition to the changes in how you request certain fields, X API v2 is also introducing new JSON designs for the objects returned by the APIs, including [P](/x-api/fundamentals/data-dictionary/reference#tweet)ost and [user](/x-api/fundamentals/data-dictionary/reference#user) objects.
