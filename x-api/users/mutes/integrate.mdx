...
description: "This guide covers the key concepts you need to integrate the mutes endpoints into your application. Reference for the X API v2 standard tier covering mutes."
---
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/users/mutes/quickstart/manage-mutes-quickstart">
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-muting">
