...
description: This guide covers the key concepts you need to integrate the mutes endpoints into your application. Mutes endpoints require user. Standard X API v2 tier.
---
