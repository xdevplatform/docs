...
description: "The Mutes endpoints let you mute and unmute users, and retrieve the list of users muted by the. Reference for the X API v2 standard tier covering mutes."
