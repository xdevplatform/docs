...
<Button href="https://developer.x.com/en/docs/twitter-api/users/mutes/quick-start.html">
  Quick start
</Button>
...
<Button href="https://developer.twitter.com/apitools/api?endpoint=/2/users/%7Bid%7D/muting&method=get">
