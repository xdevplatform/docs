...
description: "Use the X API v2 Mutes endpoints to mute and unmute accounts on behalf of the authenticated user and retrieve the full list of users they have muted on X."
...
<CardGroup cols={2}>
  ...
  <Card title="Muted users" icon="/icons/xds/icon-bulleted-list.svg">
...
<CardGroup cols={2}>
  <Card title="Mutes lookup quickstart" icon="/icons/xds/icon-bulleted-list.svg" href="/x-api/users/mutes/quickstart/mutes-lookup">
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/users/mutes/integrate">
