---
title: Mutes endpoints migration overview
description: Migrate mutes lookup and manage mutes integrations from Standard v1.1 to X API v2 with mapped endpoints, parameters, and rate limits.
