---
title: "X API v2 data dictionary: Post, User, Space fields"
sidebarTitle: Overview
description: "Field-level reference for X API v2 JSON objects, including Post (Tweet), User, Space, Media, Poll, and Place, plus expansions and metrics."
