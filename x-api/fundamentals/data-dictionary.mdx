...
description: "The X API returns rich structured JSON. This dictionary documents every available field for each object type. - Post (Tweet) fields - User fields - Space."
