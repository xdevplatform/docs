...
<script>
  (function(){try{var h=location.hash;if(h&&/^#(get|post|put|delete|patch|batch|post-tweet|user|space|list|media|poll|place|community|direct-message)/i.test(h))location.replace("/x-api/fundamentals/data-dictionary/reference"+h)}catch(e){}})();
</script>
