---
title: Edit Posts
description: "Edit Posts on X within a 30-minute window up to five times and read the edit history, edit_controls, and editable metadata returned by the v2 API."
