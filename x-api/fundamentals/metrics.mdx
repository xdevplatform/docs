...
description: The X API provides engagement metrics for posts and media. Access public metrics with any authentication. Part of the X API v2 reference documentation.
