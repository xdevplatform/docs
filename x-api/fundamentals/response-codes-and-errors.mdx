...
description: "Reference of HTTP status codes, error response formats, and common 400, 401, 403, 404, 429, and 500 errors returned by the X API for debugging."
...
<CardGroup cols={2}>
  ...
  <Card title="Handle partial errors" icon="/icons/xds/icon-warning.svg">
