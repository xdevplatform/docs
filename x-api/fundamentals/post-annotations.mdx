...
description: Annotations provide semantic metadata about post content. X analyzes posts to identify entities (people, places, products) and context (topics, domains).
