...
description: "Use X API v2 entity and context annotations to identify people, places, products, organizations, and topic domains semantically inside Post text."
