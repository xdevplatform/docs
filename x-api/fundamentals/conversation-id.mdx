...
description: Every reply on X belongs to a conversation thread. The conversation_id field lets you identify, track, and reconstruct entire conversation trees.
