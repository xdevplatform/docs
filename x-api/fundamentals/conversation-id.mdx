...
description: "Every reply on X belongs to a conversation thread. The conversationid field lets you identify, track, and reconstruct entire conversation trees."
