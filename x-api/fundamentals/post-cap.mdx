...
description: "X API v2 uses pay-per-usage pricing. You're charged based on actual API consumption, tracked at the app level. Pay-per-usage plans are subject to a monthly."
keywords: ["usage", "billing", "pay-per-usage", "API usage", "usage tracking", "post consumption", "API costs", "post cap", "cap", "monthly cap", "monthly post cap", "de-dupe", "dedupe", "deduplication"]
---
...
<CardGroup cols={2}>
  ...
  <Card title="Monitor alerts" icon="/icons/xds/icon-bell.svg">
  ...
  <Card title="Optimize queries" icon="/icons/xds/icon-filter.svg">
...
<CardGroup cols={1}>
  <Card title="Contact Enterprise Sales" icon="/icons/xds/icon-bank.svg" href="/enterprise/forms/enterprise-api-interest">
