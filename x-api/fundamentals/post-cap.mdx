...
description: "X API v2 uses pay-per-usage pricing. You're charged based on actual API consumption, tracked at the app level. Part of the X API v2 reference documentation."
