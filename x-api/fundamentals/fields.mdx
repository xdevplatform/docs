...
title: Fields
sidebarTitle: Fields
description: The X API v2 returns minimal data by default. Use fields parameters to request additional data for each object type. By default, a post lookup returns.
