...
description: "Per-endpoint X API v2 rate limits for posts, users, search, streams, and DMs, plus how to read the x-rate-limit response headers and handle 429s."
...
<CardGroup cols={2}>
  ...
  <Card title="Getting started" icon="/icons/xds/icon-rocket.svg" href="/x-api/getting-started/about-x-api">
