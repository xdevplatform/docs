...
description: When an API response contains more results than can be returned at once, use pagination to retrieve all pages of data. 1. Reference for the X API v2.
