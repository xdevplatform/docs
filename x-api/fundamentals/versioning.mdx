---
title: Versioning
description: "How X API versioning works, the difference between v1.1, v2, and enterprise, and which changes are considered breaking versus additive updates."
...
<CardGroup cols={2}>
  ...
  <Card title="Monitor announcements" icon="/icons/xds/icon-bell.svg">
