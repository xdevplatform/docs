...
description: "Learn the consistent URL, response, and ID patterns used across all X API v2 endpoints so the same conventions apply everywhere you integrate."
...
<CardGroup cols={2}>
  ...
  <Card title="Simpler code" icon="/icons/xds/icon-code.svg">
