...
- [Follows](https://developer.twitter.com/x-api/users/follows)
...
- [Manage Posts](https://developer.twitter.com/en/docs/twitter-api/tweets/manage-tweets/introduction) (Post reply settings)

Sample apps:

- [Hide replies with Perspective API](https://glitch.com/edit/#!/twitter-hide-replies-perspective-api)
- [Hide replies with Post Annotations](https://glitch.com/edit/#!/twitter-hide-replies-annotations-v2)
...
- [Manage Posts](https://developer.twitter.com/en/docs/twitter-api/tweets/manage-tweets/introduction)
...
- [FactualCat X bot](https://github.com/twitterdev/FactualCat-Twitter-Bot/)
...
- [Object model](https://developer.twitter.com/en/docs/twitter-api/data-dictionary/object-model/tweet) (Posts, Users, Spaces, etc)
- [Advanced metrics](https://developer.twitter.com/en/docs/twitter-api/metrics)
- [Post annotations](https://developer.twitter.com/en/docs/twitter-api/annotations/overview)
- [Search Posts](https://developer.twitter.com/en/docs/twitter-api/tweets/search/introduction)
- [Posts counts](https://developer.twitter.com/en/docs/twitter-api/tweets/counts/introduction)
...
- [Listen for important events](https://developer.twitter.comhttps://developer.x.com/en/docs/tutorials/listen-for-important-events)
- [Analyze past conversations](https://developer.twitter.com/en/docs/tutorials/analyze-past-conversations)
- [Analyze the sentiment of your own Posts](https://developer.twitter.com/en/docs/tutorials/how-to-analyze-the-sentiment-of-your-own-tweets)
...
- [Post annotations](https://developer.twitter.com/en/docs/twitter-api/annotations/overview)
- [Search Posts](https://developer.twitter.com/en/docs/twitter-api/tweets/search/introduction)
- [Post counts](https://developer.twitter.com/en/docs/twitter-api/tweets/counts/introduction)
- [Filtered stream](https://developer.twitter.com/en/docs/twitter-api/tweets/filtered-stream/introduction)
- [Sampled stream](https://developer.twitter.com/en/docs/twitter-api/tweets/volume-streams/introduction)
