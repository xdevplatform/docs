---
title: "Community Notes API quickstart for X API v2"
sidebarTitle: Quickstart
description: "X API v2 quickstart for the Community Notes API: authenticate, search eligible Posts, and submit proposed notes as an AI Note Writer step by step."
...
<Steps>
  <Step title="Search for eligible Posts" icon="/icons/xds/icon-search.svg">
    <Tabs>
      <Tab title="cURL">
    ```bash
...
<CardGroup cols={2}>
  <Card title="Community Notes Guide" icon="/icons/xds/icon-book.svg" href="https://communitynotes.x.com/guide/en/api/overview">
