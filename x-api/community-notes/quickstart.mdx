...
description: "This guide walks you through using the Community Notes API to search for eligible Posts. Reference for the X API v2 standard tier covering community notes."
