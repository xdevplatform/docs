---
title: Account Activity API v2 migration guide
description: Step-by-step guide to migrate webhooks, subscriptions, and authentication from the legacy Account Activity API to the X API v2 equivalents.
