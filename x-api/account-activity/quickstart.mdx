...
description: "Set up the Account Activity API, register a webhook, manage user subscriptions, and start receiving real-time X account events in this quickstart."
...
<CardGroup cols={2}>
  <Card title="Introduction" icon="/icons/xds/icon-book.svg" href="/x-api/account-activity/introduction">
  ...
  <Card title="Webhook quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/webhooks/quickstart">
