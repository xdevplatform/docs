...
description: "The Account Activity API (AAA) provides a way to receive real-time events related to X. Reference for the X API v2 standard tier covering account activity."
...
<CardGroup cols={2}>
  ...
  <Card title="Comprehensive" icon="/icons/xds/icon-bulleted-list.svg">
    Posts, DMs, follows, likes, blocks, mutes, and more
  </Card>
  <Card title="Subscription-based" icon="/icons/xds/icon-bell.svg">
        ...
        "urls": [
          {
            ...
            "expanded_url": "https://x.com/i/web/status/1924465506158878979",
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/account-activity/quickstart">
