...
If you click the "Send" button after step three, you will receive the default [Post object](https://developer-staging.twitter.com/content/developer-twitter/en/docs/twitter-api/object-reference/tweet) fields in your response: idand text.
