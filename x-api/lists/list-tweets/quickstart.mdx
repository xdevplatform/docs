...
description: "This guide walks you through retrieving Posts from a List timeline. Reference for the X API v2 standard tier covering list tweets."
...
<Steps>
  <Step title="Find a List ID" icon="/icons/xds/icon-bulleted-list.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/lists/list-tweets/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/lists/get-list-posts">
