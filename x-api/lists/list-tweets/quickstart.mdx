...
description: "This guide walks you through retrieving Posts from a List timeline. Before you begin, you'll need: - A developer account with an. Standard X API v2 tier."
