---
title: List Posts endpoint migration overview
description: Compare Standard v1.1 lists/statuses with the X API v2 List Posts endpoint, including parameters, authentication, and pagination differences.
