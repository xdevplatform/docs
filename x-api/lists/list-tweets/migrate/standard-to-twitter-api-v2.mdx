...
description: "If you have been working with the standard v1.1 GET lists/statuses endpoint, the goal of this. Reference for the X API v2 standard tier covering migrate."
