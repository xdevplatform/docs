...
description: "This guide walks you through adding and removing members from a List. Reference for the X API v2 standard tier covering quickstart."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/lists/add-list-member">
