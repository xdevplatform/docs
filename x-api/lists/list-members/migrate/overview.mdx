---
title: List members migration overview
description: Compare Standard v1.1 List members endpoints with X API v2 List members lookup and manage List members endpoints for migration planning.
