---
title: "Manage List members: v1.1 to X API v2"
description: Migrate add, remove, and manage List member operations from Standard v1.1 lists/members endpoints to the X API v2 manage List members endpoints.
