...
description: "The List lookup endpoints let you retrieve information about Lists. Reference for the X API v2 standard tier covering list lookup."
...
<CardGroup cols={2}>
  <Card title="By ID" icon="/icons/xds/icon-bulleted-list.svg">
    Get details for a specific List
  </Card>
  <Card title="By owner" icon="/icons/xds/icon-person.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/lists/list-lookup/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/lists/list-lookup-by-list-id">
