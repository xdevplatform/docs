...
description: The List lookup endpoints let you retrieve information about Lists. Look up a specific List by ID or get all Lists owned by a user. Standard X API v2 tier.
