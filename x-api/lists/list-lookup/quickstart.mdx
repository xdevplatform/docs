...
description: "This guide walks you through looking up List information using the List lookup endpoints. Reference for the X API v2 standard tier covering list lookup."
