...
description: "This guide covers the key concepts you need to integrate the List lookup endpoints into your. Reference for the X API v2 standard tier covering list lookup."
---
...
<Card title="Pagination guide" icon="/icons/xds/icon-arrow-right.svg" href="/x-api/fundamentals/pagination">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/lists/list-lookup/quickstart">
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/lists/get-list-by-id">
