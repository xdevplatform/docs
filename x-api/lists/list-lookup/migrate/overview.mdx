---
title: List lookup migration overview
description: Compare Standard v1.1 lists/show and lists/list with X API v2 List lookup endpoints, including new fields, expansions, and authentication options.
