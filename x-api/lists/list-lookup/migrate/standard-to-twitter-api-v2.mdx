---
title: "List lookup: Standard v1.1 to X API v2"
description: Step-by-step comparison of Standard v1.1 List lookup endpoints and the X API v2 equivalents, including parameters, authentication, and rate limits.
