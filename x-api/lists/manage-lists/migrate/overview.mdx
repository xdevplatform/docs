---
title: Manage Lists migration overview
description: Move List creation, updates, and deletion from Standard v1.1 lists endpoints to the X API v2 manage Lists endpoints with mapped parameters and limits.
