...
description: "The Manage Lists endpoints let you create, update, and delete Lists on behalf of. Reference for the X API v2 standard tier covering manage lists."
