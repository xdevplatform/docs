...
description: "Quickstart for retrieving a user's pinned X Lists using the X API v2 pinned Lists lookup endpoint, including authentication and sample responses."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-pinned-lists">
