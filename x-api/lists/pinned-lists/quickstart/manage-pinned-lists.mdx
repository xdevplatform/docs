...
description: "Quickstart for pinning and unpinning X Lists on the authenticated user account using the X API v2 pinned Lists endpoints, with example requests."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/lists/pin-list">
