...
description: "The Pinned Lists endpoints let you view, pin, and unpin Lists for the authenticated user. Reference for the X API v2 standard tier covering pinned lists."
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/lists/pinned-lists/integrate">
