...
<Button href="https://developer.x.com/en/docs/twitter-api/lists/pinned-lists/quick-start.html">
  Sample code
</Button>
<Button href="https://t.co/twitter-api-postman">
  Run in Postman
</Button>
<Button href="https://developer.twitter.com/apitools/api?endpoint=/2/users/%7Bid%7D/pinned_lists&method=get">
