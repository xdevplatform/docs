...
<Note>
**Looking for encrypted DMs?** The [Chat API](/xchat/introduction) provides end-to-end encrypted messaging with a separate set of endpoints. See the [Chat API Getting Started guide](/xchat/getting-started) to build with encrypted DMs.
</Note>
