...
description: "The Manage Direct Messages endpoints let you send and delete Direct Messages on behalf of. Reference for the X API v2 standard tier covering manage."
