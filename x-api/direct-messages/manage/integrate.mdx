...
description: "This guide covers the key concepts you need to integrate the manage Direct Messages endpoints into. Reference for the X API v2 standard tier covering manage."
---
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/direct-messages/create-dm-message-by-participant-id">
