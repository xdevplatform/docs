...
description: This guide covers the key concepts you need to integrate the manage Direct Messages endpoints into your application. DM endpoints. Standard X API v2 tier.
---
