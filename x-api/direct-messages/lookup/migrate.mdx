...
description: Guide to migrating Direct Message lookup code from X API v1.1 to v2, covering endpoint changes, request parameters, and new response payloads.
---
