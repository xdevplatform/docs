...
description: "This guide covers the key concepts you need to integrate the Direct Messages lookup endpoints into. Reference for the X API v2 standard tier covering lookup."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Group" icon="/icons/xds/icon-chat-unread.svg">
