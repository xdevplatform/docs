...
<Note>
**Looking for encrypted DMs?** The [Chat API](/xchat/introduction) provides end-to-end encrypted messaging. See the [Chat API Getting Started guide](/xchat/getting-started) for encrypted DM lookup and real-time events.
</Note>
