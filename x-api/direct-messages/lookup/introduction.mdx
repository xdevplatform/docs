...
<Note>
**Looking for encrypted DMs?** The [XChat API](/xchat/introduction) provides end-to-end encrypted messaging. See the [XChat Getting Started guide](/xchat/getting-started) for encrypted DM lookup and real-time events.
</Note>
