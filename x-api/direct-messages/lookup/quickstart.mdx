...
description: "This guide walks you through retrieving Direct Message events for the authenticated user. Reference for the X API v2 standard tier covering lookup."
