...
description: "The manage DM blocks endpoints enable you to block or unblock a specified account on behalf of an. Reference for the X API v2 standard tier covering blocks."
---
