---
title: Manage Direct Message blocks on the X API v2
sidebarTitle: Introduction
keywords: ["DM blocks", "direct message blocks", "block DMs", "DM blocking", "direct message blocking", "block messages"]

description: "Use the X API v2 Manage DM blocks endpoints to block or unblock a specified account on behalf of an authenticated user and control who can send Direct Messages."
---
