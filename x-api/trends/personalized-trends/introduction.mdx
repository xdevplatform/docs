...
description: "The Personalized Trends endpoint returns trending topics tailored to the. Reference for the X API v2 standard tier covering personalized trends."
