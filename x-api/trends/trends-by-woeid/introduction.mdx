...
description: "The Trends by WOEID endpoint returns trending topics for a specific geographic location. Reference for the X API v2 standard tier covering trends by woeid."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/trends/trends-by-woeid">
