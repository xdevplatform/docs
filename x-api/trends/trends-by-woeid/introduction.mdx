...
description: 'The Trends by WOEID endpoint returns trending topics for a specific geographic location, identified by a Yahoo! Where On Earth ID. Standard X API v2 tier.'
