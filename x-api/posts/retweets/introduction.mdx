...
description: "The Retweets endpoints let you retweet and undo retweets, see who retweeted a Post, and get. Reference for the X API v2 standard tier covering retweets."
...
<CardGroup cols={2}>
  ...
  <Card title="Retweeting users" icon="/icons/xds/icon-people.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-reposted-by">
