...
You can authenticate these endpoints with either either [OAuth 1.0a User Context](https://developer.twitter.com/resources/fundamentals/authentication) or [OAuth 2.0 Authorization Code with PKCE](https://developer.x.com/en/docs/authentication/oauth-2-0/authorization-code).
