---
title: Reposts endpoints migration overview
description: Migrate Repost (retweet) lookup, creation, and deletion from Standard v1.1 to X API v2 with side-by-side endpoint, parameter, and limit comparisons.
