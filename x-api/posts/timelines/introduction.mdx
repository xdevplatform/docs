...
description: "The Timelines endpoints let you retrieve Posts from user timelines, mention feeds, and home. Reference for the X API v2 standard tier covering timelines."
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-posts">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-mentions">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-timeline">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/timelines/integrate">
