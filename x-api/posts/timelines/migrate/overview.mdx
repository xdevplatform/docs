---
title: Timelines endpoints migration overview
description: Map Standard v1.1 user and mention timelines to the X API v2 reverse chronological timeline and user mentions endpoints to plan your migration.
