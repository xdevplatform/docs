...
description: If you have been working with the v1.1 statuses/filter endpoint, this guide can help you understand the similarities and differences. Standard X API v2 tier.
---
