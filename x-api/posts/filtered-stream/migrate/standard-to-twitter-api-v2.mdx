...
description: "If you have been working with the v1.1 statuses/filter endpoint, this guide can help you. Reference for the X API v2 standard tier covering migrate."
