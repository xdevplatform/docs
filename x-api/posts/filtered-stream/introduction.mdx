...
description: "The Filtered Stream endpoints let you receive near real-time Posts that match your filter. Reference for the X API v2 standard tier covering filtered stream."
