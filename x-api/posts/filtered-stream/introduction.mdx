...
The returned Posts from filtered stream count towards the monthly [Post cap](/x-api/fundamentals/tweet-cap).
...
<Button href="https://developer.twitter.com/en/docs/tutorials/developer-guide--twitter-api-toolkit-for-google-cloud1">
  Build a dashboard to find insights from X data
</Button>
</div>
