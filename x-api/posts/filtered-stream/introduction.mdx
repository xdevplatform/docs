...
description: "Receive near real-time Posts that match custom rules with X API v2 Filtered Stream, using powerful operators to filter the public Post firehose."
...
<CardGroup cols={2}>
  ...
  <Card title="Persistent rules" icon="/icons/xds/icon-filter.svg">
    Add and remove rules without disconnecting
  </Card>
  <Card title="Powerful operators" icon="/icons/xds/icon-search.svg">
...
<Card title="Contact for Enterprise" icon="/icons/xds/icon-bank.svg" href="https://developer.x.com/en/products/x-api/enterprise/enterprise-api-interest-form">
...
<Card title="Build a rule" icon="/icons/xds/icon-filter.svg" href="/x-api/posts/filtered-stream/integrate/build-a-rule">
...
<CardGroup cols={2}>
  ...
  <Card title="Recovery and redundancy" icon="/icons/xds/icon-shield-keyhole.svg" href="/x-api/fundamentals/recovery-and-redundancy">
