...
description: "Use the matching_rules payload field to identify which X API v2 Filtered Stream rules a delivered Post matched, including tags and embedding scores."
---
