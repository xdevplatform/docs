...
description: "Build X API v2 Filtered Stream rules using keyword operators, conjunctions, and negations to deliver Posts that match your filter in near real time."
...
<CardGroup cols={2}>
  <Card title="Operators reference" icon="/icons/xds/icon-bulleted-list.svg" href="/x-api/posts/filtered-stream/integrate/operators">
    Complete list of available operators
  </Card>
  <Card title="Filtered stream quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/posts/filtered-stream/quickstart">
