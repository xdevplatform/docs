...
description: "The filtered stream endpoints deliver Posts that match a set of rules applied to the stream. Reference for the X API v2 standard tier covering integrate."
