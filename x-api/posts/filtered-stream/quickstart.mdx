...
description: "This guide walks you through connecting to the filtered stream to receive near real-time. Reference for the X API v2 standard tier covering filtered stream."
...
<Steps>
  <Step title="Create a filter rule" icon="/icons/xds/icon-filter.svg">
...
```
  ...
  <Step title="Process incoming Posts" icon="/icons/xds/icon-chat.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/filtered-stream">
