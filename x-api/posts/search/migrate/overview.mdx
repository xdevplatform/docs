...
description: "The v2 Search Tweets endpoint will eventually replace the standard v1.1 search/posts endpoint and. Reference for the X API v2 standard tier covering migrate."
---
...
| source: | Available |     |     |
| min_replies: | Available |     | Available |
| min_retweets: | Available |     | Available as min_reposts: |
| min_faves: | Available |     | Available as min_likes: |
| card_name: | Available |     |     |
