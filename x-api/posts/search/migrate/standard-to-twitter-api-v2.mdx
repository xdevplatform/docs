...
**Standard v1.1 [GET search/tweets](https://developer.twitter.com/en/docs/twitter-api/v1/tweets/search/api-reference/get-search-tweets) and v2 [GET tweets/search/recent](/x-api/posts/recent-search) endpoints**
