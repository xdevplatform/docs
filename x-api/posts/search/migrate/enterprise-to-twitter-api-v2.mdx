...
description: "Migrate from the Enterprise Search Posts API to X API v2 with a side-by-side comparison of pagination, timezones, Post edit history, and metadata fields."
