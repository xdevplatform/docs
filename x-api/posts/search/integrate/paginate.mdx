...
description: "Search queries typically match on more Posts than can be returned in a single API response. Reference for the X API v2 standard tier covering integrate."
---
