...
description: "This guide covers the key concepts you need to integrate the Search Posts endpoints into your. Reference for the X API v2 standard tier covering integrate."
...
|:-------------|:--------------|:--------------------|
| Self-serve | 512 UTF-8 bytes | 1,024 UTF-8 bytes |
| Enterprise | 4,096 UTF-8 bytes | 4,096 UTF-8 bytes |

Limits are measured in UTF-8 bytes, not characters. Multibyte characters count as more than one byte each, so a query with non-ASCII content can exceed the limit with fewer visible characters. Over-budget queries return HTTP 200 with `result_count: 0`.
...
<Card title="Build a query" icon="/icons/xds/icon-search.svg" href="/x-api/posts/search/integrate/build-a-query">
...
<Card title="Pagination guide" icon="/icons/xds/icon-arrow-right.svg" href="/x-api/posts/search/integrate/paginate">
...
<Card title="Edit Posts fundamentals" icon="/icons/xds/icon-history.svg" href="/x-api/fundamentals/edit-posts">
...
<CardGroup cols={2}>
  ...
  <Card title="Handle pagination" icon="/icons/xds/icon-arrow-right.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Pagination" icon="/icons/xds/icon-arrow-right.svg" href="/x-api/posts/search/integrate/paginate">
    Handle large result sets
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/recent-search">
