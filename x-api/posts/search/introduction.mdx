...
description: "The Search Posts endpoints let you find Posts matching specific criteria using powerful query. Reference for the X API v2 standard tier covering search."
...
- 512-byte query length in UTF-8 (4,096 for Enterprise)
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/search-all-posts">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/search/integrate/overview">
