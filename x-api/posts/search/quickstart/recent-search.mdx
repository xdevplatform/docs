...
description: "This guide walks you through making your first recent search request to find Posts from the. Reference for the X API v2 standard tier covering quickstart."
...
<Steps>
  <Step title="Build a query" icon="/icons/xds/icon-search.svg">
...
```
  ...
  <Step title="Paginate through results" icon="/icons/xds/icon-arrow-right.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/search-recent-posts">
