...
Each recent search query requires a single [search query](https://developer.x.com/en/docs/x-api/posts/search/integrate/build-a-rule). For this example, we are going to use a query that matches on Posts posted by the @XDevelopers account. For this query we use the from operator and set it to XDevelopers (case insensitive):
...
[See a full list of query operators](https://developer.x.com/en/docs/x-api/posts/search/integrate/build-a-rule "See a full list of query operators")
...
[Learn how to analyze past conversations]https://developer.x.com/en/docs/tutorials/analyze-past-conversations "Learn how to analyze past conversations")
...
[Learn how to process, analyze, and visualize Posts](https://developer.x.com/en/docs/tutorials/developer-guide--twitter-api-toolkit-for-google-cloud "Learn how to process, analyze, and visualize Posts")
