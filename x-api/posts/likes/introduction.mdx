...
You can authenticate these endpoints with either [OAuth 1.0a User Context](https://developer.twitter.com/resources/fundamentals/authentication) or [OAuth 2.0 Bearer Token](https://developer.twitter.com/en/docs/authentication/oauth-2-0). For the liked Posts endpoints, pagination tokens will be provided for paging through large sets of results.

The liking users endpoint limits you to a total of 100 liking accounts per post for all time.  Additionally, the liked Posts endpoint is also subject to the monthly [Post cap](/x-api/fundamentals/tweet-cap) applied at the Project level.
 
...
<Button href="https://developer.x.com/en/docs/twitter-api/tweets/likes/quick-start.html">
  Quick start
</Button>
