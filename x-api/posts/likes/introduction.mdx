...
description: "The Likes endpoints let you like and unlike Posts, see which users liked a Post, and get Posts. Reference for the X API v2 standard tier covering likes."
...
<CardGroup cols={2}>
  <Card title="Like a Post" icon="/icons/xds/icon-heart.svg">
    Like a Post on behalf of a user
  </Card>
  <Card title="Unlike a Post" icon="heart-crack">
    Remove a like from a Post
  </Card>
  <Card title="Liking users" icon="/icons/xds/icon-people.svg">
...
<CardGroup cols={2}>
  <Card title="Lookup quickstart" icon="/icons/xds/icon-heart.svg" href="/x-api/posts/likes/quickstart/likes-lookup">
    Get likes for a Post
  </Card>
  <Card title="Manage quickstart" icon="plus" href="/x-api/posts/likes/quickstart/manage-likes">
    Like and unlike Posts
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-liking-users">
