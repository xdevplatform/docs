...
description: If you have been working with the standard v1.1 POST favorites/create and POST favorites/destroy endpoints, the goal of this guide is. Standard X API v2 tier.
---
