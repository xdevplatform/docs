---
title: Likes endpoints migration overview
description: Map Standard v1.1 Likes endpoints (favorites/list, favorites/create, favorites/destroy) to X API v2 likes endpoints to plan a migration.
