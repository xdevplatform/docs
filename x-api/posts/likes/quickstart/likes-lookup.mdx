...
description: "Quickstart for retrieving like data from the X API, including liking users and liked Posts, using the X API v2 standard tier likes lookup endpoints."
...
<CardGroup cols={2}>
  <Card title="Manage likes" icon="/icons/xds/icon-heart.svg" href="/x-api/posts/likes/quickstart/manage-likes">
