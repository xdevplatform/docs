...
description: "The Hide Replies endpoint lets you hide or unhide replies to Posts authored by the. Reference for the X API v2 standard tier covering hide replies."
