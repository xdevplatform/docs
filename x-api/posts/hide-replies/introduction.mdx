...
description: The Hide Replies endpoint lets you hide or unhide replies to Posts authored by the authenticated user. Part of the X API v2 reference documentation.
