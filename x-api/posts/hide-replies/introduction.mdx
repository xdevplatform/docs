...
description: "Use the X API v2 Hide Replies endpoint to hide or unhide replies to Posts authored by the authenticated user and moderate conversations on X."
...
<CardGroup cols={2}>
  ...
  <Card title="Conversation control" icon="/icons/xds/icon-chat-unread.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/hide-replies">
