...
description: "Through the hide replies endpoint, you can build integrations to help people and brands keep. Reference for the X API v2 standard tier covering integrate."
---
