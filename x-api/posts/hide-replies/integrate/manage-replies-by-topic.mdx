...
Recent search has functionality to a conversation and its replies, and the Post payload returns [Post annotations](x-api/fundamentals/tweet-annotations) to help you understand the context and topic of each Post, regardless of language.
