...
description: "This guide walks you through retrieving Quote Posts (Posts that quote another Post). Reference for the X API v2 standard tier covering quote tweets."
...
<Steps>
  <Step title="Find the Post ID" icon="/icons/xds/icon-chat.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-quoted-posts">
