...
description: "This guide walks you through retrieving Quote Posts (Posts that quote another Post). Before you begin, you'll need: - A developer. Standard X API v2 tier."
