---
title: X API v2 manage Posts quickstart
sidebarTitle: Quickstart
description: "Step-by-step quickstart for creating and deleting Posts with the X API v2 standard tier, including authentication, request payloads, and examples."
...
```
  ...
  <Accordion title="Post with paid partnership">
...
<CardGroup cols={2}>
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/manage-tweets/integrate">
