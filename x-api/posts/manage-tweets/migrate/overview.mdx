---
title: Manage Posts endpoints migration overview
description: Move Post creation and deletion from Standard v1.1 statuses endpoints to X API v2 by comparing parameters, authentication, and rate limits.
