...
description: 'If you have been working with the standard v1.1 POST statuses/update and POST statuses/destroy/:id endpoints, the goal of this guide. Standard X API v2 tier.'
---
...
The X API v2 endpoints require that you use credentials from a [developer App](/resources/fund