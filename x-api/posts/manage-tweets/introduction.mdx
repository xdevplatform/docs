...
description: "The Manage Posts endpoints let you create and delete Posts on behalf of authenticated. Reference for the X API v2 standard tier covering manage tweets."
