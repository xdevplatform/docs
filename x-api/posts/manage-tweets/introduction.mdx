...
description: "Create and delete Posts on behalf of authenticated users with the X API v2 standard tier manage Posts endpoints, including request and response details."
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/creation-of-a-post">
