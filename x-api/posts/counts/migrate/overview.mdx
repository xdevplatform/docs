...
description: "The v2 Post counts endpoint will eventually replace the enterprise Search API’s counts endpoint. Reference for the X API v2 standard tier covering migrate."
