...
description: "The Post counts endpoints return the volume of Posts matching a query over time, without returning. Reference for the X API v2 standard tier covering counts."
...
<CardGroup cols={2}>
  <Card title="Volume analysis" icon="/icons/xds/icon-bar-chart.svg">
    Build trendlines and visualizations showing Post volume over time
  </Card>
  <Card title="Query refinement" icon="/icons/xds/icon-filter.svg">
...
- 512-byte query length in UTF-8
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-count-of-recent-posts">
...
- 1,024-byte query length in UTF-8 (4,096 for Enterprise)
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-count-of-all-posts">
    Full endpoint documentation
  </Card>
</CardGroup>
...
<Card title="Build a query" icon="/icons/xds/icon-search.svg" href="/x-api/posts/counts/integrate/build-a-query">
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/counts/integrate/overview">
