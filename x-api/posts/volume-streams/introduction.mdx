---
title: Volume streams (1% sampled and Decahose) on the X API v2
sidebarTitle: Introduction
keywords: ["sampled stream", "1% stream", "10% stream", "decahose", "volume streams", "sampled tweets", "streaming API"]
description: "Stream sampled Posts in real time with the X API v2 1% sampled stream and 10% Decahose volume stream endpoints to track trends, sentiment, and events."
---
