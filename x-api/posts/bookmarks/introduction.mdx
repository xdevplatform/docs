...
description: "The Bookmarks endpoints let you view, add, and remove bookmarked Posts for the authenticated. Reference for the X API v2 standard tier covering bookmarks."
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/bookmarks/integrate">
    Key concepts and best practices
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/users/get-bookmarks">
