...
description: "This guide walks you through retrieving your bookmarked Posts using the X API. Before you begin, you'll need: - A developer account. Standard X API v2 tier."
