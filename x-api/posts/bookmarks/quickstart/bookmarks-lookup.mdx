...
description: "This guide walks you through retrieving your bookmarked Posts using the X API. Reference for the X API v2 standard tier covering quickstart."
