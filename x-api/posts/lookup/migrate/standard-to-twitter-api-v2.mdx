...
description: If you have been working with the standard v1.1 GET statuses/show and GET statuses/lookup, this guide will help you understand the. Standard X API v2 tier.
---
