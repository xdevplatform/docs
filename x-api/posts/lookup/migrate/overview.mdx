...
description: "The v2 Posts lookup endpoints replace the standard v1.1 GET statuses/lookup and GET statuses/show. Reference for the X API v2 standard tier covering migrate."
---
