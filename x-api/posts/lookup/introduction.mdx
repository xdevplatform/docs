...
description: "The Post lookup endpoints allow you to retrieve one or more Posts by their IDs. Reference for the X API v2 standard tier covering lookup."
...
<CardGroup cols={2}>
  <Card title="Single Post" icon="/icons/xds/icon-chat.svg">
    Retrieve a specific Post by ID
  </Card>
  <Card title="Multiple Posts" icon="messages">
    Retrieve up to 100 Posts in one request
  </Card>
  <Card title="Edit History" icon="/icons/xds/icon-history.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="Integration guide" icon="/icons/xds/icon-book.svg" href="/x-api/posts/lookup/integrate">
    Learn key concepts and best practices
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/get-post-by-id">
