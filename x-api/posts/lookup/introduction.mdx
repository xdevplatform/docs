...
This endpoint will always return the most recent edit along with its edit history. Any Post collected after its 30-minute edit window has expired will represent its final version. To learn more about Edit Post metadata, check out the [Edit Posts fundamentals](/x-api/fundamentals/edit-tweets) page.
...
Learn more about getting access to the X API v2 endpoints in our [getting started guide](https://developer.x.com/en/docs/x-api/getting-started/getting-access-to-the-x-api).
</Note>
---
...
<div className="flex space-x-2.5">
  ...
  <Button href="https://www.postman.com/twitter/twitter-s-public-workspace/collection/9956214-784efcda-ed4c-4491-a4c0-a26470a67400?ctx=documentation">
    Run in Postman
  </Button>
  <Button href="https://developer.twitter.com/apitools/api?endpoint=/2/tweets&method=get">
    Run in Postman
  </Button>
</div>