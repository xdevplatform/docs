...
description: "This guide covers the key concepts you need to integrate the Post lookup endpoints into your. Reference for the X API v2 standard tier covering lookup."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Handle edits" icon="/icons/xds/icon-history.svg">
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/posts/post-lookup-by-post-id">
