...
description: "The Stream Connections endpoints let you retrieve the history of your application's streaming. Reference for the X API v2 standard tier covering connections."
...
<CardGroup cols={2}>
  ...
  <Card title="Terminate by endpoint" icon="/icons/xds/icon-filter.svg">
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/connections/get-connection-history">
