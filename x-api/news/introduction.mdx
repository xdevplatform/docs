---
title: News lookup endpoint on the X API v2
description: "Look up breaking news stories and headlines on X with the v2 news endpoint, including summaries, hooks, contexts, tickers, and clustered Post results."
