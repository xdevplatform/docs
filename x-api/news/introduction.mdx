...
description: The news lookup endpoint allows developers to get news and headlines breaking on X. This endpoint supports app-auth and user-auth authentication for OAuth1 a...
---
