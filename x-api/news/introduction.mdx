---
title: Introduction
description: "Look up breaking news stories and headlines on X with the news endpoint, including summaries, hooks, contexts, tickers, and clustered post results."
