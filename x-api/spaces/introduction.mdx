---
title: Introduction
description: "Use the X API Spaces endpoints to look up live or scheduled audio Spaces, search by keyword, and inspect creators, hosts, speakers, and listeners."
