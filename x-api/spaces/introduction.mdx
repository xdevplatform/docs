---
title: Spaces endpoints on the X API v2
description: "Use the X API v2 Spaces endpoints to look up live or scheduled audio Spaces, search by keyword, and inspect creators, hosts, speakers, and listener details."
