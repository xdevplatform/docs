...
The following page describes the Spaces endpoints included in the X API. To learn more about Spaces in general, please visit [help.x.com](https://help.twitter.com/en/using-twitter/spaces). 
...
* [Spaces data dictionary](/x-api/fundamentals/data-dictionary#space)
