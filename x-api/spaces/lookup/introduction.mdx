...
description: "The Spaces lookup endpoints let you retrieve information about live or scheduled Spaces. Reference for the X API v2 standard tier covering lookup."
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/spaces/lookup/quickstart">
  ...
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/spaces/space-lookup-by-space-id">
