...
description: The Spaces Search endpoint lets you search for live or scheduled Spaces by keyword. Find Spaces about topics of interest. Search. Standard X API v2 tier.
