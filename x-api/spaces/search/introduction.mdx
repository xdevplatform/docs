...
description: "The Spaces Search endpoint lets you search for live or scheduled Spaces by keyword. Reference for the X API v2 standard tier covering search."
...
<CardGroup cols={2}>
  <Card title="Keyword search" icon="/icons/xds/icon-search.svg">
    Search Spaces by title
  </Card>
  <Card title="Discover Spaces" icon="/icons/xds/icon-microphone.svg">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="/icons/xds/icon-rocket.svg" href="/x-api/spaces/search/quickstart">
    Search for your first Space
  </Card>
  <Card title="Spaces lookup" icon="/icons/xds/icon-microphone.svg" href="/x-api/spaces/lookup/introduction">
    Look up Spaces by ID
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/spaces/search-spaces">
