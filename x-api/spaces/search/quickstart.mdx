...
description: "This guide walks you through searching for Spaces by keyword. Before you begin, you'll need: - A developer account with an approved. Standard X API v2 tier."
