...
description: Enterprise endpoints have been updated to provide edited Post metadata. The _Edit Posts _feature was first introduced for testing among X employees on S...---
