...
[Methods](/x-api/enterprise-gnip-2.0/fundamentals/decahose-api#methods)

[Authentication](/x-api/enterprise-gnip-2.0/fundamentals/decahose-api#authentication)

[GET /\{stream-type}/:stream](/x-api/enterprise-gnip-2.0/fundamentals/decahose-api#get-stream-type-stream)

[Replay API](/x-api/enterprise-gnip-2.0/fundamentals/decahose-api#replay-api)
