...
description: "Stream realtime user compliance events such as deletes, edits, withholdings, and scrubs with the enterprise Compliance Firehose API for stored data."
