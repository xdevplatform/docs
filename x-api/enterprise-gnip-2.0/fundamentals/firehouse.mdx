...
>In addition, both the batch compliance and the compliance firehose have been updated to support Post edits. For the compliance firehose, a new 'tweet_edit' event was added. See the [Compliance Data Objects](/x-api/enterprise-gnip-2.0/fundamentals/firehouse#compliance-data-objects) documentation for more details. Learn more about how Edit Post metadata works on the [Edit Posts fundamentals](/x-api/fundamentals/edit-posts) page.
