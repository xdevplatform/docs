...
description: ">Check out our comparison guides: > > Native Enriched compared to X API v2 > Activity Streams compared to X API v2 Posts are the basic atomic building block."
