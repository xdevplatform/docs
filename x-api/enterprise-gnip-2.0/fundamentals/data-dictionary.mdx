...
description: Data dictionary mapping legacy Enterprise GNIP and PowerTrack data formats and enrichments to modern X API v2 objects, fields, expansions, and metrics.
