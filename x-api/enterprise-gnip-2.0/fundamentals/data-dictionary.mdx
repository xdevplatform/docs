...
description: Detailed mapping of legacy Enterprise/GNIP/PowerTrack data formats and enrichments to modern X API v2 objects, fields, expansions, and metrics for historical archive and real-time streaming use cases.
