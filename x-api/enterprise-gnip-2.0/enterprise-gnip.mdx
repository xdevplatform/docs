---
title: Enterprise APIs for X data access
keywords: ["enterprise API", "GNIP", "enterprise data", "enterprise access", "GNIP API", "PowerTrack", "Decahose"]
description: Explore the X enterprise APIs, including PowerTrack, Decahose, Search, Account Activity, and more, for reliable, large-scale data access.
---
...
| :--- | :--- | :--- |
| [Decahose API](/x-api/enterprise-gnip-2.0/fundamentals/decahose-api) | Stream a random sample of 10% of all public Posts and their likes. |
| :--- | :--- | :--- |
...
| [Historical PowerTrack API](/x-api/enterprise-gnip-2.0/powertrack-api) | Filter the full archive of public Posts using an economical batch access process. |
