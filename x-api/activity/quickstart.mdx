...
```json title="profile.update.bio" expandable lines wrap icon="brackets-curly"
{
  "data": [
    {
      "subscription_id": "1976325569252868096",
...
<CardGroup cols={2}>
  <Card title="Event payloads" icon="brackets-curly" href="/x-api/activity/event-payloads">
