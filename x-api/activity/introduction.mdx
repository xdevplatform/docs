...
description: "Stream real-time user activity events from the X Platform, including posts, likes, follows, DMs, mentions, and profile updates via webhooks."
keywords: ["activity API", "X Activity API", "activity events", "profile updates", "post.create", "post.delete", "like.create", "user activity", "real-time events", "activity stream"]
---
