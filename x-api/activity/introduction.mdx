...
description: "The X Activity API (XAA) endpoint group allows developers to tap in to activity events happening on the X Platform. A developer can subscribe to events they."
---
...
| POST | [`/2/activity/subscriptions`](/x-api/activity/create-x-activity-subs
