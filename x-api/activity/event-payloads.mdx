...
<Accordion title="Example envelope" description="Common fields on every activity event">
...
Full JSON samples are collapsed by default—expand **Example payload** under each event type to copy the complete delivery body.
...
<Accordion title="Example payload" description="Full JSON for `post.create`">
...
<Accordion title="Example payload" description="Full JSON for `post.delete`">
...
<Accordion title="Example payload" description="Full JSON for `post.mention.create`">
...
<Accordion title="Example payload" description="Full JSON for `like.create`">
...
<Accordion title="Example payload" description="Full JSON for `follow.follow`">
...
<Accordion title="Example payload" description="Full JSON for `follow.unfollow`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.bio`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.profile_picture`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.banner_picture`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.screenname`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.geo`">
...
<Accordion title="Example payload" description="Full JSON for `profile.update.url`">
...
<Accordion title="Example payload" description="Full JSON for `chat.received`">
...
<Accordion title="Example payload" description="Full JSON for `chat.sent`">
...
<Accordion title="Example payload" description="Full JSON for `dm.sent`">
...
<Accordion title="Example payload" description="Full JSON for `dm.received`">
...
<Accordion title="Example payload" description="Full JSON for `news.new`">
...
<Accordion title="Example payload" description="Full JSON for `spaces.start`">
...
<Accordion title="Example payload" description="Full JSON for `spaces.end`">
...
<Accordion title="Example payload" description="Full JSON for `oauth.revoke`">
