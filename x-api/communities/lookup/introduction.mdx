...
description: "The Communities lookup endpoint lets you retrieve information about X Communities by their ID. Reference for the X API v2 standard tier covering lookup."
...
<CardGroup cols={2}>
  ...
  <Card title="Search" icon="/icons/xds/icon-search.svg">
...
<CardGroup cols={2}>
  <Card title="Search Communities" icon="/icons/xds/icon-search.svg" href="/x-api/communities/search/introduction">
    Find Communities by keyword
  </Card>
  <Card title="API Reference" icon="/icons/xds/icon-code.svg" href="/x-api/communities/get-community-by-id">
