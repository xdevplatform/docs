---
title: Introduction
description: "Upload images, GIFs, and videos to X using chunked or simple media upload, retrieve media_id values, and attach them to Posts, DMs, and profiles."
