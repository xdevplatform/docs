...
1. Upload the media file(s) using either the recommended [chunked](/x-api-/media/quickstart/chunked-media-upload) upload (images/GIF/video), or the older [simple](/x-api/media-upload/media-upload) upload (images only).
