...
description: There are a few important concepts to understand when using the [`POST /2/media/upload`](/x-api/media/upload-media) endpoint. Uploading media with OAuth...
---
