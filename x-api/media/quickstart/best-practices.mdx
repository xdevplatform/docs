...
description: There are a few important concepts to understand when using the POST /2/media/upload endpoint. Uploading media with OAuth can be a. Standard X API v2 tier.
---
