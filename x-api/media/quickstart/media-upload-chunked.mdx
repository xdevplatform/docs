...
description: This guide walks you through uploading videos and large media files using the chunked upload workflow. For video or large media. Standard X API v2 tier.
