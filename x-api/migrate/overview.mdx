...
description: "The latest version of the X API v2 is a big deal. As such, we’ve broken this migration section into a few partitions: The X API v2 is now the primary X API."
