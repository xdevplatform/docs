...
description: "Map fields from v1.1 Native, enterprise Native Enriched, and Activity Streams payloads to the X API v2 data format using fields and expansions."
