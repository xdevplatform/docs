---
title: Articles endpoints for long-form Posts on the X API
description: "Use the X API v2 Articles endpoints to programmatically create draft long-form Articles with rich text, media, and embedded Posts, then publish them to X."
