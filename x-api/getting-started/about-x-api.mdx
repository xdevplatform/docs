...
description: "High-level overview of the X API covering capabilities, v2 versus v1.1 versions, available resources, pricing tiers, and how to start building."
...
<CardGroup cols={2}>
  <Card title="Get access" icon="/icons/xds/icon-key.svg" href="/x-api/getting-started/getting-access">
