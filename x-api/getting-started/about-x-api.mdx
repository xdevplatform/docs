...
Recently, we released the X API v2. The X API v2 includes a modern foundation, new and advanced features, and quick onboarding to [Basic access](https://developer.twitter.com/en/portal/products/basic).
...
|:---|:---|:---|:---|:---|
| Getting access | [Get Started](https://developer.twitter.com/en/portal/products/free) | [Get Started](https://developer.twitter.com/en/portal/products/basic) | [Get Started](https://developer.twitter.com/en/portal/products/pro) | [Get Started](https://developer.twitter.com/en/products/twitter-api/enterprise/enterprise-api-interest-form) |
...
[Visit the X API endpoint map >](https://developer.twitter.com/en/docs/twitter-api/migrate/twitter-api-endpoint-map)
...
[Visit the data dictionary >](https://developer.twitter.com/en/docs/twitter-api/data-dictionary)
...
[Learn more about Post annotations >](https://developer.twitter.com/en/docs/twitter-api/annotations)
