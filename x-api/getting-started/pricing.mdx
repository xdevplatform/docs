...
<Tip>
Earn bonus [xAI API](https://docs.x.ai) credits when you purchase X API credits—up to 20% back based on your spend. [Learn more](#bonus-xai-api-credits)
</Tip>
...
## Bonus xAI API Credits

When you purchase X API credits, you can earn bonus [xAI API](https://docs.x.ai) credits based on your cumulative spend during a billing cycle.
