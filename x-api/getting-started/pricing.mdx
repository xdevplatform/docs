...
| **Media: Read** | &dollar;0.005 per resource |
| **Analytics: Read** | &dollar;0.005 per resource |
| **Trend: Read** | &dollar;0.010 per resource |
...
| Action | Unit Cost |
|:-------|:----------|
| **Content: Create** | &dollar;0.015 per request |
| **Content: Create (with URL)** | &dollar;0.200 per request |
