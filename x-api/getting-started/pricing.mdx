...
<Note>
Pay-per-usage plans are subject to a cap of **2 million Post reads per monthly billing cycle**. If you require higher volume, you will need to upgrade to an [Enterprise plan](/forms/enterprise-api-interest).
</Note>
