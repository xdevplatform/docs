...
<CardGroup cols={2}>
  <Card title="Credit-based" icon="/icons/xds/icon-coins.svg">
    Purchase credits upfront in the Developer Console. Credits are deducted as you make API requests.
  </Card>
  <Card title="Per-endpoint pricing" icon="/icons/xds/icon-code.svg">
...
| `mute.mute` | &dollar;0.001 |
| `mute.unmute` | &dollar;0.001 |
| `block.block` | &dollar;0.001 |
| `block.unblock` | &dollar;0.001 |
