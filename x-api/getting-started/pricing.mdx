...
description: "The X API uses pay-per-usage pricing. No subscriptions—pay only for what you use. Earn free xAI API credits when you purchase X API credits—up to 20% back."
