...
description: "Get started with the X API in three steps: sign up, create an app, and save your credentials. After signing up, create an app to get your API credentials:"
