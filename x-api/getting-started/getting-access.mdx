...
description: 'Get started with the X API in three steps: sign up, create an app, and save your credentials. Visit console.x.com and sign in with your X account.'
