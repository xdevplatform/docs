...
keywords: ["get API access", "sign up", "developer account", "API keys", "access tokens", "OAuth", "API credentials", "developer registration"]
---

### Step one: Sign up for a developer account

Signing up for a developer account is quick and easy! Just click on the button below, answer a few questions, and you can start exploring and building on the X API v2 using [Basic access](https://developer.x.com/en/portal/products/basic).
