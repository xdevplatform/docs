...
Please note that you can't make requests to streaming endpoints using Postman. Please visit the [filtered stream](/x-api/posts/filtered-stream/quickstart) or [1% sampled stream](/x-api/posts/volume-streams/quickstart) quick start guide to learn how to work with those endpoints.
