...
description: "The filtered stream endpoint group enables developers to filter a stream of public Posts. Reference for the X API v2 standard tier covering stream."
---
