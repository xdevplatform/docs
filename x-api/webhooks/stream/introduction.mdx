...
description: The filtered stream endpoint group enables developers to filter a stream of public Posts. This endpoint group’s functionality. Standard X API v2 tier.
---
