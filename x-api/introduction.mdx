...
mode: wide
description: Programmatic access to X with v2 REST endpoints for Posts, users, Spaces, lists, DMs, and trends, with pay-per-use pricing and modern SDKs.
...
<CardGroup cols={2}>
  <Card title="Flexible scaling" icon="/icons/xds/icon-bar-chart.svg">
