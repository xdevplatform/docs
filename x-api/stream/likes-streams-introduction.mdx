...
description: "The Likes Streams endpoints deliver real-time like events through persistent HTTP GET connections. Reference for the X API v2 standard tier covering stream."
