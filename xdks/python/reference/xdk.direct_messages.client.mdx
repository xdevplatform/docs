...
description: Reference for the direct messages client class in the Python XDK, including methods, parameters, and return types for X API v2 direct messages endpoints.
---
