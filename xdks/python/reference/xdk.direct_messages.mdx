...
description: Reference for the xdk.direct_messages module in the Python XDK, including the client class and Pydantic models for X API v2 direct messages endpoints.
---
