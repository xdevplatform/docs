...
description: Reference for the xdk.community_notes module in the Python XDK, including the client class and Pydantic models for X API v2 community notes endpoints.
---
