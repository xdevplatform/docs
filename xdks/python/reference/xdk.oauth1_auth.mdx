...
description: Reference for the xdk.oauth1_auth module in the Python XDK, including the client class and Pydantic models for X API v2 oauth1 auth endpoints.
---
