...
description: Reference for media Pydantic models in the Python XDK for the X API v2. Learn how to use the Python XDK for xdks python reference xdk.media.models.
---
