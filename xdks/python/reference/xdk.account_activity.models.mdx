...
description: "Reference for the account_activity.models Python module in the X API SDK. Pydantic request and response models for the account activity endpoints of the X."
---
