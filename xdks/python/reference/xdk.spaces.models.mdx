...
description: Reference for spaces Pydantic models in the Python XDK for the X API v2. Learn how to use the Python XDK for xdks python reference xdk.spaces.models.
---
