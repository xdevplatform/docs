...
description: Reference for the communities client class in the Python XDK, including methods, parameters, and return types for X API v2 communities endpoints.
---
