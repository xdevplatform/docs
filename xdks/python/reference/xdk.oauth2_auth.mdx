...
description: Reference for the xdk.oauth2_auth module in the Python XDK, including the client class and Pydantic models for X API v2 oauth2 auth endpoints.
---
