...
description: "Reference for the activity.client Python module in the X API SDK. Client class and methods for calling the activity endpoints of the X API v2."
---
