...
description: Reference for the xdk.connections module in the Python XDK, including the client class and Pydantic models for X API v2 connections endpoints.
---
