...
description: Reference for the community notes client class in the Python XDK, including methods, parameters, and return types for X API v2 community notes endpoints.
---
