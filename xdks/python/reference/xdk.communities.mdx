...
description: Reference for the xdk.communities module in the Python XDK, including the client class and Pydantic models for X API v2 communities endpoints.
---
