...
description: This example showcases how to quickly search for Posts using the XDK using Bearer Token authentication. 1. Log in to the X Developer Console.
---
