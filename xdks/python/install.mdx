...
description: "The XDK Python SDK is available directly from the GitHub repository and can be installed via pip. - Python 3.8 or higher. - pip and venv for virtual."
---
