...
description: TypeScript XDK module reference for Lists, with exported classes, functions, and type definitions for the X API v2. Reference for the TypeScript XDK.
---
