...
description: TypeScript XDK module reference for Stream, with exported classes, functions, and type definitions for the X API v2. Reference for the TypeScript XDK.
---
