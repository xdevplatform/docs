...
description: "Reference for the Spaces module in the X API TypeScript SDK. Re-exported clients, types, and utilities provided by this SDK module for the X API v2."
---
