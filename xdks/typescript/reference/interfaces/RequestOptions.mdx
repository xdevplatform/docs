...
description: "Reference for the RequestOptions TypeScript interface in the X API SDK. Request timeout in milliseconds Request signal for cancellation Return raw HTTP."
---
