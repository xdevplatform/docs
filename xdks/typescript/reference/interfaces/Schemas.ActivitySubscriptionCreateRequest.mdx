...
description: "TypeScript XDK `ActivitySubscriptionCreateRequest` interface reference — request schema with fields, types, and required flags for the X API v2 SDK."
---
