...
description: TypeScript XDK interface reference for ActivitySubscriptionCreateRequest, listing fields and types used in X API v2 request and response data.
---
