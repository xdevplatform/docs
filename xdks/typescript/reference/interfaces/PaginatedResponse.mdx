...
description: "Reference for the PaginatedResponse TypeScript interface in the X API SDK. Represents the structure of a paginated API response from the X API."
---
