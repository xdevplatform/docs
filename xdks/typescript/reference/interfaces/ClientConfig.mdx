...
description: "Reference for the ClientConfig TypeScript interface in the X API SDK. Configuration options for the X API client Bearer token for authentication OAuth1."
---
