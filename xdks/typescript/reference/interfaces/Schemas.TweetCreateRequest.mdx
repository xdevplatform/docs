...
description: Reference for the Schemas.TweetCreateRequest interface in the TypeScript XDK for X API v2, listing every field and type used in requests and responses.
---
