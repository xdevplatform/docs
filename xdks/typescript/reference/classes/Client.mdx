...
<ResponseField name="direct\_messages" type="DirectMessagesClient" required>
...
<ResponseField name="account\_activity" type="AccountActivityClient" required>
...
<ResponseField name="community\_notes" type="CommunityNotesClient" required>
