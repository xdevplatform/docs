...
description: "Stream real-time X API data in TypeScript using event listeners or async iteration for sampled posts, with automatic reconnection and stream lifecycle control."
---
