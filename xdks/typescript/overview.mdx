...
keywords: ["TypeScript XDK", "TypeScript SDK", "TypeScript API", "TypeScript client", "TypeScript library", "X API TypeScript", "TypeScript developer kit"]
---
...
- [API Reference](https://github.com/xdevplatform/xdk/tree/main/xdk/typescript) - Read the complete API documentation
