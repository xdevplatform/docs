...
description: Official TypeScript/JavaScript SDK for the X API v2 with full type safety, automatic pagination, event-driven streaming, and support for all authentication methods.
---
