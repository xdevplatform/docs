...
If you use Google Tag Manager, you can send Conversion API events from a server container without writing request code. See [Set up the Conversion API with Google Tag Manager](/x-ads-api/measurement/gtm-server-side).
