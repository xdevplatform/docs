---
title: AB Testing
description: "Run A/B tests on X Ads campaigns to compare creatives, targeting, bid type, and bid unit variations across randomized user group splits and measure lift."
