...
| Name | Description |
| :--- | :--- |
| q  <br/>_optional_ | An optional query to scope a targeting criteria. Omit this parameter to retrieve all.<br/><br/>Type: string<br/><br/>Example: `music` |
...
| :--- | :--- |
| count  <br/>_optional_ | Specifies the number of records to try and retrieve per distinct request.<br/><br/>Type: int<br/><br/>Default: `200`  <br/>Min, Max: `1`, `1000` |
| q  <br/>_optional_ | An optional query to scope a targeting criteria. Omit this parameter to retrieve all.<br/><br/>Type: string<br/><br/>Example: `apple` |
...
| count  <br/>_optional_ | Specifies the number of records to try and retrieve per distinct request.<br/><br/>Type: int<br/><br/>Default: `200`  <br/>Min, Max: `1`, `1000` |
| cursor  <br/>_optional_ | Specifies a cursor to get the next page of results. See [Pagination](/x-ads-api/introduction) for more information.<br/><br/>Type: string<br/><br/>Example: `8x7v00oow` |
| q  <br/>_optional_ | An optional query to scope a targeting criteria. Omit this parameter to retrieve all.<br/><br/>Type: string<br/><br/>Example: `books` |
...
| count  <br/>_optional_ | Specifies the number of records to try and retrieve per distinct request.<br/><br/>Type: int<br/><br/>Default: `200`  <br/>Min, Max: `1`, `1000` |
| cursor  <br/>_optional_ | Specifies a cursor to get the next page of results. See [Pagination](/x-ads-api/introduction) for more information.<br/><br/>Type: string<br/><br/>Example: `8x7v00oow` |
| q  <br/>_optional_ | An optional query to scope a targeting criteria. Omit this parameter to retrieve all.<br/><br/>Type: string<br/><br/>Example: `english` |
...
| cursor  <br/>_optional_ | Specifies a cursor to get the next page of results. See [Pagination](/x-ads-api/introduction) for more information.<br/><br/>Type: string<br/><br/>Example: `8x7v00oow` |
| q  <br/>_optional_ | An optional query to scope a targeting criteria search. Omit this parameter to retrieve all results.<br/><br/>Type: string<br/><br/>Examples: `Airpeak` |
...
| Name | Description |
| :--- | :--- |
| q  <br/>_optional_ | An optional query to scope a targeting criteria search. Omit this parameter to retrieve all results.<br/><br/>Type: string<br/><br/>Examples: `jelly bean` |
...
| :--- | :--- |
| count  <br/>_optional_ | Specifies the number of records to try and retrieve per distinct request.<br/><br/>Type: int<br/><br/>Default: `200`  <br/>Min, Max: `1`, `1000` |
| q  <br/>_optional_ | An optional query to scope a targeting criteria search. Omit this parameter to retrieve all results.<br/><br/>Type: string<br/><br/>Examples: `ios`, `blackberry` |
