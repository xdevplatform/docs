...
description: Official tools and community client libraries for the X Ads API, including SDKs in multiple languages and helpers for managing campaigns and reports.
...
Advertisers can also send website conversions through the official [Google Tag Manager server-side Conversion API template](/x-ads-api/measurement/gtm-server-side) without writing request code.
