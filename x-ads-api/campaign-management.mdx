...
Lead Gen Ads collect contact information in a native form on X. Create and manage those forms, attach them to cards with a `LEAD_FORM` destination, and export submitted leads with the [Lead Generation API](/x-ads-api/lead-generation).
