...
description: The type of a currency is identified using ISO-4217. This is a three-letter string like USD or EUR. The value of a currency is represented in micros.
---
