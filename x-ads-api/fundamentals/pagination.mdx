---
title: Pagination
description: "How to paginate large result sets on X Ads API GET endpoints using cursor and count query parameters with the next_cursor token to fetch subsequent pages."
