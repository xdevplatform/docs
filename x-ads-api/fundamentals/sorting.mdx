---
title: Sorting
description: "Sort X Ads API collection results using the sort_by query parameter, with supported ascending and descending attributes for campaigns, line items, and more."
