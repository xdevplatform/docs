...
2.  Making requests using your account that has been granted access to an Advertiser's account, e.g. an [Agency](https://business.twitter.com/en/blog/agencies-manage-multiple-Twitter-Ads-accounts.html) supporting multiple accounts.

This document is a brief overview of the differences between these options and should be used in conjunction with our other resources, such as the [multi-user login FAQ](https://business.twitter.com/en/help/troubleshooting/multi-user-login-faq.html). 
...
* **Standard Access**: User has access to [Analytics](/x-ads-api/analytics), [Campaign Management](https://developer.twitter.com/en/docs/twitter-ads-api/campaign-management/overview), [Creatives](https://developer.twitter.com/en/docs/twitter-ads-api/creatives/overview), [Custom Audiences](https://developer.twitter.com/en/docs/twitter-ads-api/audiences/overview), and [Conversion](/x-ads-api/measurement/web-conversions) endpoints with [read & write](/resources/fundamentals/developer-apps) access.
...
The standard flow is web-based and uses the [3-legged authorization](/resources/fundamentals/authentication#obtaining-access-tokens-using-3-legged-oauth-flow) OAuth flow. The screen shots outlined here are part of a sample that you can view the source of at [https://github.com/twitterdev/twauth-web](https://github.com/twitterdev/twauth-web).
