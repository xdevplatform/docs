...
description: "How to access X Ads accounts using OAuth, including advertiser versus developer access tokens, account permissions, and agency multi-account workflows."
...
**Note:** The [Leads API](/x-ads-api/lead-generation) requires the Campaign user permission. [Lead exports](/x-ads-api/lead-generation/reference#export-leads) are restricted to **Account administrator**, because exported files contain personal information.
