---
title: Timezones
description: "How the X Ads API handles timezones for accounts and billing, including ISO 8601 datetime formats, UTC offsets, and timezone_switch_at analytics implications."
