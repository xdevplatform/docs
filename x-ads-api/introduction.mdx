---
title: Introduction
description: Use the X Ads API to programmatically manage ad campaigns, audiences, creatives, and reporting on the X advertising platform with OAuth-authenticated endpoints.
...
<CardGroup cols={2}>
  ...
  <Card title="Lead generation" href="/x-ads-api/lead-generation" icon="/icons/xds/icon-document-plus.svg">Create native lead forms, attach them to cards, and export submitted leads for Lead Gen campaigns.</Card>
  ...
  <Card title="Tools and libraries" href="/x-ads-api/tools-and-libraries" icon="/icons/xds/icon-wrench.svg">Check out our curated selection of X-built and community-supported client libraries.</Card>
  <Card title="Postman collection" href="https://documenter.getpostman.com/view/7379786/SzRw1WTU" icon="/icons/xds/icon-code.svg">Explore our v2 endpoints with a curated Postman collection and visual client.</Card>
...
<Card title="X Ads MCP" href="/x-ads-api/mcp" icon="/icons/xds/icon-ai-agents.svg">Connect AI tools to the X Ads API.</Card>
</CardGroup>
