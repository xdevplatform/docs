...
<CardGroup cols={2}>
  ...
  <Card title="Lead generation" href="/x-ads-api/lead-generation" icon="/icons/xds/icon-clipboard.svg">Create native lead forms, attach them to cards, and export submitted leads for Lead Gen campaigns.</Card>
