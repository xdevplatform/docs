...
- Use the [Active Entities endpoint](/x-ads-api/analytics#active-entities)
...
- Use the [Active Entities endpoint](/x-ads-api/analytics#active-entities) to determine which entities to fetch analytics for and for what time period
