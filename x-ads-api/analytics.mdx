---
title: Analytics
description: Retrieve detailed performance metrics for X ad campaigns, line items, and creatives — including impressions, engagements, video views, and spend via synchronous and asynchronous endpoints.
