...
description: "Manage all types of promotable content (Tweets, media, cards, polls, etc.) for your X advertising campaigns. - Full API Reference — Complete reference for."
