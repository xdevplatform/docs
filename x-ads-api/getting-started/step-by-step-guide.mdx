...
At this point you will have basic access to the X API, but not specific X Ads API functionality. Next, you will need to request access and be approved for Ads API access. Visit [ads.x.com/help](https://ads.x.com/help) to submit a request for Ads API access for each of your developer app(s).
