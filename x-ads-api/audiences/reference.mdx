...
description: Technical reference for X Ads API Audiences endpoints, covering tailored audiences, custom audiences, audience permissions, and managing users in audiences.
